"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/utils/create-node-as-tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context/utils 的执行工具。导入/依赖:外部:@langchain/core/tools、zod；内部:n8n-workflow；本地:无。导出:CreateNodeAsToolOptions、createNodeAsTool。关键函数/方法:getSchema、traverseNodeParameters、createTool、createNodeAsTool。用于提供执行通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/utils/create-node-as-tool.ts -> services/n8n/tests/core/unit/execution-engine/node-execution-context/utils/create_node_as_tool.py
