"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/utils/file-system-helper-functions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context/utils 的执行工具。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/config、@n8n/di、n8n-workflow、@/instance-settings；本地:无。导出:getFileSystemHelperFunctions。关键函数/方法:getAllowedPaths、resolvePath、isFilePatternBlocked、isFilePathBlocked、getFileSystemHelperFunctions、createReadStream、getStoragePath、writeContentToFile、getN8nRestrictedPaths。用于提供执行通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/utils/file-system-helper-functions.ts -> services/n8n/tests/core/unit/execution-engine/node-execution-context/utils/file_system_helper_functions.py
