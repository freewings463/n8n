"""
MIGRATION-META:
  source_path: packages/core/nodes-testing/node-test-harness.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/core/nodes-testing 的模块。导入/依赖:外部:callsites、fast-glob 等3项；内部:@n8n/decorators、@n8n/di；本地:../execution-engine/execution-lifecycle-hooks、../execution-engine/workflow-execute、./credentials-helper 等2项。导出:NodeTestHarness。关键函数/方法:readWorkflowJSON、setupTests、setupTest、workflowToTests、setupNetworkMocks、executeWorkflow、getResultNodeData、assertOutput、expect、errorMessage。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/nodes-testing/node-test-harness.ts -> services/n8n/tests/core/unit/nodes-testing/node_test_harness.py
