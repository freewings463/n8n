"""
MIGRATION-META:
  source_path: packages/@n8n/backend-test-utils/src/migration-test-helpers.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/backend-test-utils/src 的工具。导入/依赖:外部:无；内部:@n8n/config、@n8n/db、@n8n/di、@n8n/typeorm、n8n-workflow；本地:无。导出:TestMigrationContext、createTestMigrationContext。关键函数/方法:reinitializeDataConnection、columnName、tableName、indexName、createTestMigrationContext、initDbUpToMigration、undoLastSingleMigration、runSingleMigration。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/backend-test-utils/src/migration-test-helpers.ts -> services/n8n/tests/n8n-backend-test-utils/mocks/src/migration_test_helpers.py
