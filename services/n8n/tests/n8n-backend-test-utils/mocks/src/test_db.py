"""
MIGRATION-META:
  source_path: packages/@n8n/backend-test-utils/src/test-db.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/backend-test-utils/src 的模块。导入/依赖:外部:无；内部:@n8n/config、@n8n/db、@n8n/di、@n8n/typeorm、n8n-workflow；本地:无。导出:testDbPrefix、getBootstrapDBOptions、isReady。关键函数/方法:init、getBootstrapDBOptions、isReady、terminate、truncate。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/backend-test-utils/src/test-db.ts -> services/n8n/tests/n8n-backend-test-utils/mocks/src/test_db.py
