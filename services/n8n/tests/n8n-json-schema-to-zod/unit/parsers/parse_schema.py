"""
MIGRATION-META:
  source_path: packages/@n8n/json-schema-to-zod/src/parsers/parse-schema.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/json-schema-to-zod/src/parsers 的模块。导入/依赖:外部:zod；内部:无；本地:./parse-all-of、./parse-any-of、./parse-array、./parse-boolean 等14项。导出:parseSchema。关键函数/方法:addDescribes、addDefaults、addAnnotations、parseSchema。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/json-schema-to-zod/src/parsers/parse-schema.ts -> services/n8n/tests/n8n-json-schema-to-zod/unit/parsers/parse_schema.py
