"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Aws/IAM/helpers/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Aws/IAM 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./constants、../methods/listSearch、../transport。导出:无。关键函数/方法:encodeBodyAsFormUrlEncoded、findUsersForGroup、responseData、simplifyGetGroupsResponse、simplifyGetAllGroupsResponse、simplifyGetAllUsersResponse、deleteGroupMembers、validatePath、validateUserPath、validateName 等3项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Aws/IAM/helpers/utils.ts -> services/n8n/tests/nodes-base/unit/nodes/Aws/IAM/helpers/utils.py
