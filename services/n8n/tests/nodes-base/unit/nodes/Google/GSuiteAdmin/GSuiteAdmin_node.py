"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/GSuiteAdmin/GSuiteAdmin.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/GSuiteAdmin 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./DeviceDescription、./GenericFunctions、./GroupDescription、./SearchFunctions 等1项。导出:GSuiteAdmin。关键函数/方法:execute、getDomains、domains、getSchemas、schemas、getOrgUnits、orgUnits、userDetails、customFields。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/GSuiteAdmin/GSuiteAdmin.node.ts -> services/n8n/tests/nodes-base/unit/nodes/Google/GSuiteAdmin/GSuiteAdmin_node.py
