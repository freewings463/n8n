"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Calendar/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Calendar 的节点。导入/依赖:外部:luxon、moment-timezone 等1项；内部:n8n-workflow；本地:./EventInterface。导出:encodeURIComponentOnce、TIMEZONE_VALIDATION_REGEX、RecurrentEvent、addNextOccurrence、addTimezoneToDate、eventExtendYearIntoFuture、dateObjectToISO。关键函数/方法:googleApiRequest、googleApiRequestAllItems、encodeURIComponentOnce、getCalendars、calendars 等8项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Calendar/GenericFunctions.ts -> services/n8n/tests/nodes-base/unit/nodes/Google/Calendar/GenericFunctions.py
