"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/RenameKeys/RenameKeys.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/RenameKeys 的节点。导入/依赖:外部:lodash/get、lodash/set、lodash/unset；内部:n8n-workflow；本地:无。导出:RenameKeys。关键函数/方法:execute、set、renameKey、unset、regexReplaceKey、flags、renameObjectKeys。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/RenameKeys/RenameKeys.node.ts -> services/n8n/tests/nodes-base/unit/nodes/RenameKeys/RenameKeys_node.py
