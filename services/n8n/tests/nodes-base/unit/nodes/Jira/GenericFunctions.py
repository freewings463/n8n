"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Jira/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Jira 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./types。导出:handlePagination、validateJSON、eventExists、getWebhookId、simplifyIssueOutput、allEvents、filterSortSearchListItems。关键函数/方法:jiraSoftwareCloudApiRequest、handlePagination、nextStartAt、jiraSoftwareCloudApiRequestAllItems、validateJSON、eventExists、getWebhookId、simplifyIssueOutput 等5项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Jira/GenericFunctions.ts -> services/n8n/tests/nodes-base/unit/nodes/Jira/GenericFunctions.py
