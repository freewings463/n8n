"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/EmailReadImap/v2/EmailReadImapV2.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/EmailReadImap/v2 的节点。导入/依赖:外部:@credentials/Imap.credentials、lodash/isEmpty、luxon、rfc2047；内部:@n8n/imap、n8n-workflow；本地:./utils。导出:EmailReadImapV2。关键函数/方法:imapConnectionTest、trigger、getText、getAttachment、decodeFilename、establishConnection、errorCode、handleReconnect、closeFunction、clearInterval。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/EmailReadImap/v2/EmailReadImapV2.node.ts -> services/n8n/tests/nodes-base/unit/nodes/EmailReadImap/v2/EmailReadImapV2_node.py
