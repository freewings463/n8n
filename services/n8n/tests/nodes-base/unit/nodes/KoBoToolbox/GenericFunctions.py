"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/KoBoToolbox/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/KoBoToolbox 的节点。导入/依赖:外部:lodash/clone、lodash/compact、lodash/concat、lodash/escapeRegExp、lodash/every、lodash/first 等9项；内部:无；本地:无。导出:parseStringList、formatSubmission。关键函数/方法:set、koBoToolboxApiRequest、koBoToolboxRawRequest、parseGeoPoint、every、parseStringList、matchWildcard、formatValue、formatSubmission、isArray 等3项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/KoBoToolbox/GenericFunctions.ts -> services/n8n/tests/nodes-base/unit/nodes/KoBoToolbox/GenericFunctions.py
