"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/HighLevel/v1/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/HighLevel/v1 的节点。导入/依赖:外部:luxon；内部:n8n-workflow；本地:无。导出:isEmailValid、isPhoneValid。关键函数/方法:isEmailValid、isPhoneValid、dateToIsoSupressMillis、taskPostReceiceAction、dueDatePreSendAction、contactIdentifierPreSendAction、validEmailAndPhonePreSendAction、body、dateTimeToEpochPreSendAction、qs 等9项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/HighLevel/v1/GenericFunctions.ts -> services/n8n/tests/nodes-base/unit/nodes/HighLevel/v1/GenericFunctions.py
