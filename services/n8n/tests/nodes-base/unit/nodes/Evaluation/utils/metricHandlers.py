"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Evaluation/utils/metricHandlers.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Evaluation/utils 的工具。导入/依赖:外部:@langchain/core/…/base、fastest-levenshtein、zod；内部:n8n-workflow；本地:../helpers/utils。导出:metricHandlers。关键函数/方法:customMetrics、toolsUsed、expectedToolsString、nodeNameToToolName、categorization、expectedAnswer、actualAnswer、stringSimilarity、helpfulness、userQuery 等2项。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Evaluation/utils/metricHandlers.ts -> services/n8n/tests/nodes-base/unit/nodes/Evaluation/utils/metricHandlers.py
