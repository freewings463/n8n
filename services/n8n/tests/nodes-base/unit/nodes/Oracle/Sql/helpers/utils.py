"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Oracle/Sql/helpers/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Oracle/Sql 的节点。导入/依赖:外部:luxon、oracledb 等1项；内部:n8n-workflow；本地:无。导出:mapDbType、getCompatibleValue、quoteSqlIdentifier、addSortRules、prepareErrorItem、configureQueryRunner、configureTableSchemaUpdater、getColumnMap 等3项。关键函数/方法:isDateType、mapDbType、getCompatibleValue、getExecuteOptions、getExecuteManyOptions、addBindParam、quoteSqlIdentifier 等22项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Oracle/Sql/helpers/utils.ts -> services/n8n/tests/nodes-base/unit/nodes/Oracle/Sql/helpers/utils.py
