"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Microsoft/Excel/v2/helpers/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Microsoft/Excel 的节点。导入/依赖:外部:@utils/utilities；内部:n8n-workflow；本地:./interfaces。导出:CELL_REGEX、prepareOutput、updateByDefinedValues、updateByAutoMaping、checkRange、parseAddress、nextExcelColumn、findAppendRange。关键函数/方法:prepareOutput、wrapData、updateByDefinedValues、Number、updateByAutoMaping、checkRange、parseAddress、cellTo、nextExcelColumn 等4项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Microsoft/Excel/v2/helpers/utils.ts -> services/n8n/tests/nodes-base/unit/nodes/Microsoft/Excel/v2/helpers/utils.py
