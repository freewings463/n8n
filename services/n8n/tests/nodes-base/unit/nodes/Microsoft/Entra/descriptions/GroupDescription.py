"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Microsoft/Entra/descriptions/GroupDescription.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Microsoft/Entra 的节点。导入/依赖:外部:lodash/merge；内部:n8n-workflow；本地:../GenericFunctions。导出:groupOperations。关键函数/方法:function、merge。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Microsoft/Entra/descriptions/GroupDescription.ts -> services/n8n/tests/nodes-base/unit/nodes/Microsoft/Entra/descriptions/GroupDescription.py
