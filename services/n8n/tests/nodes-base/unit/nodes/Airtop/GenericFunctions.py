"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Airtop/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Airtop 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:../common/fields 等2项。导出:validateRequiredStringField、validateSessionId、validateSessionAndWindowId、validateProfileName、validateTimeoutMinutes、validateUrl、validateProxy、validateScrollByAmount 等6项。关键函数/方法:validateRequiredStringField、validateSessionId、validateSessionAndWindowId、validateProfileName 等19项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Airtop/GenericFunctions.ts -> services/n8n/tests/nodes-base/unit/nodes/Airtop/GenericFunctions.py
