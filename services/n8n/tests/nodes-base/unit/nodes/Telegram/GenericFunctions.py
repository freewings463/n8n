"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Telegram/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Telegram 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:../sendAndWait/utils 等1项。导出:IMarkupKeyboard、IMarkupKeyboardRow、IMarkupKeyboardButton、ITelegramInlineReply、ITelegramKeyboardButton、ITelegramReplyKeyboard、IMarkupForceReply、IMarkupReplyKeyboardOptions 等6项。关键函数/方法:addAdditionalFields、array、apiRequest、getImageBySize、getPropertyName、getSecretToken 等1项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Telegram/GenericFunctions.ts -> services/n8n/tests/nodes-base/unit/nodes/Telegram/GenericFunctions.py
