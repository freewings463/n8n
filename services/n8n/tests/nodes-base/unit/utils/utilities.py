"""
MIGRATION-META:
  source_path: packages/nodes-base/utils/utilities.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/utils 的工具。导入/依赖:外部:lodash/get、lodash/isEqual、lodash/isNull 等3项；内部:无；本地:无。导出:chunk、shuffleArray、flattenKeys、flatten、compareItems、updateDisplayOptions、processJsonInput、fuzzyCompare 等14项。关键函数/方法:flattenKeys、loop、updateDisplayOptions、parseStringAndCompareToObject、fuzzyCompare、wrapData、formatPrivateKey、getResolvables、flattenObject、capitalize 等8项。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/utils/utilities.ts -> services/n8n/tests/nodes-base/unit/utils/utilities.py
