"""
MIGRATION-META:
  source_path: packages/workflow/src/from-ai-parse-utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:zod；内部:无；本地:./utils。导出:FromAIArgumentType、FromAIArgument、generateZodSchema、extractFromAICalls、traverseNodeParameters、traverseNodeParametersWithParamNames。关键函数/方法:generateZodSchema、isFromAIArgumentType、parseDefaultValue、parseArguments、extractFromAICalls、traverseNodeParameters、traverseNodeParametersWithParamNames。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/from-ai-parse-utils.ts -> services/n8n/tests/workflow/unit/from_ai_parse_utils.py
