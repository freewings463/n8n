"""
MIGRATION-META:
  source_path: packages/workflow/src/extensions/string-extensions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/workflow/src/extensions 的工作流模块。导入/依赖:外部:js-base64、jssha、luxon、md5、title-case 等1项；内部:无；本地:./extensions、./number-extensions、../errors/expression-extension.error、../type-validation。导出:SupportedHashAlgorithms、toJsonString、toDateTime、stringExtensions。关键函数/方法:hash、variant、isEmpty、isNotEmpty、length、toJsonString、removeMarkdown、removeTags、toDate、toDateTime 等22项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/extensions/string-extensions.ts -> services/n8n/tests/workflow/unit/extensions/string_extensions.py
