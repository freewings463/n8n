"""
MIGRATION-META:
  source_path: packages/workflow/src/extensions/expression-extension.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/workflow/src/extensions 的工作流模块。导入/依赖:外部:ast-types/…/kinds、esprima-next 等3项；内部:无；本地:./array-extensions 等9项。导出:EXTENSION_OBJECTS、hasExpressionExtension、hasNativeMethod、extendTransform、extend、extendOptional、extendSyntax。关键函数/方法:isEmpty、isNotEmpty、isExpressionExtension、hasExpressionExtension 等17项。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-unsafe-member-access。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/extensions/expression-extension.ts -> services/n8n/tests/workflow/unit/extensions/expression_extension.py
