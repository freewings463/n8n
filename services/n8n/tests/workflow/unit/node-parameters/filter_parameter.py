"""
MIGRATION-META:
  source_path: packages/workflow/src/node-parameters/filter-parameter.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/workflow/src/node-parameters 的工作流模块。导入/依赖:外部:luxon；内部:@n8n/errors；本地:../logger-proxy 等2项。导出:FilterError、arrayContainsValue、executeFilterCondition、executeFilter、validateFilterParameter。关键函数/方法:parseSingleFilterValue、withIndefiniteArticle、parseFilterConditionValues、composeInvalidTypeMessage、getTypeDescription、composeInvalidTypeDescription、parseRegexPattern 等8项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/node-parameters/filter-parameter.ts -> services/n8n/tests/workflow/unit/node-parameters/filter_parameter.py
