"""
MIGRATION-META:
  source_path: packages/workflow/src/workflow-data-proxy.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:jmespath、luxon；内部:@n8n/errors；本地:./augment-object、./constants 等11项。导出:WorkflowDataProxy。关键函数/方法:get、isScriptingNode、returnExecutionData、nodeContextGetter、ownKeys、getOwnPropertyDescriptor、selfGetter、buildAgentToolInfo、agentInfo、nodeParameterGetter 等16项。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/prefer-nullish-coalescing。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/workflow-data-proxy.ts -> services/n8n/tests/workflow/unit/workflow_data_proxy.py
