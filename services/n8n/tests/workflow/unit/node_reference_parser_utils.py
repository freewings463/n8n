"""
MIGRATION-META:
  source_path: packages/workflow/src/node-reference-parser-utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:lodash/cloneDeep、lodash/escapeRegExp 等2项；内部:无；本地:./errors 等1项。导出:hasDotNotationBannedChar、backslashEscape、dollarEscape、applyAccessPatterns、extractReferencesInNodeExpressions。关键函数/方法:get、hasDotNotationBannedChar、backslashEscape、dollarEscape、applyAccessPatterns、convertToUniqueJsDotName、convertDataAccessorName 等14项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/node-reference-parser-utils.ts -> services/n8n/tests/workflow/unit/node_reference_parser_utils.py
