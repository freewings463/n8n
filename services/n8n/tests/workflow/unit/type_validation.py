"""
MIGRATION-META:
  source_path: packages/workflow/src/type-validation.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:lodash/isObject、luxon；内部:无；本地:./errors 等2项。导出:tryToParseNumber、tryToParseString、tryToParseAlphanumericString、tryToParseBoolean、tryToParseDateTime、tryToParseTime、tryToParseArray、tryToParseObject 等6项。关键函数/方法:tryToParseNumber、tryToParseString、tryToParseAlphanumericString、tryToParseBoolean、tryToParseDateTime、tryToParseTime、String 等7项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/type-validation.ts -> services/n8n/tests/workflow/unit/type_validation.py
