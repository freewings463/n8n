"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/repositories/user.repository.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/repositories 的仓储。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/di、@n8n/permissions、@n8n/typeorm；本地:../entities。导出:UserRepository。关键函数/方法:update、findManyByIds、findByApiKey、deleteAllExcept、getByIds、findManyByEmail、deleteMany、findNonShellUser、countUsersByRole、rows 等11项。用于封装该模块数据读写与查询细节，隔离持久层。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/repositories/user.repository.ts -> services/n8n/tests/n8n-db/unit/repositories/user_repository.py
