"""
MIGRATION-META:
  source_path: packages/@n8n/scan-community-package/scanner/scanner.mjs
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/scan-community-package/scanner 的模块。导入/依赖:外部:eslint、tmp、semver、axios、fast-glob、eslint/config；内部:@n8n/eslint-plugin-community-nodes；本地:无。导出:isContainedWithin、safeJoinPath、resolvePackage、analyzePackageByName。关键函数/方法:isContainedWithin、safeJoinPath、resolvePackage、downloadAndExtractPackage、analyzePackage、analyzePackageByName。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/scan-community-package/scanner/scanner.mjs -> services/n8n/tests/n8n-scan-community-package/unit/scanner/scanner.py
