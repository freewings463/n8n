"""
MIGRATION-META:
  source_path: packages/testing/playwright/composables/CredentialsComposer.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/composables 的组合式函数。导入/依赖:外部:无；内部:@n8n/api-types；本地:../pages/n8nPage。导出:CredentialsComposer。关键函数/方法:createFromList、createFromNdv、createFromApi、moveToProject。用于封装该模块复用逻辑（hooks/composables）供组件组合。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/composables/CredentialsComposer.ts -> services/n8n/tests/testing/integration/ui/playwright/composables/CredentialsComposer.py
