"""
MIGRATION-META:
  source_path: packages/testing/playwright/pages/n8nPage.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/pages 的页面。导入/依赖:外部:@playwright/test；内部:无；本地:./AIAssistantPage、./AIBuilderPage、./BecomeCreatorCTAPage、./CanvasPage 等53项。导出:n8nPage。关键函数/方法:goHome。用于组装该模块页面级逻辑与子组件。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/pages/n8nPage.ts -> services/n8n/tests/testing/integration/ui/playwright/pages/n8nPage.py
