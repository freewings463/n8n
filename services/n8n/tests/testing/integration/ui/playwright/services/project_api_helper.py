"""
MIGRATION-META:
  source_path: packages/testing/playwright/services/project-api-helper.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/services 的服务。导入/依赖:外部:nanoid；内部:@n8n/db；本地:./api-helper、../Types。导出:ProjectApiHelper。关键函数/方法:createProject、deleteProject、createFolder、updateFolder、deleteFolder、getFolderTree、listFolders、getFolderContent、addUsersToProject、addUserToProject 等2项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/services/project-api-helper.ts -> services/n8n/tests/testing/integration/ui/playwright/services/project_api_helper.py
