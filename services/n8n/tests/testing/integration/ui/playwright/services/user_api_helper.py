"""
MIGRATION-META:
  source_path: packages/testing/playwright/services/user-api-helper.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/services 的服务。导入/依赖:外部:nanoid；内部:@n8n/api-types；本地:./api-helper、../Types。导出:TestUser、UserApiHelper。关键函数/方法:create、delete、getUsers、getUserByEmail。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/services/user-api-helper.ts -> services/n8n/tests/testing/integration/ui/playwright/services/user_api_helper.py
