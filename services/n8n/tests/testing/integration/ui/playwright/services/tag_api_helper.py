"""
MIGRATION-META:
  source_path: packages/testing/playwright/services/tag-api-helper.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/services 的服务。导入/依赖:外部:无；内部:无；本地:./api-helper、../Types。导出:Tag、TagApiHelper。关键函数/方法:create、delete、getAll、deleteAll。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/services/tag-api-helper.ts -> services/n8n/tests/testing/integration/ui/playwright/services/tag_api_helper.py
