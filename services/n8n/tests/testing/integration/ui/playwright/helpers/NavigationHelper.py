"""
MIGRATION-META:
  source_path: packages/testing/playwright/helpers/NavigationHelper.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/helpers 的模块。导入/依赖:外部:@playwright/test；内部:无；本地:无。导出:NavigationHelper。关键函数/方法:toHome、toWorkflows、toCredentials、toExecutions、toDatatables、toVariables、toSettings、toPersonalSettings、toProjects、toProject 等23项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/helpers/NavigationHelper.ts -> services/n8n/tests/testing/integration/ui/playwright/helpers/NavigationHelper.py
