"""
MIGRATION-META:
  source_path: packages/testing/playwright/fixtures/observability.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/fixtures 的模块。导入/依赖:外部:@playwright/test；内部:n8n-containers/stack；本地:无。导出:ObservabilityTestFixtures、ObservabilityWorkerFixtures、observabilityFixtures。关键函数/方法:attachLogsOnFailure、async。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/fixtures/observability.ts -> services/n8n/tests/testing/integration/ui/playwright/fixtures/observability.py
