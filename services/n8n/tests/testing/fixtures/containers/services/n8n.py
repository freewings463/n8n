"""
MIGRATION-META:
  source_path: packages/testing/containers/services/n8n.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/containers/services 的服务。导入/依赖:外部:testcontainers；内部:无；本地:../docker-image、../docker-image-not-found-error、../helpers/utils、../n8n-image-pull-policy 等2项。导出:N8NInstancesOptions、N8NInstancesResult。关键函数/方法:computeEnvironment、createContainer、statusCode、createN8NInstances、log。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/containers/services/n8n.ts -> services/n8n/tests/testing/fixtures/containers/services/n8n.py
