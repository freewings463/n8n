"""
MIGRATION-META:
  source_path: packages/testing/containers/n8n-start-stack.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/containers 的模块。导入/依赖:外部:node:util；内部:无；本地:./docker-image、./docker-image-not-found-error、./performance-plans、./services/keycloak 等5项。导出:无。关键函数/方法:showHelp、main、displayConfig。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/containers/n8n-start-stack.ts -> services/n8n/tests/testing/fixtures/containers/n8n_start_stack.py
