"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/utils/output_parsers/N8nStructuredOutputParser.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/utils/output_parsers 的工具。导入/依赖:外部:@langchain/core/…/manager、@langchain/classic/output_parsers、lodash/get、zod；内部:n8n-workflow；本地:../helpers。导出:N8nStructuredOutputParser。关键函数/方法:parse、get、logAiEvent、fromZodJsonSchema、Boolean、getSchema。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/utils/output_parsers/N8nStructuredOutputParser.ts -> services/n8n/tests/n8n-nodes-langchain/unit/utils/output_parsers/N8nStructuredOutputParser.py
