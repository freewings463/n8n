"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/chains/TextClassifier/TextClassifier.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/chains/TextClassifier 的节点。导入/依赖:外部:@langchain/core/…/base、@langchain/classic/output_parsers、zod、@utils/sharedFields；内部:n8n-workflow；本地:./processItem。导出:TextClassifier。关键函数/方法:execute、configuredOutputs、categories、fallback、getBatchingOptionFields、llm。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/chains/TextClassifier/TextClassifier.node.ts -> services/n8n/tests/n8n-nodes-langchain/unit/nodes/chains/TextClassifier/TextClassifier_node.py
