"""
MIGRATION-META:
  source_path: packages/@n8n/stylelint-config/src/rules/css-var-naming.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/stylelint-config/src/rules 的模块。导入/依赖:外部:stylelint；内部:无；本地:无。导出:无。关键函数/方法:shouldSkip、validateCssVariable。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/stylelint-config/src/rules/css-var-naming.ts -> services/n8n/tests/n8n-stylelint-config/unit/rules/css_var_naming.py
