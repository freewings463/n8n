"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/chains/parameter-updater.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/chains 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/messages、@langchain/core/prompts、zod；内部:n8n-workflow、@/prompts/builder；本地:../errors、../types/config。导出:parametersSchema、createParameterUpdaterChain。关键函数/方法:createParameterUpdaterChain。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/chains/parameter-updater.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/chains/parameter_updater.py
