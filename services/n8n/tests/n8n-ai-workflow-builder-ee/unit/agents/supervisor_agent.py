"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/agents/supervisor.agent.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/agents 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/messages 等2项；内部:@/prompts/…/supervisor.prompt；本地:../types/coordination、../types/workflow、../utils/context-builders 等1项。导出:supervisorRoutingSchema、SupervisorRouting、SupervisorAgentConfig、SupervisorContext、SupervisorAgent。关键函数/方法:buildContextMessage、invoke。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/agents/supervisor.agent.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/agents/supervisor_agent.py
