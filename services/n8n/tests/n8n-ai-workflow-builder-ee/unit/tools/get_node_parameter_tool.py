"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/get-node-parameter.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools 的工作流模块。导入/依赖:外部:@langchain/core/tools、lodash/get 等1项；内部:@n8n/backend-common、n8n-workflow 等2项；本地:../errors、./helpers/progress、./helpers/response、./helpers/validation 等1项。导出:GET_NODE_PARAMETER_TOOL、createGetNodeParameterTool。关键函数/方法:extractParameterValue、formatNodeParameter、createGetNodeParameterTool、reportProgress。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/get-node-parameter.tool.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/tools/get_node_parameter_tool.py
