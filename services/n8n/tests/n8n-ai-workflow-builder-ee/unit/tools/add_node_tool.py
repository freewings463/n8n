"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/add-node.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools 的工作流模块。导入/依赖:外部:@langchain/core/tools、zod；内部:n8n-workflow、@/utils/stream-processor；本地:../errors、./utils/node-creation.utils 等8项。导出:nodeCreationSchema、nodeCreationE2ESchema、getAddNodeToolBase、createAddNodeTool。关键函数/方法:createNode、buildResponseMessage、getCustomNodeTitle、getAddNodeToolBase、createAddNodeTool、async。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/add-node.tool.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/tools/add_node_tool.py
