"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/connect-nodes.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools 的工作流模块。导入/依赖:外部:@langchain/core/tools、zod；内部:@n8n/backend-common、n8n-workflow、@/utils/stream-processor；本地:../types/workflow、./helpers/progress、./helpers/response、./helpers/state 等2项。导出:nodeConnectionSchema、CONNECT_NODES_TOOL、createConnectNodesTool。关键函数/方法:createConnectNodesTool、reportProgress。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/connect-nodes.tool.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/tools/connect_nodes_tool.py
