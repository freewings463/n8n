"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/remove-connection.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools 的工作流模块。导入/依赖:外部:@langchain/core/tools、zod；内部:@n8n/backend-common、@/utils/stream-processor；本地:../errors、../types/tools、./helpers/progress、./helpers/response 等1项。导出:removeConnectionSchema、REMOVE_CONNECTION_TOOL、createRemoveConnectionTool。关键函数/方法:buildResponseMessage、createRemoveConnectionTool、reportProgress。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/remove-connection.tool.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/tools/remove_connection_tool.py
