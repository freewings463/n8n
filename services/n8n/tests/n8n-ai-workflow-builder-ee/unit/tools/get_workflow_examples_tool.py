"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/get-workflow-examples.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools 的工作流模块。导入/依赖:外部:@langchain/core/tools、zod；内部:@n8n/backend-common、@/types、@/utils/stream-processor；本地:../errors、./utils/mermaid.utils、./web/templates。导出:GET_WORKFLOW_EXAMPLES_TOOL、createGetWorkflowExamplesTool。关键函数/方法:buildQueryIdentifier、buildResponseMessage、createGetWorkflowExamplesTool、async。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/get-workflow-examples.tool.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/tools/get_workflow_examples_tool.py
