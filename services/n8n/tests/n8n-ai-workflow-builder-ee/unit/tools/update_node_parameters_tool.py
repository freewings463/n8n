"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/update-node-parameters.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/tools 等1项；内部:n8n-workflow、@/utils/stream-processor 等1项；本地:../chains/parameter-updater 等5项。导出:UPDATING_NODE_PARAMETER_TOOL、createUpdateNodeParametersTool。关键函数/方法:buildSuccessMessage、processParameterUpdates、newParameters、getCustomNodeTitle 等3项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/update-node-parameters.tool.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/tools/update_node_parameters_tool.py
