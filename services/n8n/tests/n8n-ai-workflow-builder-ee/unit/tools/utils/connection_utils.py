"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/utils/connection.utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools/utils 的工作流工具。导入/依赖:外部:无；内部:n8n-workflow；本地:../utils/node-helpers。导出:validateConnection、nodeHasOutputType、nodeAcceptsInputType、createConnection、removeConnection、getNodeConnections、formatConnectionMessage 等1项。关键函数/方法:extractConnectionTypesFromExpression、validateConnection、nodeHasOutputType、nodeAcceptsInputType 等8项。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/utils/connection.utils.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/tools/utils/connection_utils.py
