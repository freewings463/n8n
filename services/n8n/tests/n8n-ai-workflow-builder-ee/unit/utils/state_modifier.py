"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/utils/state-modifier.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/utils 的工作流工具。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/messages；内部:@n8n/backend-common；本地:./cleanup-dangling-tool-call-messages 等5项。导出:StateModificationAction、StateModifierInput、determineStateAction、handleCleanupDangling 等2项。关键函数/方法:hasUnclearedRecursionError、determineStateAction、handleCleanupDangling、handleCompactMessages 等3项。用于提供工作流通用工具能力…
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/utils/state-modifier.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/utils/state_modifier.py
