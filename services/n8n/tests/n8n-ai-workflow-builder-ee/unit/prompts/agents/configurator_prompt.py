"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/prompts/agents/configurator.prompt.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/prompts/agents 的工作流模块。导入/依赖:外部:无；内部:无；本地:../builder。导出:INSTANCE_URL_PROMPT、buildRecoveryModeContext、buildConfiguratorPrompt。关键函数/方法:buildRecoveryModeContext、buildConfiguratorPrompt。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:Configurator Agent Prompt / Sets up node parameters after the Builder Agent has created the workflow structure.。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/prompts/agents/configurator.prompt.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/prompts/agents/configurator_prompt.py
