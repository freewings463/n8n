"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/workflow-builder-agent.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src 的工作流模块。导入/依赖:外部:@langchain/core/…/manager、@langchain/core/…/chat_models 等4项；内部:@n8n/backend-common、@/prompts/legacy-agent.prompt 等1项；本地:./chains/conversation-compact 等11项。导出:TypedStateSnapshot、shouldModifyState、WorkflowBuilderAgentConfig、ExpressionValue 等3项。关键函数/方法:shouldModifyState、getWorkflowContext、getBuilderTools、createMultiAgentGraph 等21项。用于承载工作流实现…
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/workflow-builder-agent.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/workflow_builder_agent.py
