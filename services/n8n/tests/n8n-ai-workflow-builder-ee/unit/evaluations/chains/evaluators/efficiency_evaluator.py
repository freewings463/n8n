"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/chains/evaluators/efficiency-evaluator.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/chains/evaluators 的工作流评估器。导入/依赖:外部:@langchain/core/…/chat_models、zod；内部:无；本地:./base、../types/evaluation。导出:EfficiencyResult、createEfficiencyEvaluatorChain。关键函数/方法:createEfficiencyEvaluatorChain、evaluateEfficiency。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/chains/evaluators/efficiency-evaluator.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/evaluations/chains/evaluators/efficiency_evaluator.py
