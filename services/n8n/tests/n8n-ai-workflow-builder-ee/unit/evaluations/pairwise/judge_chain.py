"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise/judge-chain.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/runnables、zod；内部:无；本地:./types、../prompts/builder、../types/workflow、../evaluators/base。导出:PairwiseEvaluationInput、PairwiseEvaluationResult。关键函数/方法:evaluateWorkflowPairwise。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise/judge-chain.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/evaluations/pairwise/judge_chain.py
