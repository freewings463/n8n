"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/cli/runner.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/cli 的工作流模块。导入/依赖:外部:p-limit、picocolors；内部:无；本地:./display.js、../src/workflow-builder-agent.js、../chains/test-case-generator.js、../core/test-runner.js 等4项。导出:无。关键函数/方法:runCliEvaluation、async、updateProgress、displayResults、displayError。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/cli/runner.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/evaluations/cli/runner.py
