"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/types/evaluation.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/types 的工作流类型。导入/依赖:外部:zod；内部:无；本地:../types/workflow。导出:evaluationResultSchema、Violation、CategoryScore、EfficiencyScore、MaintainabilityScore、BestPracticesScore、EvaluationResult、testCaseSchema 等3项。关键函数/方法:无。用于定义工作流相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/types/evaluation.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/evaluations/types/evaluation.py
