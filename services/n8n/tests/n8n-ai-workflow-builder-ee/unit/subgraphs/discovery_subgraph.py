"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/subgraphs/discovery.subgraph.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/subgraphs 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/messages 等5项；内部:@n8n/backend-common、n8n-workflow 等2项；本地:./subgraph-interface 等11项。导出:DiscoverySubgraphState、DiscoverySubgraphConfig、DiscoverySubgraph。关键函数/方法:create、createGetBestPracticesTool、createNodeSearchTool、createNodeDetailsTool、callAgent 等7项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/subgraphs/discovery.subgraph.ts -> services/n8n/tests/n8n-ai-workflow-builder-ee/unit/subgraphs/discovery_subgraph.py
