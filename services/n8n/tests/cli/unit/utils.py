"""
MIGRATION-META:
  source_path: packages/cli/src/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:无；内部:n8n-workflow、@/constants；本地:无。导出:isWorkflowIdValid、findSubworkflowStart、findCliWorkflowStart、toError、isIntegerString、removeTrailingSlash、rightDiff、assertNever 等3项。关键函数/方法:isWorkflowIdValid、findWorkflowStart、toError、isIntegerString、removeTrailingSlash、assertNever、isPositiveInteger、shouldAssignExecuteMethod、getAllKeyPaths。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/utils.ts -> services/n8n/tests/cli/unit/utils.py
