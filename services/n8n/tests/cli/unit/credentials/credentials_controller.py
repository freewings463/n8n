"""
MIGRATION-META:
  source_path: packages/cli/src/credentials/credentials.controller.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/credentials 的控制器。导入/依赖:外部:zod；内部:@n8n/backend-common、@n8n/config、@n8n/permissions 等11项；本地:./credentials-finder.service、./credentials.service、./credentials.service.ee。导出:CredentialsController。关键函数/方法:getMany、getProjectCredentials、generateUniqueName、getOne、testCredentials、createCredentials、updateCredentials、deleteCredentials、shareCredentials、transfer。用于处理该模块接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/credentials/credentials.controller.ts -> services/n8n/tests/cli/unit/credentials/credentials_controller.py
