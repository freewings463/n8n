"""
MIGRATION-META:
  source_path: packages/cli/src/credentials/credentials.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/credentials 的服务。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/backend-common、@n8n/db、@n8n/di 等16项；本地:./credentials-finder.service。导出:CredentialsGetSharedOptions、CredentialsService。关键函数/方法:update、save、delete、addGlobalCredentials、getMany、applyOnlySharedWithMeFilter、getManyForAdminUser、getManyForMemberUser、applyPersonalProjectFilter、enrichCredentials 等25项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/credentials/credentials.service.ts -> services/n8n/tests/cli/unit/credentials/credentials_service.py
