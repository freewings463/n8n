"""
MIGRATION-META:
  source_path: packages/cli/src/command-registry.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:fast-glob、picocolors、zod；内部:@n8n/backend-common、@n8n/decorators、@n8n/di；本地:./zod-alias-support。导出:CommandRegistry。关键函数/方法:execute、listAllCommands、printCommandUsage、defaultValue、formatZodError、flag。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/command-registry.ts -> services/n8n/tests/cli/unit/command_registry.py
