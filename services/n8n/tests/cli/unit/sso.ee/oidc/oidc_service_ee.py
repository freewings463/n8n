"""
MIGRATION-META:
  source_path: packages/cli/src/sso.ee/oidc/oidc.service.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/sso.ee/oidc 的SSO服务。导入/依赖:外部:openid-client、undici；内部:@n8n/api-types、@n8n/backend-common、@n8n/config、@n8n/decorators、@n8n/di、n8n-core 等8项；本地:./constants。导出:OidcService。关键函数/方法:init、getCallbackUrl、getRedactedConfig、generateState、verifyState、generateNonce、verifyNonce、generateLoginUrl、loginUser、applySsoProvisioning 等8项。用于封装SSO业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/sso.ee/oidc/oidc.service.ee.ts -> services/n8n/tests/cli/unit/sso.ee/oidc/oidc_service_ee.py
