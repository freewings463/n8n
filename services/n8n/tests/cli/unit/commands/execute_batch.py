"""
MIGRATION-META:
  source_path: packages/cli/src/commands/execute-batch.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/commands 的模块。导入/依赖:外部:json-diff、lodash/pick、zod；内部:@n8n/db、@n8n/decorators、@n8n/di、n8n-workflow、@/active-executions、@/services/ownership.service 等2项；本地:./base-command。导出:ExecuteBatch。关键函数/方法:init、run、stopProcess、formatJsonOutput、shouldBeConsideredAsWarning、allWorkflows、mergeResults、runTests、resolve、res 等5项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/commands/execute-batch.ts -> services/n8n/tests/cli/unit/commands/execute_batch.py
