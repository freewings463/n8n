"""
MIGRATION-META:
  source_path: packages/cli/src/commands/worker.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/commands 的模块。导入/依赖:外部:zod；内部:@n8n/backend-common、@n8n/decorators、@n8n/di、@/constants、@/credentials-overwrites、@/deprecation/deprecation.service 等10项；本地:./base-command。导出:Worker。关键函数/方法:init、run、stopProcess、parseInt、initEventBus、initOrchestration、setConcurrency、initScalingService。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/commands/worker.ts -> services/n8n/tests/cli/unit/commands/worker.py
