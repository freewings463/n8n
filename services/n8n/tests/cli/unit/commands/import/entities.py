"""
MIGRATION-META:
  source_path: packages/cli/src/commands/import/entities.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/commands/import 的模块。导入/依赖:外部:zod；内部:@n8n/decorators、@n8n/di、@n8n/backend-common；本地:../base-command、../services/import.service。导出:ImportEntitiesCommand。关键函数/方法:run。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/commands/import/entities.ts -> services/n8n/tests/cli/unit/commands/import/entities.py
