"""
MIGRATION-META:
  source_path: packages/cli/src/commands/export/credentials.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/commands/export 的模块。导入/依赖:外部:zod；内部:@n8n/db、@n8n/decorators、@n8n/di、n8n-core、n8n-workflow、@/interfaces；本地:../base-command。导出:ExportCredentialsCommand。关键函数/方法:run。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/commands/export/credentials.ts -> services/n8n/tests/cli/unit/commands/export/credentials.py
