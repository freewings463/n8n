"""
MIGRATION-META:
  source_path: packages/cli/src/commands/ldap/reset.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/commands/ldap 的LDAP模块。导入/依赖:外部:zod；内部:@n8n/constants、@n8n/decorators、@n8n/di、@n8n/typeorm、n8n-workflow、@/constants 等2项；本地:../base-command。导出:Reset。关键函数/方法:run、Number、getProject、getOwner。用于承载LDAP实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/commands/ldap/reset.ts -> services/n8n/tests/cli/unit/commands/ldap/reset.py
