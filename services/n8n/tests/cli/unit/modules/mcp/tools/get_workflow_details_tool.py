"""
MIGRATION-META:
  source_path: packages/cli/src/modules/mcp/tools/get-workflow-details.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/mcp/tools 的工作流模块。导入/依赖:外部:zod；内部:@n8n/db、n8n-workflow、@/credentials/credentials.service、@/telemetry、@/workflows/workflow-finder.service；本地:../mcp.constants、./schemas、./webhook-utils。导出:WorkflowDetailsOutputSchema、createWorkflowDetailsTool。关键函数/方法:createWorkflowDetailsTool、getWorkflowDetails。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/mcp/tools/get-workflow-details.tool.ts -> services/n8n/tests/cli/unit/modules/mcp/tools/get_workflow_details_tool.py
