"""
MIGRATION-META:
  source_path: packages/cli/src/modules/mcp/tools/search-workflows.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/mcp/tools 的工作流模块。导入/依赖:外部:zod；内部:@n8n/db、n8n-workflow、@/requests、@/telemetry、@/workflows/workflow.service；本地:../mcp.constants、./schemas。导出:createSearchWorkflowsTool。关键函数/方法:createSearchWorkflowsTool、searchWorkflows。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/mcp/tools/search-workflows.tool.ts -> services/n8n/tests/cli/unit/modules/mcp/tools/search_workflows_tool.py
