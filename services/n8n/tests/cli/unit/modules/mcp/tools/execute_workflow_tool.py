"""
MIGRATION-META:
  source_path: packages/cli/src/modules/mcp/tools/execute-workflow.tool.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/mcp/tools 的工作流模块。导入/依赖:外部:moment-timezone、zod；内部:@n8n/constants、@n8n/db、@/active-executions、@/telemetry 等2项；本地:../mcp.constants、../mcp.errors、../mcp.utils。导出:createExecuteWorkflowTool、executeWorkflow。关键函数/方法:createExecuteWorkflowTool、executeWorkflow、reject、clearTimeout、getExecutionModeForTrigger、getPinDataForTrigger、getInputMetaData。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/mcp/tools/execute-workflow.tool.ts -> services/n8n/tests/cli/unit/modules/mcp/tools/execute_workflow_tool.py
