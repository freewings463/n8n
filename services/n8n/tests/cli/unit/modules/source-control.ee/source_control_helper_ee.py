"""
MIGRATION-META:
  source_path: packages/cli/src/modules/source-control.ee/source-control-helper.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/source-control.ee 的模块。导入/依赖:外部:node:assert/strict、node:fs/promises 等1项；内部:@n8n/api-types、@n8n/backend-common 等4项；本地:./types/exportable-folders 等4项。导出:stringContainsExpression、getWorkflowExportPath、getProjectExportPath、getCredentialExportPath 等12项。关键函数/方法:stringContainsExpression、getWorkflowExportPath、getProjectExportPath、getCredentialExportPath 等19项。用于承载该模块实现细节，并通过导出对外…
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/source-control.ee/source-control-helper.ee.ts -> services/n8n/tests/cli/unit/modules/source-control.ee/source_control_helper_ee.py
