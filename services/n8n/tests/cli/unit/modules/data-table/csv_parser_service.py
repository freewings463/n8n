"""
MIGRATION-META:
  source_path: packages/cli/src/modules/data-table/csv-parser.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/data-table 的服务。导入/依赖:外部:csv-parse；内部:@n8n/backend-common、@n8n/config、@n8n/di；本地:无。导出:CsvColumnMetadata、CsvMetadata、CsvParserService。关键函数/方法:processRowWithoutHeaders、parseFile、resolve、createReadStream、parseFileData、getCompatibleTypes、inferColumnType、isDate。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/data-table/csv-parser.service.ts -> services/n8n/tests/cli/unit/modules/data-table/csv_parser_service.py
