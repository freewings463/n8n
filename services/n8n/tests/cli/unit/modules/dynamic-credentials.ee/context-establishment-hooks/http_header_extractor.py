"""
MIGRATION-META:
  source_path: packages/cli/src/modules/dynamic-credentials.ee/context-establishment-hooks/http-header-extractor.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/dynamic-credentials.ee/context-establishment-hooks 的模块。导入/依赖:外部:node:vm、zod；内部:@n8n/backend-common；本地:无。导出:HttpHeaderExtractor。关键函数/方法:execute、isUnsafeRegexPattern、isHeaderObject、safeRegexExec、isApplicableToTriggerNode。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/dynamic-credentials.ee/context-establishment-hooks/http-header-extractor.ts -> services/n8n/tests/cli/unit/modules/dynamic-credentials.ee/context-establishment-hooks/http_header_extractor.py
