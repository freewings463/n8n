"""
MIGRATION-META:
  source_path: packages/cli/src/modules/external-secrets.ee/external-secrets-manager.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/external-secrets.ee 的模块。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/constants 等7项；本地:./external-secrets-providers.ee、./external-secrets.config、./provider-registry.service 等4项。导出:ExternalSecretsManager。关键函数/方法:init、shutdown、getProvider、hasProvider、getProviderNames、getProvidersWithSettings、getProviderWithSettings、updateProvider、getSecret、hasSecret 等18项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/external-secrets.ee/external-secrets-manager.ee.ts -> services/n8n/tests/cli/unit/modules/external-secrets.ee/external_secrets_manager_ee.py
