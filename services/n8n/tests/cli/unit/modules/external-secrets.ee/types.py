"""
MIGRATION-META:
  source_path: packages/cli/src/modules/external-secrets.ee/types.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/external-secrets.ee 的类型。导入/依赖:外部:无；内部:@n8n/db、n8n-workflow；本地:无。导出:SecretsProviderSettings、ExternalSecretsSettings、SecretsProviderState。关键函数/方法:connect、setState。用于定义该模块相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/external-secrets.ee/types.ts -> services/n8n/tests/cli/unit/modules/external-secrets.ee/types.py
