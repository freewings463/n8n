"""
MIGRATION-META:
  source_path: packages/cli/src/modules/external-secrets.ee/providers/vault.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/external-secrets.ee/providers 的模块。导入/依赖:外部:axios；内部:@n8n/backend-common、@n8n/di、n8n-workflow；本地:../constants、../external-secrets.config、../types。导出:VaultProvider。关键函数/方法:init、update、doConnect、disconnect、clearTimeout、setupTokenRefresh、setTimeout、authUsernameAndPassword、authAppRole、getTokenInfo 等5项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/external-secrets.ee/providers/vault.ts -> services/n8n/tests/cli/unit/modules/external-secrets.ee/providers/vault.py
