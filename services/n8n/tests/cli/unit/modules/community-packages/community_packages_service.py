"""
MIGRATION-META:
  source_path: packages/cli/src/modules/community-packages/community-packages.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/community-packages 的服务。导入/依赖:外部:axios、node:child_process 等3项；内部:@n8n/backend-common、@n8n/constants 等8项；本地:./community-packages.config 等5项。导出:CommunityPackagesService。关键函数/方法:init、findInstalledPackage、isPackageInstalled、getAllInstalledPackages、removePackageFromDatabase、persistInstalledPackage、parseNpmPackageName、executeNpmCommand 等22项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/community-packages/community-packages.service.ts -> services/n8n/tests/cli/unit/modules/community-packages/community_packages_service.py
