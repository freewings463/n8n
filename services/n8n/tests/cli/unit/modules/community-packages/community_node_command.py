"""
MIGRATION-META:
  source_path: packages/cli/src/modules/community-packages/community-node.command.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/community-packages 的模块。导入/依赖:外部:zod；内部:@n8n/db、@n8n/decorators 等3项；本地:./community-packages.service、./installed-nodes.entity 等2项。导出:CommunityNode。关键函数/方法:run、uninstallCredential、findUserById、findCredentialsByType、deleteCredential、uninstallPackage、pruneDependencies、deleteCommunityNode、removeCommunityPackage、findCommunityPackage。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/community-packages/community-node.command.ts -> services/n8n/tests/cli/unit/modules/community-packages/community_node_command.py
