"""
MIGRATION-META:
  source_path: packages/cli/src/modules/chat-hub/chat-hub-agent.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/chat-hub 的服务。导入/依赖:外部:uuid；内部:@n8n/backend-common、@n8n/db、@n8n/di、@/errors/…/not-found.error；本地:./chat-hub-agent.entity、./chat-hub-agent.repository、./chat-hub-credentials.service、./chat-hub.constants。导出:ChatHubAgentService。关键函数/方法:getAgentsByUserIdAsModels、convertAgentEntityToModel、getAgentsByUserId、getAgentById、createAgent、updateAgent、deleteAgent。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/chat-hub/chat-hub-agent.service.ts -> services/n8n/application/cli/services/chat-hub/chat_hub_agent_service.py
