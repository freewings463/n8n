"""
MIGRATION-META:
  source_path: packages/cli/src/modules/chat-hub/chat-hub.models.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/chat-hub 的服务。导入/依赖:外部:无；内部:@n8n/db、@n8n/di 等5项；本地:./chat-hub-agent.service、./chat-hub-workflow.service、./chat-hub.constants 等1项。导出:ChatHubModelsService。关键函数/方法:getModels、async、fetchModelsForProvider、fetchOpenAiModels、fetchAnthropicModels、fetchGoogleModels、fetchOllamaModels、fetchAzureOpenAiModels、fetchAzureEntraIdModels、fetchAwsBedrockModels 等10项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/chat-hub/chat-hub.models.service.ts -> services/n8n/application/cli/services/chat-hub/chat_hub_models_service.py
