"""
MIGRATION-META:
  source_path: packages/cli/src/workflow-runner.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src 的工作流模块。导入/依赖:外部:p-cancelable；内部:@n8n/backend-common、@n8n/config、@n8n/db、@n8n/di、n8n-core、@/active-executions 等10项；本地:./events/event.service。导出:WorkflowRunner。关键函数/方法:run、processError、runMainProcess、clearTimeout、async、enqueueExecution、onCancel、reject、resolve。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-unsafe-argument。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/workflow-runner.ts -> services/n8n/application/cli/services/workflow_runner.py
