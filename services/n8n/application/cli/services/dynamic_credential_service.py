"""
MIGRATION-META:
  source_path: packages/cli/src/modules/dynamic-credentials.ee/services/dynamic-credential.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/dynamic-credentials.ee/services 的服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/decorators 等4项；本地:./credential-resolver-registry.service、./resolver-config-expression.service、./shared-fields 等2项。导出:DynamicCredentialService。关键函数/方法:resolveIfNeeded、buildCredentialContext、handleResolutionError、handleMissingResolver、handleMissingContext。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/dynamic-credentials.ee/services/dynamic-credential.service.ts -> services/n8n/application/cli/services/dynamic_credential_service.py
