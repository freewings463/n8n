"""
MIGRATION-META:
  source_path: packages/cli/src/task-runners/task-broker/task-broker.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/task-runners/task-broker 的服务。导入/依赖:外部:nanoid；内部:@n8n/backend-common、@n8n/config 等8项；本地:无。导出:TaskRunner、Task、TaskOffer、TaskRequest、MessageCallback、RequesterMessageCallback、TaskBroker。关键函数/方法:createRequestTimeout、handleRequestTimeout、clearTimeout、expireTasks、registerRunner、deregisterRunner、registerRequester、deregisterRequester、messageRunner 等38项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/task-runners/task-broker/task-broker.service.ts -> services/n8n/application/cli/services/task-runners/task-broker/task_broker_service.py
