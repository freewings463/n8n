"""
MIGRATION-META:
  source_path: packages/cli/src/task-runners/task-managers/task-requester.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/task-runners/task-managers 的模块。导入/依赖:外部:nanoid；内部:@n8n/config、@n8n/di 等6项；本地:./data-request-response-builder 等1项。导出:RequestAccept、RequestReject、TaskAccept、TaskReject、TaskRequest、Task、RunnerStatus。关键函数/方法:setRunnerUnavailable、getRunnerStatus、cancelTasks、getTaskIds、cancelTask、clearExecutionsMap、sendMessage、onMessage、taskReady、requestExpired 等7项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/task-runners/task-managers/task-requester.ts -> services/n8n/application/cli/services/task-runners/task-managers/task_requester.py
