"""
MIGRATION-META:
  source_path: packages/cli/src/modules/dynamic-credentials.ee/services/credential-resolver.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/dynamic-credentials.ee/services 的服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/db 等4项；本地:./credential-resolver-registry.service 等4项。导出:CreateResolverParams、UpdateResolverParams、DynamicCredentialResolverService。关键函数/方法:create、update、delete、findAll、getAvailableTypes、findById、validateConfig、encryptConfig、decryptConfig、withDecryptedConfig。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/dynamic-credentials.ee/services/credential-resolver.service.ts -> services/n8n/application/cli/services/credential_resolver_service.py
