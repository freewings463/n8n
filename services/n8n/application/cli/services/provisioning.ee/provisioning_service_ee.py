"""
MIGRATION-META:
  source_path: packages/cli/src/modules/provisioning.ee/provisioning.service.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/provisioning.ee 的服务。导入/依赖:外部:zod；内部:@n8n/api-types、@n8n/backend-common 等11项；本地:./constants。导出:ProvisioningService。关键函数/方法:init、getConfig、provisionInstanceRoleForUser、provisionProjectRolesForUser、patchConfig、handleReloadSsoProvisioningConfiguration、loadConfigurationFromDatabase、loadConfig、getInstanceRoleClaimName、getProjectsRolesClaimName 等3项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/provisioning.ee/provisioning.service.ee.ts -> services/n8n/application/cli/services/provisioning.ee/provisioning_service_ee.py
