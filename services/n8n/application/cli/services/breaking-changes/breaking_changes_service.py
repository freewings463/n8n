"""
MIGRATION-META:
  source_path: packages/cli/src/modules/breaking-changes/breaking-changes.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/breaking-changes 的服务。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/backend-common 等6项；本地:./breaking-changes.rule-registry.service 等2项。导出:BreakingChangeService。关键函数/方法:registerRules、getAllInstanceRulesResults、groupNodesByType、aggregateRegularRuleResults、aggregateBatchRuleResults、getAllWorkflowRulesResults、refreshDetectionResults、getDetectionResults、void 等4项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/breaking-changes/breaking-changes.service.ts -> services/n8n/application/cli/services/breaking-changes/breaking_changes_service.py
