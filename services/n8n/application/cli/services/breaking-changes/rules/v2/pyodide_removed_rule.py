"""
MIGRATION-META:
  source_path: packages/cli/src/modules/breaking-changes/rules/v2/pyodide-removed.rule.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/breaking-changes/rules 的模块。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/db、@n8n/di、n8n-workflow；本地:../../types。导出:PyodideRemovedRule。关键函数/方法:getMetadata、getRecommendations、detectWorkflow。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/breaking-changes/rules/v2/pyodide-removed.rule.ts -> services/n8n/application/cli/services/breaking-changes/rules/v2/pyodide_removed_rule.py
