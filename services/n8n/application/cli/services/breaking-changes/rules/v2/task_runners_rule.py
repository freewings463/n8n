"""
MIGRATION-META:
  source_path: packages/cli/src/modules/breaking-changes/rules/v2/task-runners.rule.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/breaking-changes/rules 的模块。导入/依赖:外部:无；内部:@n8n/config、@n8n/di；本地:../../types。导出:TaskRunnersRule。关键函数/方法:getMetadata、detect。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/breaking-changes/rules/v2/task-runners.rule.ts -> services/n8n/application/cli/services/breaking-changes/rules/v2/task_runners_rule.py
