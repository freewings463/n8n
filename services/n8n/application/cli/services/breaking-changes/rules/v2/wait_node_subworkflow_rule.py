"""
MIGRATION-META:
  source_path: packages/cli/src/modules/breaking-changes/rules/v2/wait-node-subworkflow.rule.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/breaking-changes/rules 的工作流模块。导入/依赖:外部:无；内部:@n8n/db、@n8n/di、n8n-workflow；本地:../../types。导出:WaitNodeSubworkflowRule。关键函数/方法:getMetadata、getRecommendations、reset、collectWorkflowData、produceReport、findWaitingNodes、extractCalledWorkflowId、isWorkflowItselfExpression。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/breaking-changes/rules/v2/wait-node-subworkflow.rule.ts -> services/n8n/application/cli/services/breaking-changes/rules/v2/wait_node_subworkflow_rule.py
