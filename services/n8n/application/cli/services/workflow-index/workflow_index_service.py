"""
MIGRATION-META:
  source_path: packages/cli/src/modules/workflow-index/workflow-index.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/workflow-index 的工作流服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/db、@n8n/di、n8n-core、n8n-workflow、@/events/event.service；本地:无。导出:WorkflowIndexService。关键函数/方法:init、buildIndex、updateIndexFor、addNodeTypeDependencies、addCredentialDependencies、addWorkflowCallDependencies、addWebhookPathDependencies、getCalledWorkflowIdFrom。用于封装工作流业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/workflow-index/workflow-index.service.ts -> services/n8n/application/cli/services/workflow-index/workflow_index_service.py
