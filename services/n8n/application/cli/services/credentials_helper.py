"""
MIGRATION-META:
  source_path: packages/cli/src/credentials-helper.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:无；内部:@n8n/db、@n8n/di 等5项；本地:./constants 等3项。导出:CredentialsHelper、createCredentialsFromCredentialsEntity。关键函数/方法:getKnownTypes、getByName、getByNameAndVersion、authenticate、preAuthentication、resolveValue、getParentTypes、getCredentials、getCredentialsEntity、getCredentialsProperties 等6项。用于承载该模块实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-unsafe-argument。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/credentials-helper.ts -> services/n8n/application/cli/services/credentials_helper.py
