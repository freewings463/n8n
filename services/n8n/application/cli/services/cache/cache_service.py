"""
MIGRATION-META:
  source_path: packages/cli/src/services/cache/cache.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/services/cache 的服务。导入/依赖:外部:cache-manager；内部:@n8n/config、@n8n/constants、@n8n/di、n8n-workflow、@/errors/…/malformed-refresh-value.error、@/errors/…/uncacheable-value.error 等2项；本地:../redis-client.service。导出:CacheService。关键函数/方法:init、set、delete、sizeCalculation、reset、isRedis、isMemory、exists、setMany、setHash 等3项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/services/cache/cache.service.ts -> services/n8n/application/cli/services/cache/cache_service.py
