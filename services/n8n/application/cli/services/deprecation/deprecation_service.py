"""
MIGRATION-META:
  source_path: packages/cli/src/deprecation/deprecation.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/deprecation 的服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/config、@n8n/di、n8n-core；本地:无。导出:DeprecationService。关键函数/方法:warn。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/deprecation/deprecation.service.ts -> services/n8n/application/cli/services/deprecation/deprecation_service.py
