"""
MIGRATION-META:
  source_path: packages/cli/src/requests.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:无；内部:@n8n/api-types；本地:无。导出:AuthlessRequest、Request、Params、Options、hasSharing、SurveyAnswers、InviteResponse、Delete 等2项。关键函数/方法:hasSharing。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/requests.ts -> services/n8n/application/cli/services/requests.py
