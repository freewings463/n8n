"""
MIGRATION-META:
  source_path: packages/cli/src/wait-tracker.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/db、@n8n/decorators、@n8n/di、n8n-core、n8n-workflow 等4项；本地:无。导出:WaitTracker。关键函数/方法:init、has、startTracking、getWaitingExecutions、stopExecution、clearTimeout、startExecution、stopTracking、clearInterval。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/wait-tracker.ts -> services/n8n/application/cli/services/wait_tracker.py
