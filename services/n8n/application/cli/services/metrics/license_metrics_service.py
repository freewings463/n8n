"""
MIGRATION-META:
  source_path: packages/cli/src/metrics/license-metrics.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/metrics 的服务。导入/依赖:外部:无；内部:@n8n/db、@n8n/di；本地:无。导出:LicenseMetricsService。关键函数/方法:collectUsageMetrics、collectPassthroughData。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/metrics/license-metrics.service.ts -> services/n8n/application/cli/services/metrics/license_metrics_service.py
