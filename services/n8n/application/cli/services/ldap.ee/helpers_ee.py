"""
MIGRATION-META:
  source_path: packages/cli/src/ldap.ee/helpers.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/ldap.ee 的LDAP工具。导入/依赖:外部:jsonschema、ldapts 等1项；内部:@n8n/config、@n8n/constants 等4项；本地:./constants。导出:isLdapEnabled、getLdapLoginLabel、isLdapLoginEnabled、validateLdapConfigurationSchema、resolveEntryBinaryAttributes、resolveBinaryAttributes、createFilter 等17项。关键函数/方法:isLdapEnabled、getLdapLoginLabel、isLdapLoginEnabled、validateLdapConfigurationSchema 等20项。用于提供LDAP通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/ldap.ee/helpers.ee.ts -> services/n8n/application/cli/services/ldap.ee/helpers_ee.py
