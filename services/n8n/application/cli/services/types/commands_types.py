"""
MIGRATION-META:
  source_path: packages/cli/src/types/commands.types.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/types 的类型。导入/依赖:外部:无；内部:n8n-workflow；本地:无。导出:IResult、IExecutionResult、IWorkflowExecutionProgress、INodeSpecialCases、INodeSpecialCase。关键函数/方法:无。用于定义该模块相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/types/commands.types.ts -> services/n8n/application/cli/services/types/commands_types.py
