"""
MIGRATION-META:
  source_path: packages/cli/src/permissions.ee/check-access.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/permissions.ee 的模块。导入/依赖:外部:无；内部:@n8n/db、@n8n/di、@n8n/permissions、n8n-workflow、@/credentials/credentials-finder.service、@/errors/…/not-found.error 等1项；本地:无。导出:无。关键函数/方法:userHasScopes、userProjectIds。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/permissions.ee/check-access.ts -> services/n8n/application/cli/services/permissions.ee/check_access.py
