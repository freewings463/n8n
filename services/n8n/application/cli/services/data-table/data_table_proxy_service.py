"""
MIGRATION-META:
  source_path: packages/cli/src/modules/data-table/data-table-proxy.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/data-table 的服务。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/backend-common、@n8n/di 等1项；本地:./data-table.service。导出:isAllowedNode、DataTableProxyService。关键函数/方法:isAllowedNode、validateRequest、getProjectId、getDataTableAggregateProxy、getDataTableProxy、makeAggregateOperations、getManyAndCount、createDataTable、deleteDataTableAll、makeDataTableOperations 等10项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/data-table/data-table-proxy.service.ts -> services/n8n/application/cli/services/data-table/data_table_proxy_service.py
