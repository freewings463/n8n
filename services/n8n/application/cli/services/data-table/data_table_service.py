"""
MIGRATION-META:
  source_path: packages/cli/src/modules/data-table/data-table.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/data-table 的服务。导入/依赖:外部:luxon；内部:@n8n/backend-common、@n8n/db 等3项；本地:./csv-parser.service、./data-table-column.entity 等12项。导出:DataTableService。关键函数/方法:start、shutdown、createDataTable、importDataFromFile、updateDataTable、transferDataTablesByProjectId、deleteDataTableByProjectId、deleteDataTableAll、deleteDataTable、addColumn 等26项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/data-table/data-table.service.ts -> services/n8n/application/cli/services/data-table/data_table_service.py
