"""
MIGRATION-META:
  source_path: packages/cli/src/workflow-execute-additional-data.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src 的工作流模块。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/backend-common 等20项；本地:无。导出:getRunData、setExecutionStatus、sendDataToUI。关键函数/方法:getRunData、fetchWorkflowData、getDraftWorkflowData、getPublishedWorkflowData、executeWorkflow、startExecution、setExecutionStatus、sendDataToUI、getBase、getRunExecutionData 等1项。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-unsafe-argument。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/workflow-execute-additional-data.ts -> services/n8n/application/cli/services/workflow_execute_additional_data.py
