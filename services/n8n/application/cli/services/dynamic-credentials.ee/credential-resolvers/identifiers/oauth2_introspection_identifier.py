"""
MIGRATION-META:
  source_path: packages/cli/src/modules/dynamic-credentials.ee/credential-resolvers/identifiers/oauth2-introspection-identifier.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/dynamic-credentials.ee/credential-resolvers 的OAuth模块。导入/依赖:外部:axios、zod；内部:@n8n/backend-common、@n8n/constants 等3项；本地:./identifier-interface 等1项。导出:OAuth2IntrospectionOptionsSchema、TokenIntrospectionResponseSchema、TokenIntrospectionResponse、OAuth2TokenIntrospectionIdentifier。关键函数/方法:validateOptions、resolve、parseOptions、fetchMetadata 等4项。用于承载OAuth实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/dynamic-credentials.ee/credential-resolvers/identifiers/oauth2-introspection-identifier.ts -> services/n8n/application/cli/services/dynamic-credentials.ee/credential-resolvers/identifiers/oauth2_introspection_identifier.py
