"""
MIGRATION-META:
  source_path: packages/cli/src/services/workflow-statistics.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/services 的工作流服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/db、@n8n/di、@/events/event.service、@/services/user.service、@/typed-emitter；本地:./ownership.service。导出:WorkflowStatisticsService。关键函数/方法:async、workflowExecutionCompleted、nodeFetchedData。用于封装工作流业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/services/workflow-statistics.service.ts -> services/n8n/application/cli/services/workflow_statistics_service.py
