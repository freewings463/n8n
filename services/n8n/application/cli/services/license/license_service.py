"""
MIGRATION-META:
  source_path: packages/cli/src/license/license.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/license 的服务。导入/依赖:外部:axios；内部:@n8n/backend-common、@n8n/db、@n8n/di、n8n-workflow、@/errors/…/bad-request.error、@/errors/…/license-eula-required.error 等3项；本地:无。导出:LicenseErrors、LicenseService。关键函数/方法:getLicenseData、requestEnterpriseTrial、registerCommunityEdition、getManagementJwt、activateLicense、isEulaRequiredError、renewLicense、mapErrorMessage、isLicenseError。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/license/license.service.ts -> services/n8n/application/cli/services/license/license_service.py
