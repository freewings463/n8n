"""
MIGRATION-META:
  source_path: packages/cli/src/execution-lifecycle/execution-lifecycle-hooks.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/execution-lifecycle 的执行模块。导入/依赖:外部:flatted；内部:@n8n/backend-common、@n8n/db 等10项；本地:./execute-error-workflow 等3项。导出:getLifecycleHooksForSubExecutions、getLifecycleHooksForScalingWorker、getLifecycleHooksForScalingMain、getLifecycleHooksForRegularMain。关键函数/方法:addHooks、hookFunctionsWorkflowEvents、hookFunctionsNodeEvents、hookFunctionsPush 等12项。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/execution-lifecycle/execution-lifecycle-hooks.ts -> services/n8n/application/cli/services/execution-lifecycle/execution_lifecycle_hooks.py
