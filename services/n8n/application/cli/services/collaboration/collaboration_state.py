"""
MIGRATION-META:
  source_path: packages/cli/src/collaboration/collaboration.state.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/collaboration 的模块。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/constants、@n8n/db、@n8n/di、n8n-workflow 等1项；本地:无。导出:CollaborationState。关键函数/方法:addCollaborator、removeCollaborator、getCollaborators、formWorkflowCacheKey、splitToExpiredAndStillActive、removeExpiredCollaborators、cacheHashToCollaborators、hasSessionExpired、setWriteLock、renewWriteLock 等3项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/collaboration/collaboration.state.ts -> services/n8n/application/cli/services/collaboration/collaboration_state.py
