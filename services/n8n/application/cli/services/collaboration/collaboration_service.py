"""
MIGRATION-META:
  source_path: packages/cli/src/collaboration/collaboration.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/collaboration 的服务。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/db 等8项；本地:./collaboration.message。导出:CollaborationService。关键函数/方法:init、handleUserMessage、handleWorkflowOpened、handleWorkflowClosed、sendWorkflowUsersChangedMessage、handleWriteAccessRequested、handleWriteAccessReleaseRequested、handleWriteAccessHeartbeat、sendWriteAccessAcquiredMessage 等4项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/collaboration/collaboration.service.ts -> services/n8n/application/cli/services/collaboration/collaboration_service.py
