"""
MIGRATION-META:
  source_path: packages/cli/src/modules/insights/insights.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/insights 的Insights服务。导入/依赖:外部:luxon；内部:@n8n/api-types、@n8n/backend-common 等4项；本地:../entities/insights-shared 等4项。导出:InsightsService。关键函数/方法:init、toggleCollectionService、startCompactionAndPruningTimers、stopCompactionAndPruningTimers、shutdown、getInsightsSummary、getValueByType、getDeviation、getInsightsByWorkflow、getInsightsByTime 等2项。用于封装Insights业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/insights/insights.service.ts -> services/n8n/application/cli/services/insights/insights_service.py
