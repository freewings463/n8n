"""
MIGRATION-META:
  source_path: packages/cli/src/modules/insights/insights-pruning.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/insights 的Insights服务。导入/依赖:外部:assert；内部:@n8n/backend-common、@n8n/constants、@n8n/di；本地:../repositories/insights-by-period.repository、./insights.config。导出:InsightsPruningService。关键函数/方法:toMaxSafeIfUnlimited、startPruningTimer、strict、clearPruningTimer、clearTimeout、stopPruningTimer、scheduleNextPrune、pruneInsights。用于封装Insights业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/insights/insights-pruning.service.ts -> services/n8n/application/cli/services/insights/insights_pruning_service.py
