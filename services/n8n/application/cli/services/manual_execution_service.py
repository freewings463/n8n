"""
MIGRATION-META:
  source_path: packages/cli/src/manual-execution.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src 的执行服务。导入/依赖:外部:assert/strict、p-cancelable；内部:@n8n/backend-common、@n8n/constants、@n8n/di、n8n-workflow；本地:无。导出:ManualExecutionService。关键函数/方法:getExecutionStartNode、runManually、filterDisabledNodes。用于封装执行业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/manual-execution.service.ts -> services/n8n/application/cli/services/manual_execution_service.py
