"""
MIGRATION-META:
  source_path: packages/cli/src/modules/mcp/mcp-oauth-authorization-code.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/mcp 的OAuth服务。导入/依赖:外部:无；内部:@n8n/constants、@n8n/di；本地:../entities/oauth-authorization-code.entity、../repositories/oauth-authorization-code.repository。导出:McpOAuthAuthorizationCodeService。关键函数/方法:createAuthorizationCode、findAndValidateAuthorizationCode、validateAndConsumeAuthorizationCode、getCodeChallenge。用于封装OAuth业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/mcp/mcp-oauth-authorization-code.service.ts -> services/n8n/application/cli/services/mcp/mcp_oauth_authorization_code_service.py
