"""
MIGRATION-META:
  source_path: packages/cli/src/eventbus/message-event-bus-destination/message-event-bus-destination.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/eventbus/message-event-bus-destination 的模块。导入/依赖:外部:uuid；内部:@n8n/backend-common、@n8n/db 等4项；本地:../event-message-classes、../event-message-classes/abstract-event-message、../event-message-classes/event-message-confirm 等1项。导出:无。关键函数/方法:startListening、async、stopListening、enable、disable、getId、hasSubscribedToEvent、saveToDb、deleteFromDb、serialize 等2项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/eventbus/message-event-bus-destination/message-event-bus-destination.ee.ts -> services/n8n/application/cli/services/eventbus/message-event-bus-destination/message_event_bus_destination_ee.py
