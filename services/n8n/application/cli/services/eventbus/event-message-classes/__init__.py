"""
MIGRATION-META:
  source_path: packages/cli/src/eventbus/event-message-classes/index.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/eventbus/event-message-classes 的入口。导入/依赖:外部:无；内部:无；本地:./event-message-ai-node、./event-message-audit、./event-message-execution、./event-message-generic 等4项。导出:eventNamesAiNodes、EventNamesAiNodesType、eventNamesRunner、EventNamesRunnerType、eventNamesQueue、EventNamesQueueType、eventNamesWorkflow、eventNamesGeneric 等11项。关键函数/方法:无。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/eventbus/event-message-classes/index.ts -> services/n8n/application/cli/services/eventbus/event-message-classes/__init__.py
