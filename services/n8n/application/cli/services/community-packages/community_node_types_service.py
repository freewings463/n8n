"""
MIGRATION-META:
  source_path: packages/cli/src/modules/community-packages/community-node-types.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/community-packages 的服务。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/backend-common 等2项；本地:./community-node-types-utils 等2项。导出:CommunityNodeTypesService。关键函数/方法:fetchNodeTypes、detectEnvironment、updateCommunityNodeTypes、resetCommunityNodeTypes、updateRequired、setTimestampForRetry、createIsInstalled、installedPackages、getCommunityNodeTypes、getCommunityNodeType 等1项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/community-packages/community-node-types.service.ts -> services/n8n/application/cli/services/community-packages/community_node_types_service.py
