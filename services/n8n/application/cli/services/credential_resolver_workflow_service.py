"""
MIGRATION-META:
  source_path: packages/cli/src/modules/dynamic-credentials.ee/services/credential-resolver-workflow.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/dynamic-credentials.ee/services 的工作流服务。导入/依赖:外部:无；内部:@n8n/db、n8n-core、n8n-workflow、@n8n/decorators、@n8n/di；本地:./credential-resolver-registry.service、../repositories/credential-resolver.repository。导出:CredentialResolverWorkflowService。关键函数/方法:isCredentialStatus、getResolver、getWorkflowStatus、checkCredentialStatus。用于封装工作流业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/dynamic-credentials.ee/services/credential-resolver-workflow.service.ts -> services/n8n/application/cli/services/credential_resolver_workflow_service.py
