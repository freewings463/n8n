"""
MIGRATION-META:
  source_path: packages/cli/src/events/relays/log-streaming.event-relay.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/events/relays 的模块。导入/依赖:外部:无；内部:@n8n/decorators、@n8n/di、n8n-core、n8n-workflow、@/eventbus/…/message-event-bus、@/events/event.service 等2项；本地:无。导出:LogStreamingEventRelay。关键函数/方法:init、hasUser、workflowCreated、workflowDeleted、workflowArchived、workflowUnarchived、workflowActivated、workflowDeactivated、workflowSaved、workflowPreExecute 等56项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/events/relays/log-streaming.event-relay.ts -> services/n8n/application/cli/services/events/relays/log_streaming_event_relay.py
