"""
MIGRATION-META:
  source_path: packages/cli/src/events/relays/telemetry.event-relay.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/events/relays 的遥测模块。导入/依赖:外部:change-case、psl；内部:@n8n/config、@n8n/di 等11项；本地:../../telemetry 等1项。导出:TelemetryEventRelay。关键函数/方法:init、teamProjectUpdated、teamProjectDeleted、teamProjectCreated、sourceControlSettingsUpdated、sourceControlUserStartedPullUi、sourceControlUserFinishedPullUi、sourceControlUserPulledApi、sourceControlUserStartedPushUi 等32项。用于承载遥测实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/events/relays/telemetry.event-relay.ts -> services/n8n/application/cli/services/events/relays/telemetry_event_relay.py
