"""
MIGRATION-META:
  source_path: packages/cli/src/events/maps/ai.event-map.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/events/maps 的模块。导入/依赖:外部:无；内部:无；本地:无。导出:AiEventPayload、AiEventMap。关键函数/方法:无。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/events/maps/ai.event-map.ts -> services/n8n/application/cli/services/events/maps/ai_event_map.py
