"""
MIGRATION-META:
  source_path: packages/cli/src/chat/chat-execution-manager.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/chat 的执行模块。导入/依赖:外部:无；内部:@n8n/db、@n8n/di、n8n-core、n8n-workflow；本地:../response-errors/not-found.error、../workflow-execute-additional-data、../workflow-runner、./chat-service.types 等2项。导出:ChatExecutionManager。关键函数/方法:runWorkflow、cancelExecution、findExecution、checkIfExecutionExists、getWorkflow、mapFilesToBinaryData、runNode、getRunData。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/chat/chat-execution-manager.ts -> services/n8n/application/cli/services/chat/chat_execution_manager.py
