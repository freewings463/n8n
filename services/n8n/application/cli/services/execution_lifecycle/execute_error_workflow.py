"""
MIGRATION-META:
  source_path: packages/cli/src/execution-lifecycle/execute-error-workflow.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/execution-lifecycle 的工作流模块。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/config、@n8n/di、n8n-core、n8n-workflow、@/interfaces 等3项；本地:无。导出:executeErrorWorkflow。关键函数/方法:executeErrorWorkflow。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/execution-lifecycle/execute-error-workflow.ts -> services/n8n/application/cli/services/execution_lifecycle/execute_error_workflow.py
