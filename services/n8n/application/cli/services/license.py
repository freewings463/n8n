"""
MIGRATION-META:
  source_path: packages/cli/src/license.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/config、@n8n/db、@n8n/decorators、@n8n/di、@n8n_io/license-sdk 等3项；本地:./constants。导出:FeatureReturnType、License。关键函数/方法:init、loadCertStr、onFeatureChange、onLicenseRenewed、broadcastReloadLicenseCommand、saveCertStr、onCertRefresh、notifyRefreshCallbacks、refreshCallback、activate 等45项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/license.ts -> services/n8n/application/cli/services/license.py
