"""
MIGRATION-META:
  source_path: packages/cli/src/load-nodes-and-credentials.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:@parcel/watcher、fast-glob、fs/promises、picocolors 等1项；内部:@n8n/backend-common、@n8n/config、@n8n/di、@n8n/utils、n8n-core、n8n-workflow 等2项；本地:无。导出:LoadNodesAndCredentials。关键函数/方法:init、addPostProcessor、isKnownNode、loadNodesFromNodeModules、resolveIcon、resolvePath、resolvePathCustom、resolveSchema、findLastCalloutIndex、getCustomDirectories 等17项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/load-nodes-and-credentials.ts -> services/n8n/application/cli/services/load_nodes_and_credentials.py
