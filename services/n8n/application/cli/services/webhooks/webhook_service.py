"""
MIGRATION-META:
  source_path: packages/cli/src/webhooks/webhook.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/webhooks 的Webhook服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/db、@n8n/di、n8n-core、n8n-workflow、@/node-types 等1项；本地:./webhook.types。导出:WebhookService。关键函数/方法:populateCache、findAll、findCached、findStaticWebhook、findDynamicWebhook、findWebhook、storeWebhook、createWebhook、deleteWorkflowWebhooks、deleteWebhooks 等8项。用于封装Webhook业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/webhooks/webhook.service.ts -> services/n8n/application/cli/services/webhooks/webhook_service.py
