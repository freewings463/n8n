"""
MIGRATION-META:
  source_path: packages/cli/src/executions/execution-recovery.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/executions 的执行服务。导入/依赖:外部:luxon；内部:@n8n/backend-common、@n8n/config、@n8n/db、@n8n/di、@n8n/permissions、n8n-core 等8项；本地:../eventbus/event-message-classes。导出:ExecutionRecoveryService。关键函数/方法:autoDeactivateWorkflowsIfNeeded、recoverFromLogs、amend、amendWithoutLogs、toRelevantMessages、toStoppedAt、runHooks、getAutodeactivationRecipient。用于封装执行业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/executions/execution-recovery.service.ts -> services/n8n/application/cli/services/executions/execution_recovery_service.py
