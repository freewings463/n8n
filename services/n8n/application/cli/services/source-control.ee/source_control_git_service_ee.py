"""
MIGRATION-META:
  source_path: packages/cli/src/modules/source-control.ee/source-control-git.service.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/source-control.ee 的服务。导入/依赖:外部:proxy-from-env、simple-git；内部:@n8n/backend-common、@n8n/db 等3项；本地:./source-control-helper.ee 等2项。导出:SourceControlGitService。关键函数/方法:preInitCheck、initService、sourceControlFoldersExistCheck、setGitCommand、escapeShellArg、resetService、checkRepositorySetup、hasRemote、initRepository、trackRemoteIfReady 等15项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/source-control.ee/source-control-git.service.ee.ts -> services/n8n/application/cli/services/source-control.ee/source_control_git_service_ee.py
