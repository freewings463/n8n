"""
MIGRATION-META:
  source_path: packages/cli/src/modules/source-control.ee/source-control-preferences.service.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/source-control.ee 的服务。导入/依赖:外部:class-validator、fs/promises 等1项；内部:@n8n/backend-common、@n8n/db 等3项；本地:./source-control-helper.ee 等3项。导出:SourceControlPreferencesService。关键函数/方法:isSourceControlSetup、getKeyPairFromDatabase、getPrivateKeyFromDatabase、getPublicKeyFromDatabase、getHttpsCredentialsFromDatabase、getDecryptedHttpsCredentials 等15项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/source-control.ee/source-control-preferences.service.ee.ts -> services/n8n/application/cli/services/source-control.ee/source_control_preferences_service_ee.py
