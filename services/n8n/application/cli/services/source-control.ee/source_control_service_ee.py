"""
MIGRATION-META:
  source_path: packages/cli/src/modules/source-control.ee/source-control.service.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/source-control.ee 的服务。导入/依赖:外部:simple-git；内部:@n8n/backend-common、@n8n/db 等6项；本地:./source-control-export.service.ee、./source-control-git.service.ee 等8项。导出:SourceControlService。关键函数/方法:start、sourceControlFoldersExistCheck、initGitService、sanityCheck、disconnect、initializeRepository、writeFileSync、getBranches、setBranch、resetWorkfolder 等9项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/source-control.ee/source-control.service.ee.ts -> services/n8n/application/cli/services/source-control.ee/source_control_service_ee.py
