"""
MIGRATION-META:
  source_path: packages/cli/src/modules/source-control.ee/source-control-status.service.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/source-control.ee 的服务。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/backend-common 等6项；本地:./source-control-git.service.ee 等9项。导出:SourceControlStatusService。关键函数/方法:getStatus、getTrackingInformationFromPrePushResult、getTrackingInformationFromPullResult、resetWorkfolder、getStatusWorkflows、getStatusCredentials、hasOwnerChanged、getStatusVariables 等7项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/source-control.ee/source-control-status.service.ee.ts -> services/n8n/application/cli/services/source-control.ee/source_control_status_service_ee.py
