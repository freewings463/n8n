"""
MIGRATION-META:
  source_path: packages/cli/src/environments.ee/variables/variables.service.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/environments.ee/variables 的服务。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/backend-common、@n8n/db、@n8n/di、@n8n/permissions、@/errors/feature-not-licensed.error 等6项；本地:无。导出:VariablesService。关键函数/方法:delete、create、update、findAll、isAuthorizedForVariable、getAllCached、getCached、updateCache、getAllForUser、userHasAccess 等8项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/environments.ee/variables/variables.service.ee.ts -> services/n8n/application/cli/services/environments.ee/variables/variables_service_ee.py
