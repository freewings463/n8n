"""
MIGRATION-META:
  source_path: packages/cli/src/modules/chat-hub/chat-hub.constants.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/chat-hub 的模块。导入/依赖:外部:无；内部:@n8n/api-types、n8n-workflow；本地:./chat-hub.types。导出:EXECUTION_POLL_INTERVAL、STREAM_CLOSE_TIMEOUT、EXECUTION_FINISHED_STATUSES、TOOLS_AGENT_NODE_MIN_VERSION、CHAT_TRIGGER_NODE_MIN_VERSION、PROVIDER_NODE_TYPE_MAP、NODE_NAMES、JSONL_STREAM_HEADERS 等2项。关键函数/方法:getModelMetadata。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/chat-hub/chat-hub.constants.ts -> services/n8n/application/cli/services/modules/chat-hub/chat_hub_constants.py
