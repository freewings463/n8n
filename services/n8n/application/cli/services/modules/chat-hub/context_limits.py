"""
MIGRATION-META:
  source_path: packages/cli/src/modules/chat-hub/context-limits.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/chat-hub 的模块。导入/依赖:外部:无；内部:@n8n/api-types；本地:无。导出:maxContextWindowTokens、getMaxContextWindowTokens。关键函数/方法:getMaxContextWindowTokens。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/chat-hub/context-limits.ts -> services/n8n/application/cli/services/modules/chat-hub/context_limits.py
