"""
MIGRATION-META:
  source_path: packages/cli/src/modules/dynamic-credentials.ee/credential-resolvers/oauth-credential-resolver.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/modules/dynamic-credentials.ee/credential-resolvers 的OAuth模块。导入/依赖:外部:zod；内部:@n8n/backend-common、n8n-core 等1项；本地:./identifiers/identifier-interface、./storage/dynamic-credential-entry-storage。导出:OAuthCredentialResolver。关键函数/方法:getSecret、setSecret、deleteSecret、deleteAllSecrets、parseOptions、validateOptions、getIdentifier、resolveIdentifier、validateIdentity。用于承载OAuth实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/dynamic-credentials.ee/credential-resolvers/oauth-credential-resolver.ts -> services/n8n/application/cli/services/modules/dynamic-credentials.ee/credential-resolvers/oauth_credential_resolver.py
