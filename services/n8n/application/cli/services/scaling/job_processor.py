"""
MIGRATION-META:
  source_path: packages/cli/src/scaling/job-processor.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/scaling 的SSO模块。导入/依赖:外部:p-cancelable；内部:@n8n/api-types、@n8n/backend-common、@n8n/config、@n8n/db、@n8n/di、n8n-core 等7项；本地:无。导出:JobProcessor。关键函数/方法:processJob、executionHasErrors、stopJob、getRunningJobIds、getRunningJobsSummary、encodeWebhookResponse。用于承载SSO实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/scaling/job-processor.ts -> services/n8n/application/cli/services/scaling/job_processor.py
