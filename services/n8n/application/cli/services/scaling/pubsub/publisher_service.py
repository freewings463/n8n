"""
MIGRATION-META:
  source_path: packages/cli/src/scaling/pubsub/publisher.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/cli/src/scaling/pubsub 的服务。导入/依赖:外部:ioredis；内部:@n8n/backend-common、@n8n/config、@n8n/di、n8n-core、n8n-workflow、@/services/redis-client.service；本地:./pubsub.types。导出:Publisher。关键函数/方法:get、getClient、shutdown、publishCommand、publishWorkerResponse、setIfNotExists、setExpiration、clear。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/scaling/pubsub/publisher.service.ts -> services/n8n/application/cli/services/scaling/pubsub/publisher_service.py
