"""
MIGRATION-META:
  source_path: packages/@n8n/decorators/src/context-establishment/context-establishment-hook-metadata.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/decorators/src/context-establishment 的模块。导入/依赖:外部:无；内部:@n8n/di；本地:./context-establishment-hook。导出:ContextEstablishmentHookMetadata、ContextEstablishmentHook。关键函数/方法:register、getEntries、getClasses。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/decorators/src/context-establishment/context-establishment-hook-metadata.ts -> services/n8n/application/n8n-decorators/services/context-establishment/context_establishment_hook_metadata.py
