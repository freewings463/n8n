"""
MIGRATION-META:
  source_path: packages/core/src/binary-data/binary-data.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/binary-data 的服务。导入/依赖:外部:jsonwebtoken、ms、node:fs/promises、pretty-bytes；内部:@n8n/backend-common、@n8n/di、n8n-workflow、@/errors；本地:./binary-data.config、./types、./utils、../errors/invalid-manager.error 等1项。导出:BinaryDataService。关键函数/方法:init、setManager、createSignedToken、validateSignedToken、copyBinaryFile、store、getAsStream、getAsBuffer、getPath、getMetadata 等9项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/binary-data/binary-data.service.ts -> services/n8n/application/core/services/binary-data/binary_data_service.py
