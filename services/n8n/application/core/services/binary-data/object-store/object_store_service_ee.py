"""
MIGRATION-META:
  source_path: packages/core/src/binary-data/object-store/object-store.service.ee.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/binary-data/object-store 的服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/di、n8n-workflow；本地:./object-store.config、./types、../types、../utils。导出:ObjectStoreService。关键函数/方法:init、get、list、getClientConfig、setReady、checkConnection、put、getMetadata、deleteOne、deleteMany 等1项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/binary-data/object-store/object-store.service.ee.ts -> services/n8n/application/core/services/binary-data/object-store/object_store_service_ee.py
