"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/execution-context.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine 的执行服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/di、@/encryption、@/utils/deep-merge；本地:./execution-context-hook-registry.service。导出:ExecutionContextService。关键函数/方法:decryptExecutionContext、encryptExecutionContext、mergeExecutionContexts、augmentExecutionContextWithHooks。用于封装执行业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/execution-context.service.ts -> services/n8n/application/core/services/execution-engine/execution_context_service.py
