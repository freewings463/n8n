"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/ssh-clients-manager.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine 的执行模块。导入/依赖:外部:ssh2、zod；内部:@n8n/backend-common、@n8n/config、@n8n/di、n8n-workflow；本地:无。导出:SSHClientsConfig、SSHClientsManager。关键函数/方法:updateLastUsed、getClient、resolve、withCleanupHandler、cleanupClient、onShutdown、clearInterval、cleanupStaleConnections。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/ssh-clients-manager.ts -> services/n8n/application/core/services/execution-engine/ssh_clients_manager.py
