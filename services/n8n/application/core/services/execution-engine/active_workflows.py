"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/active-workflows.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine 的工作流模块。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/di、@/errors/error-reporter、@/interfaces；本地:./interfaces、./scheduled-task-manager、./triggers-and-pollers。导出:ActiveWorkflows。关键函数/方法:get、isActive、allActiveWorkflows、add、activatePolling、cronExpressions、executeTrigger、remove、removeAllTriggerAndPollerBasedWorkflows、closeTrigger。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/active-workflows.ts -> services/n8n/application/core/services/execution-engine/active_workflows.py
