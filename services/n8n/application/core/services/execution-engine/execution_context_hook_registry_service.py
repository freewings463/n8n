"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/execution-context-hook-registry.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine 的执行服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/decorators、@n8n/di；本地:无。导出:ExecutionContextHookRegistry。关键函数/方法:init、getHookByName、getAllHooks、getHookForTriggerType。用于封装执行业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/execution-context-hook-registry.service.ts -> services/n8n/application/core/services/execution-engine/execution_context_hook_registry_service.py
