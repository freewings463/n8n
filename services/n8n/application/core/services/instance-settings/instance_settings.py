"""
MIGRATION-META:
  source_path: packages/core/src/instance-settings/instance-settings.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/instance-settings 的模块。导入/依赖:外部:nanoid；内部:@n8n/backend-common、@n8n/config、@n8n/constants、@n8n/decorators、@n8n/di、n8n-workflow；本地:./worker-missing-encryption-key.error。导出:InstanceSettings。关键函数/方法:update、save、setMultiMainEnabled、setMultiMainLicensed、markAsLeader、markAsFollower、loadOrCreate、mkdirSync、generateInstanceId、getOrGenerateHmacSignatureSecret 等4项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/instance-settings/instance-settings.ts -> services/n8n/application/core/services/instance-settings/instance_settings.py
