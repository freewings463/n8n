"""
MIGRATION-META:
  source_path: packages/core/src/errors/error-reporter.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/errors 的错误。导入/依赖:外部:@sentry/core、@sentry/node、axios、@sentry/node-native；内部:@n8n/backend-common、@n8n/constants、@n8n/di、@n8n/errors、n8n-workflow；本地:无。导出:ErrorReporter。关键函数/方法:init、defaultReport、shutdown、clearTimeout、releaseExpiresInMs、checkForExpiration、rewriteFramesIntegration、requestDataIntegration、setTag、beforeSend 等9项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/errors/error-reporter.ts -> services/n8n/application/core/services/errors/error_reporter.py
