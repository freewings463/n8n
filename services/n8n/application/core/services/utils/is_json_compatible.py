"""
MIGRATION-META:
  source_path: packages/core/src/utils/is-json-compatible.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/utils 的工具。导入/依赖:外部:无；内部:无；本地:无。导出:isJsonCompatible。关键函数/方法:check、subVal、isJsonCompatible。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/utils/is-json-compatible.ts -> services/n8n/application/core/services/utils/is_json_compatible.py
