"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/workflow-execute.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine 的工作流模块。导入/依赖:外部:assert/strict、lodash/get 等1项；内部:@n8n/config、@n8n/constants 等6项；本地:./execution-context 等6项。导出:WorkflowExecute。关键函数/方法:run、isLegacyExecutionOrder、runPartialWorkflow2、recreateNodeExecutionStack、moveNodeMetadata、incomingConnectionIsEmpty 等9项。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/prefer-optional-chain。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/workflow-execute.ts -> services/n8n/application/core/services/execution_engine/workflow_execute.py
