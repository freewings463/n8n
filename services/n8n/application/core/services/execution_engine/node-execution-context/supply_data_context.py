"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/supply-data-context.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context 的执行模块。导入/依赖:外部:lodash/get；内部:n8n-workflow；本地:./base-execute-context、./utils/construct-execution-metadata 等9项。导出:SupplyDataContext。关键函数/方法:assertBinaryData、cloneWith、getInputConnectionData、getInputData、getNextRunIndex、isToolExecution、addInputData、addOutputData、addExecutionDataFunctions、logNodeOutput 等1项。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/supply-data-context.ts -> services/n8n/application/core/services/execution_engine/node-execution-context/supply_data_context.py
