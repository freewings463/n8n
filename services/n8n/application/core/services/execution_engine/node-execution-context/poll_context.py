"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/poll-context.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context 的执行模块。导入/依赖:外部:无；内部:n8n-workflow；本地:./node-execution-context、./utils/binary-helper-functions、./utils/request-helper-functions、./utils/return-json-array 等1项。导出:PollContext。关键函数/方法:throwOnEmit、throwOnEmitError、getActivationMode。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/poll-context.ts -> services/n8n/application/core/services/execution_engine/node-execution-context/poll_context.py
