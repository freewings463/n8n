"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/base-execute-context.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context 的执行模块。导入/依赖:外部:lodash/get；内部:无；本地:./node-execution-context。导出:BaseExecuteContext。关键函数/方法:getExecutionContext、getExecutionCancelSignal、onExecutionCancellation、fn、handler、getExecuteData、setMetadata、getContext、continueOnFail、putExecutionToWait 等9项。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/base-execute-context.ts -> services/n8n/application/core/services/execution_engine/node-execution-context/base_execute_context.py
