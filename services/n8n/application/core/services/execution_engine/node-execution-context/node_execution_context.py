"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/node-execution-context.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context 的执行模块。导入/依赖:外部:lodash/get；内部:@n8n/backend-common、@n8n/decorators 等2项；本地:./utils/cleanup-parameter-data、./utils/ensure-type、./utils/extract-value 等3项。导出:无。关键函数/方法:getExecutionContext、getExecutionId、getNode、getWorkflow、getMode、getWorkflowStaticData、getChildNodes、getParentNodes、getChatTrigger、getWorkflowSettings 等17项。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/node-execution-context.ts -> services/n8n/application/core/services/execution_engine/node-execution-context/node_execution_context.py
