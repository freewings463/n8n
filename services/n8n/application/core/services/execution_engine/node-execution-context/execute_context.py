"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/execute-context.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context 的执行模块。导入/依赖:外部:无；内部:无；本地:./base-execute-context、./utils/construct-execution-metadata、./utils/copy-input-items 等8项。导出:ExecuteContext。关键函数/方法:assertBinaryData、isStreaming、sendChunk、getInputConnectionData、getInputData、logNodeOutput、sendResponse、addInputData、addOutputData、getParentCallbackManager 等2项。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/execute-context.ts -> services/n8n/application/core/services/execution_engine/node-execution-context/execute_context.py
