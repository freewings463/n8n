"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/utils/get-input-connection-data.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context/utils 的执行工具。导入/依赖:外部:无；内部:无；本地:./create-node-as-tool 等3项。导出:makeHandleToolInvocation。关键函数/方法:getNextRunIndex、containsBinaryData、containsDataThatIsUsefulToTheAgent、mapResult、makeHandleToolInvocation、validateInputConfiguration、getInputConnectionData 等1项。用于提供执行通用工具能力（纯函数/封装器）供复用。注释目标:eslint-disable @typescript-eslint/no-unsafe-argument。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/utils/get-input-connection-data.ts -> services/n8n/application/core/services/execution_engine/node-execution-context/utils/get_input_connection_data.py
