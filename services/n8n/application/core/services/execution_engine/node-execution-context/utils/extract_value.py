"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/utils/extract-value.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context/utils 的执行工具。导入/依赖:外部:lodash/get；内部:无；本地:无。导出:extractValue。关键函数/方法:findPropertyFromParameterName、findProp、executeRegexExtractValue、extractValueRLC、modeProp、extractValueFilter、extractValueOther、extractValue。用于提供执行通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/utils/extract-value.ts -> services/n8n/application/core/services/execution_engine/node-execution-context/utils/extract_value.py
