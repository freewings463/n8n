"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/partial-execution-utils/directed-graph.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine/partial-execution-utils 的执行模块。导入/依赖:外部:assert；内部:n8n-workflow；本地:无。导出:GraphConnection、DirectedGraph。关键函数/方法:hasNode、getNodes、getNodesByNames、getConnections、addNode、addNodes、removeNode、addConnection、addConnections、getDirectChildConnections 等16项。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/partial-execution-utils/directed-graph.ts -> services/n8n/application/core/services/execution_engine/partial-execution-utils/directed_graph.py
