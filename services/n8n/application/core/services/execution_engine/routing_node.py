"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/routing-node.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/core/src/execution-engine 的执行模块。导入/依赖:外部:lodash/get、lodash/merge、lodash/set；内部:无；本地:./node-execution-context。导出:RoutingNode。关键函数/方法:set、runNode、items、mergeOptions、merge、runPostReceiveAction、body、postProcessResponseData、rawRoutingRequest、makeRequest 等5项。用于承载执行实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-unsafe-call。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/routing-node.ts -> services/n8n/application/core/services/execution_engine/routing_node.py
