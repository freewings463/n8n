"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/best-practices/data-analysis.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools/best-practices 的工作流模块。导入/依赖:外部:无；内部:@/types/best-practices、@/types/categorization；本地:无。导出:DataAnalysisBestPractices。关键函数/方法:getDocumentation。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/best-practices/data-analysis.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/tools/best-practices/data_analysis.py
