"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/utils/parameter-update.utils.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools/utils 的工作流工具。导入/依赖:外部:无；内部:n8n-workflow；本地:无。导出:extractNodeParameters、mergeParameters、updateNodeWithParameters、formatChangesForPrompt、fixExpressionPrefixes。关键函数/方法:extractNodeParameters、mergeParameters、deepMerge、isObject、updateNodeWithParameters、formatChangesForPrompt。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/utils/parameter-update.utils.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/tools/utils/parameter_update_utils.py
