"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/utils/mermaid.utils.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools/utils 的工作流工具。导入/依赖:外部:无；内部:@/types；本地:无。导出:MermaidOptions、MermaidResult、mermaidStringify、processWorkflowExamples。关键函数/方法:build、createNodeIdMap、categorizeStickyOverlaps、extractStickyBounds、isNodeWithinStickyBounds、findAgentSubgraphs、findNestedStickySubgraphs、buildReverseConnectionMap、getConnectionTargets 等33项。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/utils/mermaid.utils.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/tools/utils/mermaid_utils.py
