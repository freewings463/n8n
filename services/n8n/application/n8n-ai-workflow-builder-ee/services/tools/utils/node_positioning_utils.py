"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/tools/utils/node-positioning.utils.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/tools/utils 的工作流工具。导入/依赖:外部:无；内部:n8n-workflow；本地:../utils/node-helpers。导出:POSITIONING_CONFIG、calculateNodePosition、categorizeNodes、getNodesAtPosition、calculateConnectedNodePosition。关键函数/方法:calculateNodePosition、categorizeNodes、calculateXPosition、calculateYPosition、getNodesAtPosition、calculateConnectedNodePosition。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/tools/utils/node-positioning.utils.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/tools/utils/node_positioning_utils.py
