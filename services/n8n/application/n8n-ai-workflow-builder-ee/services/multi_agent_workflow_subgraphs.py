"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/multi-agent-workflow-subgraphs.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/messages 等1项；内部:@n8n/backend-common、n8n-workflow；本地:./agents/responder.agent、./agents/supervisor.agent 等9项。导出:MultiAgentSubgraphConfig、createMultiAgentWorkflowWithSubgraphs。关键函数/方法:routeToNode、createMultiAgentWorkflowWithSubgraphs、async、createSubgraphNodeHandler。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/multi-agent-workflow-subgraphs.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/multi_agent_workflow_subgraphs.py
