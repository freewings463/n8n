"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/types/categorization.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/types 的工作流类型。导入/依赖:外部:无；内部:无；本地:无。导出:WorkflowTechnique、WorkflowTechniqueType、TechniqueDescription、PromptCategorization。关键函数/方法:无。用于定义工作流相关类型/结构约束，供多模块共享。注释目标:Common workflow building techniques that can be combined in workflows。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/types/categorization.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/types/categorization.py
