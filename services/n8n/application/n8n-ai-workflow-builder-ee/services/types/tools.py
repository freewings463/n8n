"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/types/tools.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/types 的工作流类型。导入/依赖:外部:zod；内部:n8n-workflow；本地:./categorization、./nodes、./workflow。导出:ProgressUpdateType、ProgressUpdate、ToolProgressMessage、ToolError、ProgressReporter、BatchReporter、UpdateNodeParametersOutput、AddNodeOutput 等12项。关键函数/方法:无。用于定义工作流相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/types/tools.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/types/tools.py
