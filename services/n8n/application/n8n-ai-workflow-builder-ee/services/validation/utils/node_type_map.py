"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/validation/utils/node-type-map.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/validation/utils 的工作流工具。导入/依赖:外部:无；内部:n8n-workflow、@/types；本地:无。导出:createNodeTypeMap、getNodeTypeForNode、createNodeTypeMaps。关键函数/方法:getNodeTypeVersions、getDefaultVersion、createNodeTypeMap、resolveNodeVersion、getNodeTypeForNode、createNodeTypeMaps。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/validation/utils/node-type-map.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/validation/utils/node_type_map.py
