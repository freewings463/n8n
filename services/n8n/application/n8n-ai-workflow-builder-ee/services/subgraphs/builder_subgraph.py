"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/subgraphs/builder.subgraph.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/subgraphs 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/messages 等3项；内部:@n8n/backend-common、n8n-workflow 等3项；本地:./subgraph-interface 等14项。导出:BuilderSubgraphState、BuilderSubgraphConfig、BuilderSubgraph。关键函数/方法:create、createAddNodeTool、createConnectNodesTool、createRemoveNodeTool、createRemoveConnectionTool 等5项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/subgraphs/builder.subgraph.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/subgraphs/builder_subgraph.py
