"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/prompts/chains/parameter-updater/registry.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/prompts/chains/parameter-updater 的工作流模块。导入/依赖:外部:无；内部:无；本地:./types。导出:matchesPattern、getMatchingGuides、getMatchingExamples。关键函数/方法:matchesPattern、getMatchingGuides、getMatchingExamples。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:Centralized registry for node-type specific guides and examples. / This module imports all guides and examples and builds the lookup arrays.。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/prompts/chains/parameter-updater/registry.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/prompts/chains/parameter-updater/registry.py
