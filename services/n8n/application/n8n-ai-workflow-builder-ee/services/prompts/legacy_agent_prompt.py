"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/prompts/legacy-agent.prompt.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/prompts 的工作流模块。导入/依赖:外部:@langchain/core/prompts；内部:无；本地:../parameter-updater/instance-url、./shared/node-guidance。导出:MainAgentPromptOptions、createMainAgentPrompt、mainAgentPrompt。关键函数/方法:generateWorkflowCreationPhases、generateSystemPrompt、update_node_parameters、createMainAgentPrompt。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/prompts/legacy-agent.prompt.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/prompts/legacy_agent_prompt.py
