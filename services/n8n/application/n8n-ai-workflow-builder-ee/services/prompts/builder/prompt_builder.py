"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/prompts/builder/prompt-builder.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/prompts/builder 的工作流模块。导入/依赖:外部:无；内部:无；本地:无。导出:PromptBuilder、prompt。关键函数/方法:build、hasContentProperty、normalizeToTag、formatSection、resolveContent、section、sectionIf、merge、buildAsMessageBlocks、estimateTokens 等1项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/prompts/builder/prompt-builder.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/prompts/builder/prompt_builder.py
