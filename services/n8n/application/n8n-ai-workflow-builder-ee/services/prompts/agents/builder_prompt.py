"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/prompts/agents/builder.prompt.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/prompts/agents 的工作流模块。导入/依赖:外部:无；内部:无；本地:../builder、../shared/node-guidance。导出:buildBuilderPrompt。关键函数/方法:buildBuilderPrompt。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:Builder Agent Prompt / Constructs workflow structure by creating nodes and connections based on Discovery results.。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/prompts/agents/builder.prompt.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/prompts/agents/builder_prompt.py
