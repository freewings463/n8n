"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/prompts/agents/discovery.prompt.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/prompts/agents 的工作流模块。导入/依赖:外部:无；内部:无；本地:../builder 等1项。导出:exampleCategorizations、formatTechniqueList、formatExampleCategorizations、DiscoveryPromptOptions 等1项。关键函数/方法:formatTechniqueList、formatExampleCategorizations、generateAvailableToolsList、generateProcessSteps 等1项。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:Discovery Agent Prompt / Identifies relevant n8n nodes and…。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/prompts/agents/discovery.prompt.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/prompts/agents/discovery_prompt.py
