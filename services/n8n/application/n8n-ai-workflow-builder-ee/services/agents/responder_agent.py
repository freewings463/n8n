"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/agents/responder.agent.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/agents 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/messages、@langchain/core/prompts；内部:无；本地:../types/coordination、../types/discovery-types、../types/workflow。导出:ResponderAgentConfig、ResponderContext、ResponderAgent。关键函数/方法:buildContextMessage、invoke。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/agents/responder.agent.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/agents/responder_agent.py
