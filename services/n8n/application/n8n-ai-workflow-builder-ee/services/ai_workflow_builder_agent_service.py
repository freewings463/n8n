"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/ai-workflow-builder-agent.service.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src 的工作流服务。导入/依赖:外部:@langchain/anthropic、@langchain/core/messages 等3项；内部:@n8n/backend-common、@n8n/di 等5项；本地:无。导出:AiWorkflowBuilderService。关键函数/方法:getAnthropicClaudeModel、getApiProxyAuthHeaders、assert、setupModels、filterNodeTypes、getAgent、onGenerationSuccess、trackBuilderReplyTelemetry、getSessions、getBuilderInstanceCredits 等1项。用于封装工作流业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/ai-workflow-builder-agent.service.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/ai_workflow_builder_agent_service.py
