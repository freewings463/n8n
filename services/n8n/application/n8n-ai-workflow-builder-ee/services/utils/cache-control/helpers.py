"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/utils/cache-control/helpers.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/utils/cache-control 的工作流工具。导入/依赖:外部:@langchain/core/messages；内部:无；本地:无。导出:findUserToolMessageIndices、cleanStaleWorkflowContext、applyCacheControlMarkers、applySubgraphCacheMarkers。关键函数/方法:isTextBlock、typeof、hasCacheControl、findUserToolMessageIndices、cleanStaleWorkflowContext、applyCacheControlMarkers、applySubgraphCacheMarkers。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/utils/cache-control/helpers.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/utils/cache-control/helpers.py
