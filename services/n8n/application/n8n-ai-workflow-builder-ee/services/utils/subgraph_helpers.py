"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/utils/subgraph-helpers.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/utils 的工作流工具。导入/依赖:外部:@langchain/core/messages、@langchain/core/tools、@langchain/langgraph；内部:无；本地:../types/langchain、../types/tools、../types/workflow。导出:extractUserRequest、createStandardShouldContinue。关键函数/方法:isCommandUpdate、executeSubgraphTools、extractUserRequest、createStandardShouldContinue。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/utils/subgraph-helpers.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/utils/subgraph_helpers.py
