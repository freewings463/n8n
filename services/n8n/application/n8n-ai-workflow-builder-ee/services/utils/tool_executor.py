"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/utils/tool-executor.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/utils 的工作流工具。导入/依赖:外部:@langchain/core/messages、@langchain/core/tools、@langchain/langgraph；内部:无；本地:../errors、../types/config、../types/tools、../types/workflow 等1项。导出:无。关键函数/方法:isArray、createToolErrorMessage、executeToolsInParallel。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/utils/tool-executor.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/utils/tool_executor.py
