"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/utils/operations-processor.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/utils 的SSO工具。导入/依赖:外部:无；内部:n8n-workflow；本地:../types/workflow。导出:applyOperations、processOperations。关键函数/方法:applyClearOperation、applyRemoveNodeOperation、applyAddNodesOperation、applyUpdateNodeOperation、applySetConnectionsOperation、applyMergeConnectionsOperation、applyRemoveConnectionOperation、applySetNameOperation 等2项。用于提供SSO通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/utils/operations-processor.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/utils/operations_processor.py
