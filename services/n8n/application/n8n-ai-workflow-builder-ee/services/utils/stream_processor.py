"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/src/utils/stream-processor.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/src/utils 的SSO工具。导入/依赖:外部:@langchain/core/messages、@langchain/core/…/tool 等1项；内部:无；本地:无。导出:BuilderToolBase、BuilderTool、StreamEvent、DEFAULT_WORKFLOW_UPDATE_TOOLS 等3项。关键函数/方法:isFromSkippedSubgraph、shouldSkipNode、shouldEmitFromNode、hasMessageInUpdate 等21项。用于提供SSO通用工具能力（纯函数/封装器）供复用。注释目标:===========================================================…。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/src/utils/stream-processor.ts -> services/n8n/application/n8n-ai-workflow-builder-ee/services/utils/stream_processor.py
