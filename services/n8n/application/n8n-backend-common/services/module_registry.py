"""
MIGRATION-META:
  source_path: packages/@n8n/backend-common/src/modules/module-registry.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/backend-common/src/modules 的模块。导入/依赖:外部:无；内部:@n8n/constants、@n8n/decorators、@n8n/di；本地:./errors/missing-module.error、./errors/module-confusion.error、./modules.config、../license-state 等1项。导出:ModuleRegistry。关键函数/方法:loadModules、initModules、refreshModuleSettings、shutdownModule、isActive、getActiveModules。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/backend-common/src/modules/module-registry.ts -> services/n8n/application/n8n-backend-common/services/module_registry.py
