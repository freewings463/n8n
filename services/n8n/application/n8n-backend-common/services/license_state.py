"""
MIGRATION-META:
  source_path: packages/@n8n/backend-common/src/license-state.ts
  target_context: n8n
  target_layer: Application
  responsibility: 位于 packages/@n8n/backend-common/src 的模块。导入/依赖:外部:无；内部:@n8n/constants、@n8n/di、n8n-workflow；本地:./types。导出:LicenseState。关键函数/方法:setLicenseProvider、assertProvider、isLicensed、isCustomRolesLicensed、isDynamicCredentialsLicensed、isSharingLicensed、isLogStreamingLicensed、isLdapLicensed、isSamlLicensed、isOidcLicensed 等35项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/backend-common/src/license-state.ts -> services/n8n/application/n8n-backend-common/services/license_state.py
