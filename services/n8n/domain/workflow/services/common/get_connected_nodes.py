"""
MIGRATION-META:
  source_path: packages/workflow/src/common/get-connected-nodes.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src/common 的工作流模块。导入/依赖:外部:无；内部:无；本地:../interfaces。导出:getConnectedNodes。关键函数/方法:getConnectedNodes。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/common/get-connected-nodes.ts -> services/n8n/domain/workflow/services/common/get_connected_nodes.py
