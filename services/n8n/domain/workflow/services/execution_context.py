"""
MIGRATION-META:
  source_path: packages/workflow/src/execution-context.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:zod/v4；内部:无；本地:./utils。导出:ICredentialContextV1、CredentialContextSchema、ICredentialContext、WorkflowExecuteModeValues、IExecutionContextV1、ExecutionContextSchema、IExecutionContext、PlaintextExecutionContext 等3项。关键函数/方法:toExecutionContext、toCredentialContext。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/execution-context.ts -> services/n8n/domain/workflow/services/execution_context.py
