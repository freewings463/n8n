"""
MIGRATION-META:
  source_path: packages/workflow/src/workflow-checksum.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:jssha；内部:无；本地:./interfaces、./utils。导出:WorkflowSnapshot。关键函数/方法:sortObjectKeys、calculateWorkflowChecksum、arrayBufferToHex。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/workflow-checksum.ts -> services/n8n/domain/workflow/services/workflow_checksum.py
