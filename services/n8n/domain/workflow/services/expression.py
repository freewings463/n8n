"""
MIGRATION-META:
  source_path: packages/workflow/src/expression.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:luxon；内部:@n8n/errors；本地:./errors/expression-extension.error、./errors/expression.error、./expression-evaluator-proxy、./expression-sandboxing 等9项。导出:Expression。关键函数/方法:get、set、isSyntaxError、isExpressionError、isTypeError、setErrorHandler、createSafeObject、safeCreate、defineProperty、createSafeError 等10项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/expression.ts -> services/n8n/domain/workflow/services/expression.py
