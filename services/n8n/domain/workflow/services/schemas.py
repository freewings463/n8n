"""
MIGRATION-META:
  source_path: packages/workflow/src/schemas.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:zod；内部:无；本地:无。导出:INodeParameterResourceLocatorSchema、FieldTypeSchema、GenericValueSchema、IDataObjectSchema、IRequestOptionsSimplifiedAuthSchema、IN8nRequestOperationPaginationBaseSchema、IN8nRequestOperationPaginationGenericSchema、IN8nRequestOperationPaginationOffsetSchema 等37项。关键函数/方法:无。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/schemas.ts -> services/n8n/domain/workflow/services/schemas.py
