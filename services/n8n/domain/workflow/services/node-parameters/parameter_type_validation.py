"""
MIGRATION-META:
  source_path: packages/workflow/src/node-parameters/parameter-type-validation.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src/node-parameters 的工作流模块。导入/依赖:外部:无；内部:无；本地:../errors 等2项。导出:assertParamIsNumber、assertParamIsString、assertParamIsBoolean、assertParamIsOfAnyTypes、assertParamIsArray、validateNodeParameters。关键函数/方法:assert、assertUserInput、assertParamIsNumber、assertParamIsString、assertParamIsBoolean、assertIsValidObject、assertIsRequiredParameter 等7项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/node-parameters/parameter-type-validation.ts -> services/n8n/domain/workflow/services/node-parameters/parameter_type_validation.py
