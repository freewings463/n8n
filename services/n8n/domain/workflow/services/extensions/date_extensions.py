"""
MIGRATION-META:
  source_path: packages/workflow/src/extensions/date-extensions.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src/extensions 的工作流模块。导入/依赖:外部:luxon；内部:无；本地:./extensions、./string-extensions、./utils、../errors/expression-extension.error。导出:dateExtensions。关键函数/方法:isDateTime、toDateTime、generateDurationObject、beginningOf、endOfMonth、extract、unit、format、isBetween、isDst 等10项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/extensions/date-extensions.ts -> services/n8n/domain/workflow/services/extensions/date_extensions.py
