"""
MIGRATION-META:
  source_path: packages/workflow/src/extensions/number-extensions.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src/extensions 的工作流模块。导入/依赖:外部:luxon；内部:无；本地:./extensions、../errors/expression-extension.error。导出:toDateTime、numberExtensions。关键函数/方法:format、isEven、isOdd、floor、ceil、abs、isInteger、round、toBoolean、toInt 等2项。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:@vitest-environment jsdom。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/extensions/number-extensions.ts -> services/n8n/domain/workflow/services/extensions/number_extensions.py
