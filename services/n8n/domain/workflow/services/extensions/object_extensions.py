"""
MIGRATION-META:
  source_path: packages/workflow/src/extensions/object-extensions.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src/extensions 的工作流模块。导入/依赖:外部:无；内部:无；本地:./extensions、../errors/expression-extension.error。导出:compact、urlEncode、toJsonString、toInt、toFloat、toBoolean、toDateTime、objectExtensions。关键函数/方法:delete、isEmpty、isNotEmpty、keys、values、hasField、removeField、removeFieldsContaining、keepFieldsContaining、compact 等6项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/extensions/object-extensions.ts -> services/n8n/domain/workflow/services/extensions/object_extensions.py
