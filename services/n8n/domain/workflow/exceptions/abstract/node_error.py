"""
MIGRATION-META:
  source_path: packages/workflow/src/errors/abstract/node.error.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/workflow/src/errors/abstract 的工作流错误。导入/依赖:外部:无；内部:无；本地:./execution-base.error、../../interfaces、../../utils。导出:无。关键函数/方法:findProperty、addToMessages、setDescriptiveErrorMessage。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/errors/abstract/node.error.ts -> services/n8n/domain/workflow/exceptions/abstract/node_error.py
