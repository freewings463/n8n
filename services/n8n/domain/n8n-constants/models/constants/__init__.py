"""
MIGRATION-META:
  source_path: packages/@n8n/constants/src/index.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/@n8n/constants/src 的入口。导入/依赖:外部:无；内部:无；本地:无。再导出:./api、./browser、./community-nodes、./instance 等2项。导出:LICENSE_FEATURES、LICENSE_QUOTAS、UNLIMITED_LICENSE_QUOTA、DEFAULT_WORKFLOW_HISTORY_PRUNE_LIMIT、BooleanLicenseFeature、NumericLicenseFeature、LDAP_FEATURE_NAME、ConnectionSecurity 等5项。关键函数/方法:无。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/constants/src/index.ts -> services/n8n/domain/n8n-constants/models/constants/__init__.py
