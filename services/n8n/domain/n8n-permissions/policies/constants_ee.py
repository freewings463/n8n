"""
MIGRATION-META:
  source_path: packages/@n8n/permissions/src/constants.ee.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/@n8n/permissions/src 的模块。导入/依赖:外部:无；内部:无；本地:无。导出:DEFAULT_OPERATIONS、RESOURCES、API_KEY_RESOURCES、PROJECT_OWNER_ROLE_SLUG、PROJECT_ADMIN_ROLE_SLUG、PROJECT_EDITOR_ROLE_SLUG、PROJECT_VIEWER_ROLE_SLUG、PROJECT_CHAT_USER_ROLE_SLUG。关键函数/方法:无。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/permissions/src/constants.ee.ts -> services/n8n/domain/n8n-permissions/policies/constants_ee.py
