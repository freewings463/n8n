"""
MIGRATION-META:
  source_path: packages/@n8n/permissions/src/utilities/get-role-scopes.ee.ts
  target_context: n8n
  target_layer: Domain
  responsibility: 位于 packages/@n8n/permissions/src/utilities 的模块。导入/依赖:外部:无；内部:无；本地:../roles/role-maps.ee、../types.ee。导出:COMBINED_ROLE_MAP、getRoleScopes、getAuthPrincipalScopes。关键函数/方法:getRoleScopes、getAuthPrincipalScopes。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/permissions/src/utilities/get-role-scopes.ee.ts -> services/n8n/domain/n8n-permissions/policies/utilities/get_role_scopes_ee.py
