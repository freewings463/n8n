"""
MIGRATION-META:
  source_path: packages/@n8n/node-cli/src/commands/dev/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/node-cli/src/commands/dev 的模块。导入/依赖:外部:node:child_process、node:fs/promises 等1项；内部:无；本地:../utils/json。导出:createSpinner、openUrl、CommandConfig、KeyHandler、CommandsConfig、runCommands、createOpenN8nHandler、buildHelpText。关键函数/方法:calculatePanelHeight、stripScreenControlCodes、getStatusDisplay、getVisibleLength、truncateLine、processStreamData、sleep、createSpinner 等22项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/node-cli/src/commands/dev/utils.ts -> services/n8n/infrastructure/n8n-node-cli/container/bin/commands/dev/utils.py
