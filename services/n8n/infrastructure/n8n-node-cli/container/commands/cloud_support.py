"""
MIGRATION-META:
  source_path: packages/@n8n/node-cli/src/commands/cloud-support.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/node-cli/src/commands 的模块。导入/依赖:外部:@clack/prompts、@oclif/core、node:fs/promises、picocolors；内部:无；本地:../utils/command-suggestions、../utils/package、../utils/prompts。导出:CloudSupport。关键函数/方法:run、enableCloudSupport、intro、outro、disableCloudSupport、confirm、onCancel、updateEslintConfig、updateStrictMode、showCloudSupportStatus。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/node-cli/src/commands/cloud-support.ts -> services/n8n/infrastructure/n8n-node-cli/container/commands/cloud_support.py
