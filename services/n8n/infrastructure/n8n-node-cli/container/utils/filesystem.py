"""
MIGRATION-META:
  source_path: packages/@n8n/node-cli/src/utils/filesystem.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/node-cli/src/utils 的工具。导入/依赖:外部:change-case、node:fs/promises；内部:无；本地:./validation。导出:无。关键函数/方法:folderExists、copyFolder、walkAndCopy、writeFileSafe、ensureFolder、renameFilesInDirectory、renameDirectory、createSymlink。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/node-cli/src/utils/filesystem.ts -> services/n8n/infrastructure/n8n-node-cli/container/utils/filesystem.py
