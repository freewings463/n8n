"""
MIGRATION-META:
  source_path: packages/@n8n/syslog-client/src/client.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/syslog-client/src 的模块。导入/依赖:外部:dgram、net、tls；内部:无；本地:./constants、./schemas、./utils。导出:SyslogClient。关键函数/方法:log、logInternal、errorCb、sendMessage、completionCb、getTransport、notifyAllWaitingRequests、createTcpTransport、createTlsTransport、setupSocketHandlers 等9项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/syslog-client/src/client.ts -> services/n8n/infrastructure/n8n-syslog-client/external_services/clients/client.py
