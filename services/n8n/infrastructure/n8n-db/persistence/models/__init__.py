"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/entities/index.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/entities 的入口。导入/依赖:外部:无；内部:无；本地:./annotation-tag-entity.ee、./annotation-tag-mapping.ee、./api-key、./auth-identity 等31项。导出:entities。关键函数/方法:无。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/entities/index.ts -> services/n8n/infrastructure/n8n-db/persistence/models/__init__.py
