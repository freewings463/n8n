"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/entities/test-case-execution.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/entities 的执行模块。导入/依赖:外部:无；内部:@n8n/typeorm、n8n-workflow；本地:./abstract-entity、./execution-entity、./test-run.ee、./types-db。导出:TestCaseRunMetrics、TestCaseExecutionStatus、TestCaseExecution。关键函数/方法:无。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/entities/test-case-execution.ee.ts -> services/n8n/infrastructure/n8n-db/persistence/models/test_case_execution_ee.py
