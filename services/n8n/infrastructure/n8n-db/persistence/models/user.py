"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/entities/user.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/entities 的模块。导入/依赖:外部:无；内部:@n8n/permissions、n8n-workflow；本地:./abstract-entity、./api-key、./auth-identity、./project-relation 等7项。导出:User。关键函数/方法:preUpsertHook、computeIsPending、toJSON、createPersonalProjectName、toIUser。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/entities/user.ts -> services/n8n/infrastructure/n8n-db/persistence/models/user.py
