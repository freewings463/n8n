"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/repositories/workflow-history.repository.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/repositories 的工作流仓储。导入/依赖:外部:无；内部:@n8n/di、@n8n/typeorm、n8n-workflow；本地:../entities、./workflow-publish-history.repository。导出:WorkflowHistoryRepository。关键函数/方法:deleteEarlierThan、deleteEarlierThanExceptCurrentAndActive、makeSkipActiveAndNamedVersionsRule、getWorkflowIdsInRange、pruneHistory。用于封装工作流数据读写与查询细节，隔离持久层。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/repositories/workflow-history.repository.ts -> services/n8n/infrastructure/n8n-db/persistence/repositories/workflow_history_repository.py
