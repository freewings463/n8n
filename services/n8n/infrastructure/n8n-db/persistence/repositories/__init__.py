"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/repositories/index.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/repositories 的入口。导入/依赖:外部:无；内部:无；本地:无。导出:AnnotationTagMappingRepository、AnnotationTagRepository、ApiKeyRepository、AuthIdentityRepository、AuthProviderSyncHistoryRepository、BinaryDataRepository、CredentialsRepository、ExecutionAnnotationRepository 等27项。关键函数/方法:无。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/repositories/index.ts -> services/n8n/infrastructure/n8n-db/persistence/repositories/__init__.py
