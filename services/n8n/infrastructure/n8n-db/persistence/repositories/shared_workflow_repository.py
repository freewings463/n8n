"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/repositories/shared-workflow.repository.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/repositories 的工作流仓储。导入/依赖:外部:无；内部:@n8n/di、@n8n/permissions、@n8n/typeorm；本地:../entities。导出:SharedWorkflowRepository。关键函数/方法:getSharedWorkflowIds、findByWorkflowIds、findSharingRole、makeOwnerOfAllWorkflows、makeOwner、findWithFields、deleteByIds、findProjectIds、getWorkflowOwningProject、getRelationsByWorkflowIdsAndProjectIds 等2项。用于封装工作流数据读写与查询细节，隔离持久层。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/repositories/shared-workflow.repository.ts -> services/n8n/infrastructure/n8n-db/persistence/repositories/shared_workflow_repository.py
