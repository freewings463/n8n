"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/repositories/test-case-execution.repository.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/repositories 的执行仓储。导入/依赖:外部:无；内部:@n8n/di、@n8n/typeorm、@n8n/typeorm/…/DeepPartial、n8n-workflow；本地:../entities、../entities/types-db。导出:TestCaseExecutionRepository。关键函数/方法:createTestCaseExecution、createBatch、markAsRunning、markAsCompleted、markAllPendingAsCancelled、markAsFailed。用于封装执行数据读写与查询细节，隔离持久层。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/repositories/test-case-execution.repository.ee.ts -> services/n8n/infrastructure/n8n-db/persistence/repositories/test_case_execution_repository_ee.py
