"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/services/auth.roles.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/services 的服务。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/di、@n8n/permissions、@n8n/typeorm；本地:../entities、../repositories。导出:AuthRolesService。关键函数/方法:init、syncScopes、syncRoles。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/services/auth.roles.service.ts -> services/n8n/infrastructure/n8n-db/persistence/repositories/services/auth_roles_service.py
