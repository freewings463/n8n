"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/repositories/folder.repository.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/repositories 的仓储。导入/依赖:外部:无；内部:@n8n/di、@n8n/typeorm、n8n-workflow；本地:../entities、../entities/types-db。导出:FolderRepository。关键函数/方法:getManyAndCount、getMany、getManyQuery、applySelections、applyWorkflowCountSelect、applyDefaultSelect、applyCustomSelect、addBasicFields、addRelationFields、getProjectFields 等16项。用于封装该模块数据读写与查询细节，隔离持久层。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/repositories/folder.repository.ts -> services/n8n/infrastructure/n8n-db/persistence/repositories/folder_repository.py
