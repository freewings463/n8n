"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/mysqldb/index.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/mysqldb 的入口。导入/依赖:外部:无；内部:无；本地:./1588157391238-InitialMigration、./1592447867632-WebhookModel、./1594902918301-CreateIndexStoppedAt、./1607431743767-MakeStoppedAtNullable 等127项。导出:mysqlMigrations。关键函数/方法:无。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/mysqldb/index.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/mysqldb/__init__.py
