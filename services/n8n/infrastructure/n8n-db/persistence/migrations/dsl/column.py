"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/dsl/column.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/dsl 的迁移。导入/依赖:外部:无；内部:@n8n/typeorm；本地:无。导出:Column。关键函数/方法:varchar、timestamp、timestampTimezone、timestampNoTimezone、primaryWithName、default、comment、toOptions。用于定义该模块数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/dsl/column.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/dsl/column.py
