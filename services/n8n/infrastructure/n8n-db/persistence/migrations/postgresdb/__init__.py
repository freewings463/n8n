"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/postgresdb/index.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/postgresdb 的入口。导入/依赖:外部:无；内部:无；本地:./1587669153312-InitialMigration、./1589476000887-WebhookModel、./1594828256133-CreateIndexStoppedAt、./1607431743768-MakeStoppedAtNullable 等131项。导出:postgresMigrations。关键函数/方法:无。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/postgresdb/index.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/postgresdb/__init__.py
