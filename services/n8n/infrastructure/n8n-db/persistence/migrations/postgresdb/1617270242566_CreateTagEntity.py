"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/postgresdb/1617270242566-CreateTagEntity.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/postgresdb 的迁移。导入/依赖:外部:无；内部:无；本地:../migration-types。导出:CreateTagEntity1617270242566。关键函数/方法:up、down。用于定义该模块数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/postgresdb/1617270242566-CreateTagEntity.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/postgresdb/1617270242566_CreateTagEntity.py
