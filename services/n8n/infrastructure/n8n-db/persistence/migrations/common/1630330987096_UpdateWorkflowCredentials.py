"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/common/1630330987096-UpdateWorkflowCredentials.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/common 的工作流迁移。导入/依赖:外部:无；内部:n8n-workflow；本地:../../entities、../migration-types。导出:UpdateWorkflowCredentials1630330987096。关键函数/方法:up、down。用于定义工作流数据库迁移步骤（新增表/字段/索引等）。注释目标:eslint-disable @typescript-eslint/ban-ts-comment。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/common/1630330987096-UpdateWorkflowCredentials.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/common/1630330987096_UpdateWorkflowCredentials.py
