"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/common/1714133768519-CreateProject.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/common 的迁移。导入/依赖:外部:nanoid；内部:@n8n/permissions、n8n-workflow；本地:../../entities、../utils/generators、../migration-types。导出:CreateProject1714133768519。关键函数/方法:escapeNames、setupTables、column、alterSharedTable、FROM、alterSharedCredentials、alterSharedWorkflow、createUserPersonalProjects、async、createPersonalProjectName 等2项。用于定义该模块数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/common/1714133768519-CreateProject.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/common/1714133768519_CreateProject.py
