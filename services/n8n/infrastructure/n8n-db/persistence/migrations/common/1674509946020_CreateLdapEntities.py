"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/common/1674509946020-CreateLdapEntities.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/common 的LDAP迁移。导入/依赖:外部:无；内部:@n8n/constants；本地:../migration-types。导出:CreateLdapEntities1674509946020。关键函数/方法:up、VALUES、down。用于定义LDAP数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/common/1674509946020-CreateLdapEntities.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/common/1674509946020_CreateLdapEntities.py
