"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/common/1762763704614-BackfillMissingWorkflowHistoryRecords.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/common 的工作流迁移。导入/依赖:外部:无；内部:无；本地:../migration-types。导出:BackfillMissingWorkflowHistoryRecords1762763704614。关键函数/方法:up、OR。用于定义工作流数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/common/1762763704614-BackfillMissingWorkflowHistoryRecords.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/common/1762763704614_BackfillMissingWorkflowHistoryRecords.py
