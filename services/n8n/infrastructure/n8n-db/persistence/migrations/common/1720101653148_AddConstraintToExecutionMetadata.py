"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/common/1720101653148-AddConstraintToExecutionMetadata.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/common 的执行迁移。导入/依赖:外部:nanoid；内部:无；本地:../migration-types。导出:AddConstraintToExecutionMetadata1720101653148。关键函数/方法:up、column、down。用于定义执行数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/common/1720101653148-AddConstraintToExecutionMetadata.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/common/1720101653148_AddConstraintToExecutionMetadata.py
