"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/sqlite/index.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/sqlite 的入口。导入/依赖:外部:无；内部:无；本地:./1588102412422-InitialMigration、./1592445003908-WebhookModel、./1594825041918-CreateIndexStoppedAt、./1607431743769-MakeStoppedAtNullable 等125项。导出:sqliteMigrations。关键函数/方法:无。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/sqlite/index.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/sqlite/__init__.py
