"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/sqlite/1665484192211-CreateCredentialUsageTable.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/sqlite 的迁移。导入/依赖:外部:无；内部:无；本地:../migration-types。导出:CreateCredentialUsageTable1665484192211。关键函数/方法:up、down。用于定义该模块数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/sqlite/1665484192211-CreateCredentialUsageTable.ts -> services/n8n/infrastructure/n8n-db/persistence/migrations/sqlite/1665484192211_CreateCredentialUsageTable.py
