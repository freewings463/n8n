"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/sqlite/1690000000002-MigrateIntegerKeysToString.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/sqlite 的迁移。导入/依赖:外部:无；内部:@n8n/config、@n8n/di、n8n-core；本地:../migration-types。导出:MigrateIntegerKeysToString1690000000002。关键函数/方法:up、UNIQUE、getSqliteDbFileSize、pruneExecutionsData。用于定义该模块数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/sqlite/1690000000002-MigrateIntegerKeysToString.ts -> services/n8n/infrastructure/n8n-db/container/migrations/sqlite/1690000000002_MigrateIntegerKeysToString.py
