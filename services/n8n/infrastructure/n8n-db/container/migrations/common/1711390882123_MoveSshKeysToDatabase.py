"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/migrations/common/1711390882123-MoveSshKeysToDatabase.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/db/src/migrations/common 的迁移。导入/依赖:外部:node:fs/promises；内部:@n8n/di、n8n-core、n8n-workflow；本地:../migration-types。导出:MoveSshKeysToDatabase1711390882123。关键函数/方法:up、readFile、down、writeFile。用于定义该模块数据库迁移步骤（新增表/字段/索引等）。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/migrations/common/1711390882123-MoveSshKeysToDatabase.ts -> services/n8n/infrastructure/n8n-db/container/migrations/common/1711390882123_MoveSshKeysToDatabase.py
