"""
MIGRATION-META:
  source_path: packages/@n8n/client-oauth2/src/code-flow.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/client-oauth2/src 的OAuth模块。导入/依赖:外部:querystring；内部:无；本地:./client-oauth2、./client-oauth2-token、./constants、./utils。导出:CodeFlow。关键函数/方法:getUri、expects、getToken。用于承载OAuth实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/client-oauth2/src/code-flow.ts -> services/n8n/infrastructure/n8n-client-oauth2/external_services/clients/code_flow.py
