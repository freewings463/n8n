"""
MIGRATION-META:
  source_path: packages/@n8n/benchmark/scripts/run-for-n8n-setup.mjs
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/benchmark/scripts 的模块。导入/依赖:外部:zx；内部:无；本地:./clients/docker-compose-client.mjs、./utils/flags.mjs。导出:无。关键函数/方法:discoverRunnerServices、main、validateN8nSetup、printContainerStatus、dumpLogs、printUsage、getAllN8nSetups。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/benchmark/scripts/run-for-n8n-setup.mjs -> services/n8n/infrastructure/n8n-benchmark/container/bin/benchmark/run_for_n8n_setup.py
