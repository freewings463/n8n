"""
MIGRATION-META:
  source_path: packages/@n8n/benchmark/src/test-execution/scenario-data-importer.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/benchmark/src/test-execution 的执行模块。导入/依赖:外部:无；内部:@/n8n-api-client/authenticated-n8n-api-client、@/n8n-api-client/credentials-api-client 等5项；本地:无。导出:ScenarioDataImporter。关键函数/方法:replaceValuesInObject、importTestScenarioData、importCredentials、importDataTable、importWorkflow、findExistingCredentials、findExistingWorkflows、getBenchmarkCredentialName 等2项。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/benchmark/src/test-execution/scenario-data-importer.ts -> services/n8n/infrastructure/n8n-benchmark/container/scenario_data_importer.py
