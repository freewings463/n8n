"""
MIGRATION-META:
  source_path: packages/@n8n/benchmark/scripts/run.mjs
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/benchmark/scripts 的模块。导入/依赖:外部:minimist；内部:无；本地:./run-in-cloud.mjs、./run-locally.mjs。导出:无。关键函数/方法:main、printUsage、readAvailableN8nSetups、parseAndValidateConfig、getAndValidateN8nSetup。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/benchmark/scripts/run.mjs -> services/n8n/infrastructure/n8n-benchmark/container/scripts/run.py
