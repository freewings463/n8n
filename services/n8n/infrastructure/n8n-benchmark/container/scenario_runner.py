"""
MIGRATION-META:
  source_path: packages/@n8n/benchmark/src/test-execution/scenario-runner.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/benchmark/src/test-execution 的执行模块。导入/依赖:外部:zx；内部:@/n8n-api-client/authenticated-n8n-api-client、@/n8n-api-client/n8n-api-client、@/scenario/scenario-data-loader、@/test-execution/scenario-data-importer、@/types/scenario；本地:./k6-executor。导出:ScenarioRunner。关键函数/方法:runManyScenarios、runSingleTestScenario、formTestScenarioRunName。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/benchmark/src/test-execution/scenario-runner.ts -> services/n8n/infrastructure/n8n-benchmark/container/scenario_runner.py
