"""
MIGRATION-META:
  source_path: packages/@n8n/benchmark/src/test-execution/k6-summary.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/benchmark/src/test-execution 的执行模块。导入/依赖:外部:无；内部:无；本地:无。导出:无。关键函数/方法:无。用于承载执行实现细节，并通过导出对外提供能力。注释目标:Example JSON: / {。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/benchmark/src/test-execution/k6-summary.ts -> services/n8n/infrastructure/n8n-benchmark/container/k6_summary.py
