"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/utils/request-helper-functions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context/utils 的执行工具。导入/依赖:外部:axios、form-data 等6项；内部:@n8n/backend-common、@n8n/client-oauth2 等4项；本地:./binary-helper-functions 等1项。导出:createFormDataObject、convertN8nRequestToAxios、removeEmptyBody、applyPaginationRequestData。关键函数/方法:validateUrl、getUrlFromProxyConfig、buildTargetUrl、setAxiosAgents 等18项。用于提供执行通用工具能力（纯函数/封装器）供复用。注释目标:eslint-disable @typ…
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/utils/request-helper-functions.ts -> services/n8n/infrastructure/core/external_services/clients/execution-engine/node-execution-context/utils/request_helper_functions.py
