"""
MIGRATION-META:
  source_path: packages/core/src/execution-engine/node-execution-context/utils/binary-helper-functions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/core/src/execution-engine/node-execution-context/utils 的执行工具。导入/依赖:外部:chardet、file-type 等4项；内部:@n8n/di、@/binary-data/binary-data.service 等2项；本地:./parse-incoming-message。导出:assertBinaryData、detectBinaryEncoding、getBinaryHelperFunctions。关键函数/方法:binaryToString、parseIncomingMessage、getBinaryPath、getBinaryMetadata、getBinaryStream、assertBinaryData 等7项。用于提供执行通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/core/src/execution-engine/node-execution-context/utils/binary-helper-functions.ts -> services/n8n/infrastructure/core/container/execution-engine/node-execution-context/utils/binary_helper_functions.py
