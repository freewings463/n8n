"""
MIGRATION-META:
  source_path: packages/@n8n/eslint-config/src/configs/base.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/eslint-config/src/configs 的模块。导入/依赖:外部:eslint/config、@eslint/js、eslint-plugin-import-x、@typescript-eslint/eslint-plugin、eslint-plugin-unused-imports、@stylistic/eslint-plugin 等5项；内部:无；本地:../plugin.js。导出:baseConfig。关键函数/方法:globalIgnores。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/eslint-config/src/configs/base.ts -> services/n8n/infrastructure/n8n-eslint-config/configuration/tooling/src/configs/base.py
