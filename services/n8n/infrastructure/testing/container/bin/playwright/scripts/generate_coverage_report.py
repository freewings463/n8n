"""
MIGRATION-META:
  source_path: packages/testing/playwright/scripts/generate-coverage-report.js
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/scripts 的模块。导入/依赖:外部:无；内部:无；本地:无。导出:无。关键函数/方法:findCoverageDirectories、main、execSync。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/scripts/generate-coverage-report.js -> services/n8n/infrastructure/testing/container/bin/playwright/scripts/generate_coverage_report.py
