"""
MIGRATION-META:
  source_path: packages/testing/playwright/services/workflow-api-helper.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/services 的工作流服务。导入/依赖:外部:nanoid；内部:n8n-workflow；本地:./api-helper、../Types、../utils/path-helper。导出:WorkflowApiHelper。关键函数/方法:delete、createWorkflow、createInProject、activate、deactivate、archive、transfer、makeWorkflowUnique、createWorkflowFromDefinition、importWorkflowFromFile 等5项。用于封装工作流业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/services/workflow-api-helper.ts -> services/n8n/infrastructure/testing/container/playwright/services/workflow_api_helper.py
