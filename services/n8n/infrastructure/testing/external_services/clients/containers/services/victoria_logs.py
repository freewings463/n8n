"""
MIGRATION-META:
  source_path: packages/testing/containers/services/victoria-logs.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/containers/services 的服务。导入/依赖:外部:testcontainers、node:timers/promises；内部:无；本地:../test-containers、./types。导出:VictoriaLogsMeta、VictoriaLogsResult、victoriaLogs、LogEntry、LogQueryOptions、LogsHelper、createLogsHelper、escapeLogsQL。关键函数/方法:start、env、query、waitForLog、createLogsHelper、escapeLogsQL。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/containers/services/victoria-logs.ts -> services/n8n/infrastructure/testing/external_services/clients/containers/services/victoria_logs.py
