"""
MIGRATION-META:
  source_path: packages/testing/playwright/reporters/metrics-reporter.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/testing/playwright/reporters 的模块。导入/依赖:外部:@playwright/test/reporter、assert、zod；内部:无；本地:无。导出:无。关键函数/方法:onTestEnd、collectMetrics、sendMetrics、assert、onEnd、getGitInfo。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/testing/playwright/reporters/metrics-reporter.ts -> services/n8n/infrastructure/testing/monitoring/playwright/reporters/metrics_reporter.py
