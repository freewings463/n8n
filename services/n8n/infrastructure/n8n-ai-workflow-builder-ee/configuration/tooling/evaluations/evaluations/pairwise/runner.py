"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise/runner.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise 的工作流模块。导入/依赖:外部:langsmith/evaluation、picocolors；内部:无；本地:./generator、./judge-panel、./metrics-builder 等7项。导出:PairwiseEvaluationOptions、LocalPairwiseOptions。关键函数/方法:getNotionId、id、getCategories、categories、filterByEvalField、filterByNotionId、filterByTechnique、filterExamples、logFeatureFlags、logPairwiseConfig 等7项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise/runner.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/pairwise/runner.py
