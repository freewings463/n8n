"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/types/langsmith.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/types 的工作流类型。导入/依赖:外部:@langchain/core/messages；内部:@/utils/stream-processor；本地:../types/workflow 等1项。导出:UsageMetadata、WorkflowOutput、WorkflowStateValues、isMessageWithMetadata、hasUsageMetadata、isValidPrompt、isSimpleWorkflow 等5项。关键函数/方法:isMessageWithMetadata、hasUsageMetadata、isValidPrompt、isSimpleWorkflow 等5项。用于定义工作流相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/types/langsmith.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/types/langsmith.py
