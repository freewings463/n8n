"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/utils/evaluation-reporter.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/utils 的工作流工具。导入/依赖:外部:cli-table3、picocolors；内部:@/validation/types；本地:./cache-analyzer.js 等2项。导出:generateMarkdownReport、displayTestResults、displaySummaryTable、displayCacheStatistics、displayViolationsDetail。关键函数/方法:generateMarkdownReport、displayTestResults、displaySummaryTable、displayCacheStatistics、hitRateColor 等2项。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/utils/evaluation-reporter.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/utils/evaluation_reporter.py
