"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/langsmith/runner.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/langsmith 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、langsmith/evaluation、langsmith/langchain、langsmith/traceable、picocolors；内部:n8n-workflow；本地:./evaluator、../src/workflow-builder-agent、../src/workflow-state、../constants 等2项。导出:无。关键函数/方法:createWorkflowGenerator、async、getChatPayload、runLangsmithEvaluation。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/langsmith/runner.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/langsmith/runner.py
