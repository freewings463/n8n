"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/utils/evaluation-calculator.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/utils 的工作流工具。导入/依赖:外部:无；内部:无；本地:../types/test-result.js。导出:calculateCategoryAverages、countViolationsByType、calculateTestMetrics、calculateAverageGenerationTime、groupResultsByStatus 等2项。关键函数/方法:calculateCategoryAverages、countViolationsByType、calculateTestMetrics、calculateAverageGenerationTime 等3项。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/utils/evaluation-calculator.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/utils/evaluation_calculator.py
