"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/langsmith/evaluator.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/langsmith 的工作流评估器。导入/依赖:外部:@langchain/core/…/chat_models、langsmith/evaluation 等1项；内部:n8n-workflow；本地:../types/workflow.js、../chains/workflow-evaluator.js、../programmatic/programmatic-evaluation 等1项。导出:createLangsmithEvaluator。关键函数/方法:validateRunOutputs、extractUsageMetadata、categoryToResult、createLangsmithEvaluator。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/langsmith/evaluator.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/langsmith/evaluator.py
