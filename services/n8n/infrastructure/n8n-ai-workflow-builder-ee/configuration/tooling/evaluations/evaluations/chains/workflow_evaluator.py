"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/chains/workflow-evaluator.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/chains 的工作流评估器。导入/依赖:外部:@langchain/core/…/chat_models；内部:无；本地:../types/evaluation。导出:calculateWeightedScore。关键函数/方法:calculateWeightedScore、generateEvaluationSummary、identifyCriticalIssues、evaluateWorkflow、evaluateFunctionality、evaluateConnections、evaluateExpressions、evaluateNodeConfiguration、evaluateEfficiency 等3项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/chains/workflow-evaluator.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/chains/workflow_evaluator.py
