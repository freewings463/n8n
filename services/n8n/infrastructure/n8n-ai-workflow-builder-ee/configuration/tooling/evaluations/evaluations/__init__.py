"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/index.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations 的工作流入口。导入/依赖:外部:无；内部:@/workflow-builder-agent；本地:./cli/runner.js、./langsmith/runner.js、./pairwise/runner.js 等1项。导出:runCliEvaluation、runLangsmithEvaluation、runSingleTest、setupTestEnvironment、createAgent。关键函数/方法:validateCliArgs、getIntFlag、parseFilterFlags、parseCliArgs、main、getFlagValue、parseFeatureFlags。用于汇总导出并完成工作流模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/index.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/__init__.py
