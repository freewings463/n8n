"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/core/environment.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/core 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/…/tracer_langchain 等2项；内部:n8n-workflow；本地:../src/llm-config.js 等2项。导出:TestEnvironment、createTracer、createLangsmithClient、CreateAgentOptions、createAgent、getConcurrencyLimit 等2项。关键函数/方法:setupLLM、createTracer、createLangsmithClient、setupTestEnvironment 等4项。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/core/environment.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/core/environment.py
