"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise/metrics-builder.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise 的工作流模块。导入/依赖:外部:langsmith/evaluation、langsmith/schemas；内部:无；本地:./judge-panel、./types、../constants。导出:buildSingleGenerationResults、buildMultiGenerationResults。关键函数/方法:buildSingleGenerationResults、buildMultiGenerationResults、pairwiseLangsmithEvaluator。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/pairwise/metrics-builder.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/configuration/tooling/evaluations/evaluations/pairwise/metrics_builder.py
