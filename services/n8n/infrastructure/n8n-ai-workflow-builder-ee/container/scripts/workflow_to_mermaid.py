"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/scripts/workflow-to-mermaid.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/scripts 的工作流模块。导入/依赖:外部:picocolors；内部:n8n-workflow、@/tools/…/mermaid.utils、@/types、@/types/workflow；本地:无。导出:无。关键函数/方法:isDirectWorkflowFormat、isWorkflowMetadataFormat、workflow、printUsage、parseArgs、loadWorkflow、main、join、writeFileSync。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/scripts/workflow-to-mermaid.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/container/scripts/workflow_to_mermaid.py
