"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/programmatic/evaluators/workflow-similarity.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/programmatic/evaluators 的工作流评估器。导入/依赖:外部:node:child_process、node:fs/promises、node:util；内部:@/types、@/validation/types；本地:无。导出:无。关键函数/方法:isExecError、mapEditTypeToViolationName、isWorkflowSimilarityResult、evaluateWorkflowSimilarity、writeFile、evaluateWorkflowSimilarityMultiple、async。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/programmatic/evaluators/workflow-similarity.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/container/bin/evaluations/programmatic/evaluators/workflow_similarity.py
