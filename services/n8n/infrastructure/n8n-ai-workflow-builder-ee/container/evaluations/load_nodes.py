"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/load-nodes.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations 的工作流模块。导入/依赖:外部:无；内部:n8n-workflow；本地:无。导出:loadNodesFromFile。关键函数/方法:getDisabledNodes、filterNodeTypes、loadNodesFromFile。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/load-nodes.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/container/evaluations/load_nodes.py
