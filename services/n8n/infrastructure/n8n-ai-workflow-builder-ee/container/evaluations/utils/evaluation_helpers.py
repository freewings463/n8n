"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/utils/evaluation-helpers.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/utils 的工作流工具。导入/依赖:外部:picocolors、uuid；内部:无；本地:../src/workflow-builder-agent 等2项。导出:formatPercentage、formatElapsedTime、formatColoredScore、formatHeader、formatStatusBadge、formatViolationType、formatTestName、saveEvaluationResults 等2项。关键函数/方法:formatPercentage、formatElapsedTime、formatColoredScore、formatHeader 等7项。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/utils/evaluation-helpers.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/container/evaluations/utils/evaluation_helpers.py
