"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/utils/artifact-saver.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/utils 的工作流工具。导入/依赖:外部:无；内部:无；本地:./logger、../pairwise/judge-panel。导出:ArtifactSaver、createArtifactSaver。关键函数/方法:savePrompt、saveGeneration、saveSummary、createArtifactSaver。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/utils/artifact-saver.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/container/evaluations/utils/artifact_saver.py
