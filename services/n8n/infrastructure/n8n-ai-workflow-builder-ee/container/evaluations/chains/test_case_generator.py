"""
MIGRATION-META:
  source_path: packages/@n8n/ai-workflow-builder.ee/evaluations/chains/test-case-generator.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/ai-workflow-builder.ee/evaluations/chains 的工作流模块。导入/依赖:外部:@langchain/core/…/chat_models、@langchain/core/messages、@langchain/core/prompts、zod；内部:n8n-workflow；本地:../types/workflow、../types/evaluation。导出:createTestCaseGeneratorChain、basicTestCases。关键函数/方法:loadReferenceWorkflow、createTestCaseGeneratorChain、generateTestCases、result。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/ai-workflow-builder.ee/evaluations/chains/test-case-generator.ts -> services/n8n/infrastructure/n8n-ai-workflow-builder-ee/container/evaluations/chains/test_case_generator.py
