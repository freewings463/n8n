"""
MIGRATION-META:
  source_path: packages/cli/src/modules/chat-hub/chat-hub-message.entity.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/chat-hub 的模块。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/db、n8n-workflow；本地:./chat-hub-session.entity。导出:ChatHubMessage。关键函数/方法:无。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/chat-hub/chat-hub-message.entity.ts -> services/n8n/infrastructure/cli/persistence/models/modules/chat-hub/chat_hub_message_entity.py
