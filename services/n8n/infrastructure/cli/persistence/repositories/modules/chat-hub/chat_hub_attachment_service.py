"""
MIGRATION-META:
  source_path: packages/cli/src/modules/chat-hub/chat-hub.attachment.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/chat-hub 的服务。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/di、@n8n/typeorm、@n8n/utils、n8n-core、n8n-workflow 等2项；本地:./chat-message.repository。导出:ChatHubAttachmentService。关键函数/方法:store、getAttachment、deleteAllBySessionId、deleteAll、deleteAttachments、getDataUrl、getAsBuffer、processAttachment。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/chat-hub/chat-hub.attachment.service.ts -> services/n8n/infrastructure/cli/persistence/repositories/modules/chat-hub/chat_hub_attachment_service.py
