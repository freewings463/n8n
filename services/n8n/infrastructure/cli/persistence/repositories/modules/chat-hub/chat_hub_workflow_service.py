"""
MIGRATION-META:
  source_path: packages/cli/src/modules/chat-hub/chat-hub-workflow.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/chat-hub 的工作流服务。导入/依赖:外部:luxon、uuid；内部:@n8n/backend-common、@n8n/di 等1项；本地:./chat-hub-message.entity 等5项。导出:ChatHubWorkflowService。关键函数/方法:createChatWorkflow、createTitleGenerationWorkflow、prepareExecutionData、parseInputModalities、getUniqueNodeName、buildChatWorkflow、buildTitleGenerationWorkflow、buildChatTriggerNode、getSystemMessageMetadata 等11项。用于封装工作流业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/chat-hub/chat-hub-workflow.service.ts -> services/n8n/infrastructure/cli/persistence/repositories/modules/chat-hub/chat_hub_workflow_service.py
