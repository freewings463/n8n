"""
MIGRATION-META:
  source_path: packages/cli/src/modules/source-control.ee/source-control-scoped.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/source-control.ee 的服务。导入/依赖:外部:无；内部:@n8n/db、@n8n/di 等3项；本地:./types/source-control-context。导出:SourceControlScopedService。关键函数/方法:ensureIsAllowedToPush、getAuthorizedProjectsFromContext、getWorkflowsInAdminProjectsFromContext、getProjectsWithPushScopeByContextFilter、getFoldersInAdminProjectsFromContextFilter 等3项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/source-control.ee/source-control-scoped.service.ts -> services/n8n/infrastructure/cli/persistence/repositories/modules/source-control.ee/source_control_scoped_service.py
