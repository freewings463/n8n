"""
MIGRATION-META:
  source_path: packages/cli/src/modules/source-control.ee/source-control-import.service.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/source-control.ee 的服务。导入/依赖:外部:fast-glob、lodash/isEqual 等2项；内部:@n8n/api-types、@n8n/backend-common 等14项；本地:./source-control-scoped.service 等7项。导出:SourceControlImportService。关键函数/方法:findOwnerProject、getOwnerFromProject、getRemoteVersionIdsFromFiles、getAllLocalVersionIdsFromDb、getLocalVersionIdsFromDb、getRemoteCredentialsFromFiles 等15项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/source-control.ee/source-control-import.service.ee.ts -> services/n8n/infrastructure/cli/persistence/repositories/modules/source-control.ee/source_control_import_service_ee.py
