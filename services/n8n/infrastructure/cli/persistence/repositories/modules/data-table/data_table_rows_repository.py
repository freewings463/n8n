"""
MIGRATION-META:
  source_path: packages/cli/src/modules/data-table/data-table-rows.repository.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/data-table 的仓储。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/db、@n8n/di；本地:./data-table-column.entity、./data-table.types。导出:DataTableRowsRepository。关键函数/方法:getConditionAndParams、insertRowsBulk、updateRows、dryRunUpdateRows、dryRunUpsertRow、deleteRows、prepareUpdateData、toDryRunRows、template、getManyAndCount 等6项。用于封装该模块数据读写与查询细节，隔离持久层。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/data-table/data-table-rows.repository.ts -> services/n8n/infrastructure/cli/persistence/repositories/modules/data-table/data_table_rows_repository.py
