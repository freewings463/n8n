"""
MIGRATION-META:
  source_path: packages/cli/src/modules/data-table/data-table-column.repository.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/data-table 的仓储。导入/依赖:外部:无；内部:@n8n/api-types、@n8n/db、@n8n/di 等1项；本地:./data-table-column.entity、./data-table-ddl.service、./data-table.entity、./errors/data-table-column-name-conflict.error 等2项。导出:DataTableColumnRepository。关键函数/方法:validateNotSystemColumn、validateUniqueColumnName、getColumns、addColumn、deleteColumn、moveColumn、renameColumn、shiftColumns。用于封装该模块数据读写与查询细节，隔离持久层。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/data-table/data-table-column.repository.ts -> services/n8n/infrastructure/cli/persistence/repositories/modules/data-table/data_table_column_repository.py
