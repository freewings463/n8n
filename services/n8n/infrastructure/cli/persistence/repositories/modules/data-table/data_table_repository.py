"""
MIGRATION-META:
  source_path: packages/cli/src/modules/data-table/data-table.repository.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/data-table 的仓储。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/config 等4项；本地:./data-table-column.entity、./data-table-ddl.service 等5项。导出:DataTableRepository。关键函数/方法:touchUpdatedAt、createDataTable、deleteDataTable、transferDataTableByProjectId、deleteDataTableByProjectId、deleteDataTableAll、getManyAndCount、getMany、getManyQuery、applySelections 等12项。用于封装该模块数据读写与查询细节，隔离持久层。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/data-table/data-table.repository.ts -> services/n8n/infrastructure/cli/persistence/repositories/modules/data-table/data_table_repository.py
