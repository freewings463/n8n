"""
MIGRATION-META:
  source_path: packages/cli/src/modules/mcp/mcp-oauth-token.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/modules/mcp 的OAuth服务。导入/依赖:外部:@modelcontextprotocol/sdk/…/types、@modelcontextprotocol/sdk/…/auth；内部:@n8n/backend-common、@n8n/constants 等5项；本地:../entities/oauth-access-token.entity 等5项。导出:McpOAuthTokenService。关键函数/方法:generateTokenPair、saveTokenPair、validateAndRotateRefreshToken、verifyAccessToken、verifyOAuthAccessToken、revokeAccessToken、revoked 等1项。用于封装OAuth业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/mcp/mcp-oauth-token.service.ts -> services/n8n/infrastructure/cli/persistence/repositories/modules/mcp/mcp_oauth_token_service.py
