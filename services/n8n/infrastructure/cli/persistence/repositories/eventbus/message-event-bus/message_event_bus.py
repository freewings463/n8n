"""
MIGRATION-META:
  source_path: packages/cli/src/eventbus/message-event-bus/message-event-bus.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/eventbus/message-event-bus 的模块。导入/依赖:外部:lodash/uniqBy；内部:@n8n/backend-common、@n8n/config 等7项；本地:../executions/execution-recovery.service 等11项。导出:EventMessageReturnMode、MessageWithCallback、MessageEventBusInitializeOptions、MessageEventBus。关键函数/方法:initialize、dbUnfinishedExecutionIds、clearInterval、addDestination、findDestination、removeDestination 等25项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/eventbus/message-event-bus/message-event-bus.ts -> services/n8n/infrastructure/cli/persistence/repositories/eventbus/message-event-bus/message_event_bus.py
