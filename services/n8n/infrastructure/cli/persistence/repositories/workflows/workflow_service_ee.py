"""
MIGRATION-META:
  source_path: packages/cli/src/workflows/workflow.service.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/workflows 的工作流服务。导入/依赖:外部:lodash/omit；内部:@n8n/backend-common、@n8n/di 等12项；本地:./workflow-finder.service。导出:EnterpriseWorkflowService。关键函数/方法:shareWithProjects、addOwnerAndSharings、addCredentialsToWorkflow、validateCredentialPermissionsToUser、isTamperingAttempt、omit、getNodesWithInaccessibleCreds、transferWorkflow、getFolderUsedCredentials、transferFolder 等7项。用于封装工作流业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/workflows/workflow.service.ee.ts -> services/n8n/infrastructure/cli/persistence/repositories/workflows/workflow_service_ee.py
