"""
MIGRATION-META:
  source_path: packages/cli/src/ldap.ee/ldap.service.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/ldap.ee 的LDAP服务。导入/依赖:外部:ldapts、tls；内部:@n8n/backend-common、@n8n/config、@n8n/constants、@n8n/db、@n8n/di、@n8n/typeorm 等5项；本地:./constants。导出:LdapService。关键函数/方法:init、loadConfig、updateConfig、setConfig、setGlobalLdapConfigVariables、setLdapLoginEnabled、getClient、bindAdmin、searchWithAdminBinding、hasEmailDuplicatesInLdap 等15项。用于封装LDAP业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/ldap.ee/ldap.service.ee.ts -> services/n8n/infrastructure/cli/persistence/repositories/ldap.ee/ldap_service_ee.py
