"""
MIGRATION-META:
  source_path: packages/cli/src/credentials/credentials-finder.service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/credentials 的服务。导入/依赖:外部:无；内部:@n8n/db、@n8n/di、@n8n/permissions、@n8n/typeorm、@/services/role.service；本地:无。导出:CredentialsFinderService。关键函数/方法:fetchGlobalCredentials、hasGlobalReadOnlyAccess、findGlobalCredentialById、findCredentialById、findCredentialsForUser、findCredentialForUser、findAllCredentialsForUser、getCredentialIdsByUserAndRole。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/credentials/credentials-finder.service.ts -> services/n8n/infrastructure/cli/persistence/repositories/credentials/credentials_finder_service.py
