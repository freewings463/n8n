"""
MIGRATION-META:
  source_path: packages/cli/src/utils/compression.util.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/utils 的工具。导入/依赖:外部:fflate、fs/promises；内部:@n8n/backend-common；本地:无。导出:CompressionOptions、DecompressionOptions。关键函数/方法:sanitizePath、compressFolder、decompressFolder、mkdir、reject、resolve、addDirectoryToZipStreaming。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/utils/compression.util.ts -> services/n8n/infrastructure/cli/container/utils/compression_util.py
