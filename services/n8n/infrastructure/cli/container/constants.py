"""
MIGRATION-META:
  source_path: packages/cli/src/constants.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:无；内部:@n8n/constants、n8n-core、n8n-workflow；本地:无。导出:inE2ETests、CUSTOM_API_CALL_NAME、CUSTOM_API_CALL_KEY、CLI_DIR、TEMPLATES_DIR、NODES_BASE_DIR、EDITOR_UI_DIST_DIR、N8N_VERSION 等29项。关键函数/方法:无。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/constants.ts -> services/n8n/infrastructure/cli/container/constants.py
