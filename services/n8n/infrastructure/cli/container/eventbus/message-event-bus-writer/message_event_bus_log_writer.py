"""
MIGRATION-META:
  source_path: packages/cli/src/eventbus/message-event-bus-writer/message-event-bus-log-writer.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/eventbus/message-event-bus-writer 的模块。导入/依赖:外部:lodash/remove、readline 等1项；内部:@n8n/backend-common、@n8n/config 等3项；本地:../event-message-classes 等8项。导出:MessageEventBusLogWriterOptions、MessageEventBusLogWriter。关键函数/方法:getInstance、startLogging、startRecoveryProcess、isRecoveryProcessRunning 等21项。用于承载该模块实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-unsafe-member-access。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/eventbus/message-event-bus-writer/message-event-bus-log-writer.ts -> services/n8n/infrastructure/cli/container/eventbus/message-event-bus-writer/message_event_bus_log_writer.py
