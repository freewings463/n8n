"""
MIGRATION-META:
  source_path: packages/cli/src/sso.ee/saml/schema/ws-federation.xsd.ts
  target_context: n8n
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/sso.ee/saml/schema/ws-federation.xsd.ts -> services/n8n/infrastructure/cli/configuration/sso.ee/saml/schema/ws_federation_xsd.py
