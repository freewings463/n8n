"""
MIGRATION-META:
  source_path: packages/cli/src/sso.ee/saml/schema/metadata-exchange.xsd.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/sso.ee/saml/schema 的SSO模块。导入/依赖:外部:xmllint-wasm；内部:无；本地:无。导出:xmlFileInfo。关键函数/方法:webMethods。用于承载SSO实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/sso.ee/saml/schema/metadata-exchange.xsd.ts -> services/n8n/infrastructure/cli/configuration/sso.ee/saml/schema/metadata_exchange_xsd.py
