"""
MIGRATION-META:
  source_path: packages/cli/src/sso.ee/saml/schema/oasis-200401-wss-wssecurity-utility-1.0.xsd.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/sso.ee/saml/schema 的SSO模块。导入/依赖:外部:xmllint-wasm；内部:无；本地:无。导出:xmlFileInfo。关键函数/方法:无。用于承载SSO实现细节，并通过导出对外提供能力。
  entities: []
  external_dependencies: []
  mapping_confidence: High
  todo_refactor_ddd:
    - Detected XML schema resource (xmllint-wasm XMLFileInfo)
    - Rewrite implementation for Infrastructure layer
  moved_in_batch: 2026-01-18-system-analysis-ddd-mapping
"""
# TODO-REFACTOR-DDD: packages/cli/src/sso.ee/saml/schema/oasis-200401-wss-wssecurity-utility-1.0.xsd.ts -> services/n8n/infrastructure/cli/configuration/sso.ee/saml/schema/oasis_200401_wss_wssecurity_utility_1_0_xsd.py
