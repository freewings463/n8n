"""
MIGRATION-META:
  source_path: packages/cli/src/sso.ee/saml/schema/ws-authorization.xsd.ts
  target_context: n8n
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/sso.ee/saml/schema/ws-authorization.xsd.ts -> services/n8n/infrastructure/cli/configuration/sso.ee/saml/schema/ws_authorization_xsd.py
