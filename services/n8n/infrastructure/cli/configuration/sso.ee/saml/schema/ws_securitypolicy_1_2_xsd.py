"""
MIGRATION-META:
  source_path: packages/cli/src/sso.ee/saml/schema/ws-securitypolicy-1.2.xsd.ts
  target_context: n8n
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/sso.ee/saml/schema/ws-securitypolicy-1.2.xsd.ts -> services/n8n/infrastructure/cli/configuration/sso.ee/saml/schema/ws_securitypolicy_1_2_xsd.py
