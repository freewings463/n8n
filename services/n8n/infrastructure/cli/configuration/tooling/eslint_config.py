"""
MIGRATION-META:
  source_path: packages/cli/eslint.config.mjs
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli 的配置。导入/依赖:外部:eslint/config；内部:@n8n/eslint-config/node；本地:无。导出:无。关键函数/方法:globalIgnores。用于集中定义该模块配置项与默认值，供其他模块读取。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/eslint.config.mjs -> services/n8n/infrastructure/cli/configuration/tooling/eslint_config.py
