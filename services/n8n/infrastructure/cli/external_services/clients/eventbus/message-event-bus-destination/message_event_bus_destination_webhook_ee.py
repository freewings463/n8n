"""
MIGRATION-META:
  source_path: packages/cli/src/eventbus/message-event-bus-destination/message-event-bus-destination-webhook.ee.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/eventbus/message-event-bus-destination 的模块。导入/依赖:外部:axios；内部:@n8n/di、n8n-core 等2项；本地:./message-event-bus-destination.ee 等2项。导出:isMessageEventBusDestinationWebhookOptions、MessageEventBusDestinationWebhook。关键函数/方法:isMessageEventBusDestinationWebhookOptions、buildAxiosSetting、matchDecryptedCredentialType、generateAxiosOptions 等5项。用于承载该模块实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescr…
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/eventbus/message-event-bus-destination/message-event-bus-destination-webhook.ee.ts -> services/n8n/infrastructure/cli/external_services/clients/eventbus/message-event-bus-destination/message_event_bus_destination_webhook_ee.py
