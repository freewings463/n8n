"""
MIGRATION-META:
  source_path: packages/cli/src/utils/circuit-breaker.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src/utils 的工具。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/di；本地:./sliding-window。导出:CircuitBreakerOpen、CircuitBreakerOptions、CircuitBreaker。关键函数/方法:currentState、getFailureCount、clearFailures、recordFailure、changeToState、wrapper。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/utils/circuit-breaker.ts -> services/n8n/infrastructure/cli/external_services/clients/utils/circuit_breaker.py
