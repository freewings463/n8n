"""
MIGRATION-META:
  source_path: packages/cli/src/node-types.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/cli/src 的类型。导入/依赖:外部:fs/promises；内部:@n8n/di、@n8n/task-runner、n8n-core、n8n-workflow；本地:./load-nodes-and-credentials、./utils。导出:NodeTypes。关键函数/方法:getWithSourcePath、getByName、getByNameAndVersion、getKnownTypes、getNodeTranslationPath、getMaxVersion、isVersionedDirname、getNodeTypeDescriptions。用于定义该模块相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/node-types.ts -> services/n8n/infrastructure/cli/external_services/adapters/nodes/node_types.py
