"""
MIGRATION-META:
  source_path: packages/@n8n/eslint-plugin-community-nodes/src/utils/file-utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/eslint-plugin-community-nodes/src/utils 的工具。导入/依赖:外部:@typescript-eslint/typescript-estree；内部:无；本地:无。导出:isContainedWithin、safeJoinPath、findPackageJson、readPackageJsonCredentials、extractCredentialNameFromFile、validateIconPath、readPackageJsonNodes 等2项。关键函数/方法:isContainedWithin、safeJoinPath、findPackageJson、isValidPackageJson 等12项。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/eslint-plugin-community-nodes/src/utils/file-utils.ts -> services/n8n/infrastructure/n8n-eslint-plugin-community-nodes/container/utils/file_utils.py
