"""
MIGRATION-META:
  source_path: packages/@n8n/imap/src/imap-simple.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/imap/src 的模块。导入/依赖:外部:imap；内部:无；本地:./helpers/get-message、./part-data、./types。导出:ImapSimple。关键函数/方法:search、end、reject、resolve、fetchOnMessage、fetchOnError、fetchOnEnd、getPartData、addFlags、getBoxes 等2项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/imap/src/imap-simple.ts -> services/n8n/infrastructure/n8n-imap/external_services/clients/imap_simple.py
