"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Webhook/Webhook.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Webhook 的Webhook节点。导入/依赖:外部:fs/promises、isbot、stream/promises、tmp-promise、uuid；内部:n8n-workflow；本地:./error。导出:Webhook。关键函数/方法:authenticationProperty、webhook、checkResponseModeConfiguration、validateAuth、handleBinaryData、binaryPropertyName。用于实现 n8n Webhook节点的描述与执行逻辑，供工作流运行。注释目标:eslint-disable n8n-nodes-base/node-execute-block-wrong-error-thrown。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Webhook/Webhook.node.ts -> services/n8n/infrastructure/nodes-base/container/nodes/Webhook/Webhook_node.py
