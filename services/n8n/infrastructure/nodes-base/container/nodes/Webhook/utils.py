"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Webhook/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Webhook 的Webhook节点。导入/依赖:外部:basic-auth、fs/promises 等3项；内部:n8n-workflow；本地:./error 等1项。导出:WebhookParameters、getResponseCode、getResponseData、configuredOutputs、setupOutputConnection、isIpWhitelisted、checkResponseModeConfiguration。关键函数/方法:getResponseCode、getResponseData、configuredOutputs、setupOutputConnection、isIpWhitelisted 等5项。用于实现 n8n Webhook节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Webhook/utils.ts -> services/n8n/infrastructure/nodes-base/container/nodes/Webhook/utils.py
