"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Files/ReadWriteFile/actions/write.operation.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Files/ReadWriteFile 的节点。导入/依赖:外部:@utils/utilities；内部:n8n-workflow；本地:../helpers/utils。导出:properties、description。关键函数/方法:execute。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Files/ReadWriteFile/actions/write.operation.ts -> services/n8n/infrastructure/nodes-base/container/nodes/Files/ReadWriteFile/actions/write_operation.py
