"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Airtop/constants.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Airtop 的节点。导入/依赖:外部:无；内部:n8n-core、n8n-workflow；本地:无。导出:getN8NVersion、N8N_VERSION、BASE_URL、DEFAULT_TIMEOUT_MINUTES、MIN_TIMEOUT_MINUTES、MAX_TIMEOUT_MINUTES、DEFAULT_DOWNLOAD_TIMEOUT_SECONDS、SESSION_STATUS 等4项。关键函数/方法:getN8NVersion。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Airtop/constants.ts -> services/n8n/infrastructure/nodes-base/container/nodes/Airtop/constants.py
