"""
MIGRATION-META:
  source_path: packages/nodes-base/types/generate-schema.d.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/types 的类型。导入/依赖:外部:无；内部:无；本地:无。导出:SchemaObject、SchemaArray、SchemaProperty、json。关键函数/方法:json。用于定义该模块相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/types/generate-schema.d.ts -> services/n8n/infrastructure/nodes-base/external_services/types/generate_schema_d.py
