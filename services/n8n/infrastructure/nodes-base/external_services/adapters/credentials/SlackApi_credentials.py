"""
MIGRATION-META:
  source_path: packages/nodes-base/credentials/SlackApi.credentials.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/credentials 的凭证。导入/依赖:外部:无；内部:无；本地:无。导出:SlackApi。关键函数/方法:无。用于声明 n8n 该模块鉴权字段/校验规则，供节点引用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/credentials/SlackApi.credentials.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/credentials/SlackApi_credentials.py
