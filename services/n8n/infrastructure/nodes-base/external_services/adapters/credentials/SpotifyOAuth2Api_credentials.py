"""
MIGRATION-META:
  source_path: packages/nodes-base/credentials/SpotifyOAuth2Api.credentials.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/credentials 的OAuth凭证。导入/依赖:外部:无；内部:n8n-workflow；本地:无。导出:SpotifyOAuth2Api。关键函数/方法:无。用于声明 n8n OAuth鉴权字段/校验规则，供节点引用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/credentials/SpotifyOAuth2Api.credentials.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/credentials/SpotifyOAuth2Api_credentials.py
