"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Jira/Jira.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Jira 的节点。导入/依赖:外部:lodash/mergeWith；内部:n8n-workflow；本地:./IssueAttachmentDescription、./IssueCommentDescription、./IssueDescription、./UserDescription。导出:Jira。关键函数/方法:execute、getProjects、getIssueTypes、getUsers、getPriorities、getTransitions、getCustomFields、getLabels、getGroups、getProjectComponents 等1项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Jira/Jira.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Jira/Jira_node.py
