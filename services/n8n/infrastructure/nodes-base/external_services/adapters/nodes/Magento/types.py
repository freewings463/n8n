"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Magento/types.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Magento 的类型。导入/依赖:外部:无；内部:n8n-workflow；本地:无。导出:NewCustomer、Customer、Address、CustomAttribute、AddressExtensionAttributes、Region、CustomerExtensionAttributes、CompanyAttributes 等11项。关键函数/方法:无。用于定义该模块相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Magento/types.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Magento/types.py
