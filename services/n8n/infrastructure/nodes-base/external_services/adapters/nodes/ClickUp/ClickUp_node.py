"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/ClickUp/ClickUp.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/ClickUp 的节点。导入/依赖:外部:moment-timezone；内部:n8n-workflow；本地:./ChecklistDescription、./ChecklistItemDescription、./CommentDescription、./FolderDescription 等13项。导出:ClickUp。关键函数/方法:execute、getTeams、getSpaces、getFolders、getLists、getFolderlessLists、getAssignees、getTags、getTimeEntryTags、getStatuses 等2项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/ClickUp/ClickUp.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/ClickUp/ClickUp_node.py
