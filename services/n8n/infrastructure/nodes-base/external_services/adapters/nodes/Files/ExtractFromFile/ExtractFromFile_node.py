"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Files/ExtractFromFile/ExtractFromFile.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Files/ExtractFromFile 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./actions/moveTo.operation、./actions/pdf.operation、./actions/spreadsheet.operation。导出:ExtractFromFile。关键函数/方法:execute。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Files/ExtractFromFile/ExtractFromFile.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Files/ExtractFromFile/ExtractFromFile_node.py
