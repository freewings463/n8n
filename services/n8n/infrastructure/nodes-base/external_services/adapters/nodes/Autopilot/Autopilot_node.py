"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Autopilot/Autopilot.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Autopilot 的节点。导入/依赖:外部:无；内部:无；本地:./ContactDescription、./ContactJourneyDescription、./ContactListDescription、./GenericFunctions 等1项。导出:Autopilot。关键函数/方法:execute、getCustomFields、getLists、getTriggers、customFieldsValues。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Autopilot/Autopilot.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Autopilot/Autopilot_node.py
