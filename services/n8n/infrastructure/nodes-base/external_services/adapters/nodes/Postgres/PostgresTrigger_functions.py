"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Postgres/PostgresTrigger.functions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Postgres 的节点。导入/依赖:外部:无；内部:@n8n/errors；本地:./transport、../helpers/interfaces。导出:prepareNames。关键函数/方法:prepareNames、triggerName、channelName、pgTriggerFunction、initDB、searchSchema、searchTables。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Postgres/PostgresTrigger.functions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Postgres/PostgresTrigger_functions.py
