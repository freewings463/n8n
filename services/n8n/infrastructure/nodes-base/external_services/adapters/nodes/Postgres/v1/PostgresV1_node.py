"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Postgres/v1/PostgresV1.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Postgres/v1 的节点。导入/依赖:外部:@utils/descriptions；内部:n8n-workflow；本地:./genericFunctions、../transport、../helpers/interfaces。导出:PostgresV1。关键函数/方法:execute、postgresConnectionTest。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Postgres/v1/PostgresV1.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Postgres/v1/PostgresV1_node.py
