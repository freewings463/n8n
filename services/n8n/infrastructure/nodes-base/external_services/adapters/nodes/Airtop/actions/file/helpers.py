"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Airtop/actions/file/helpers.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Airtop/actions 的工具。导入/依赖:外部:lodash/pick；内部:n8n-workflow；本地:../../constants、../../GenericFunctions、../../transport。导出:无。关键函数/方法:requestAllFiles、pollFileUntilAvailable、createAndUploadFile、waitForFileInSession、condition、pushFileToSession、triggerFileInput、pick、createFileBuffer、buffer。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Airtop/actions/file/helpers.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Airtop/actions/file/helpers.py
