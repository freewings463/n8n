"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Ssh/Ssh.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Ssh 的节点。导入/依赖:外部:fs/promises、node-ssh、tmp-promise、@utils/utilities；内部:无；本地:无。导出:Ssh。关键函数/方法:execute、resolveHomeDir、sshConnectionTest。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Ssh/Ssh.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Ssh/Ssh_node.py
