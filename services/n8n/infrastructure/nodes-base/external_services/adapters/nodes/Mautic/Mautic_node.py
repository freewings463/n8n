"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Mautic/Mautic.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Mautic 的节点。导入/依赖:外部:change-case；内部:n8n-workflow；本地:./CampaignContactDescription、./CompanyContactDescription、./CompanyDescription、./ContactDescription 等3项。导出:Mautic。关键函数/方法:execute、getCompanies、getTags、getStages、getCompanyFields、getIndustries、getContactFields、getSegments、getCampaigns、getEmails 等5项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Mautic/Mautic.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Mautic/Mautic_node.py
