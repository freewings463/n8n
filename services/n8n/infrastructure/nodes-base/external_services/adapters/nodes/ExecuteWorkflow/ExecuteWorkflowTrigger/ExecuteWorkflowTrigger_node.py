"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/ExecuteWorkflow/ExecuteWorkflowTrigger/ExecuteWorkflowTrigger.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/ExecuteWorkflow/ExecuteWorkflowTrigger 的工作流节点。导入/依赖:外部:lodash/pickBy；内部:无；本地:../workflowInputsResourceMapping/GenericFunctions。导出:ExecuteWorkflowTrigger。关键函数/方法:execute、trigger。用于实现 n8n 工作流节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/ExecuteWorkflow/ExecuteWorkflowTrigger/ExecuteWorkflowTrigger.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/ExecuteWorkflow/ExecuteWorkflowTrigger/ExecuteWorkflowTrigger_node.py
