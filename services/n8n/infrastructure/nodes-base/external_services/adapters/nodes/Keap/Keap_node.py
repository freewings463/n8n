"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Keap/Keap.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Keap 的节点。导入/依赖:外部:change-case、moment-timezone；内部:n8n-workflow；本地:./CompanyDescription、./CompanyInterface、./ContactDescription、./ContactNoteDescription 等11项。导出:Keap。关键函数/方法:execute、getTags、getUsers、getCountries、getProvinces、getContactTypes、getTimezones、addresses、faxes、phones 等6项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Keap/Keap.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Keap/Keap_node.py
