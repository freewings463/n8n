"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/TheHive/TheHive.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/TheHive 的节点。导入/依赖:外部:lodash/set；内部:无；本地:./descriptions/AlertDescription、./descriptions/CaseDescription、./descriptions/LogDescription、./descriptions/ObservableDescription 等2项。导出:TheHive。关键函数/方法:execute、set、loadResponders、loadAnalyzers、loadCustomFields、loadObservableOptions、version、loadObservableTypes、loadTaskOptions、loadAlertOptions 等9项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/TheHive/TheHive.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/TheHive/TheHive_node.py
