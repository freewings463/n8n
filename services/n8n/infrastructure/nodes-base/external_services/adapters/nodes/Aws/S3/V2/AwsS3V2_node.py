"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Aws/S3/V2/AwsS3V2.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Aws/S3 的节点。导入/依赖:外部:change-case、xml2js；内部:n8n-workflow；本地:./BucketDescription、./FileDescription、./FolderDescription、./GenericFunctions 等2项。导出:AwsS3V2。关键函数/方法:execute、tagsValues。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Aws/S3/V2/AwsS3V2.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Aws/S3/V2/AwsS3V2_node.py
