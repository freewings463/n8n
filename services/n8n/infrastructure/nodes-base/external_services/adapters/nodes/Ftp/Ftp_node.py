"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Ftp/Ftp.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Ftp 的节点。导入/依赖:外部:promise-ftp、ssh2-sftp-client、stream/promises、tmp-promise、@utils/utilities；内部:n8n-workflow；本地:无。导出:Ftp。关键函数/方法:execute、callRecursiveList、prepareAndNormalize、normalizeFunction、recursivelyCreateSftpDirs、normalizeSFtpItem、normalizeFtpItem、ftpConnectionTest、sftpConnectionTest、basename。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Ftp/Ftp.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Ftp/Ftp_node.py
