"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Telegram/Telegram.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Telegram 的节点。导入/依赖:外部:mime-types；内部:无；本地:../utils/descriptions、../sendAndWait/configureWaitTillDate.util、../sendAndWait/descriptions。导出:Telegram。关键函数/方法:无。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Telegram/Telegram.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Telegram/Telegram_node.py
