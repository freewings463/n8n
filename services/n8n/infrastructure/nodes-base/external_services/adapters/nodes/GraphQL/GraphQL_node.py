"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/GraphQL/GraphQL.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/GraphQL 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:无。导出:GraphQL。关键函数/方法:execute、headerParameters。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。注释目标:eslint-disable n8n-nodes-base/node-filename-against-convention。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/GraphQL/GraphQL.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/GraphQL/GraphQL_node.py
