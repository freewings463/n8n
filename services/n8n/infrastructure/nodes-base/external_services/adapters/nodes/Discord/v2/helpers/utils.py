"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Discord/v2/helpers/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Discord/v2 的节点。导入/依赖:外部:form-data、lodash/isEmpty 等1项；内部:n8n-workflow；本地:../sendAndWait/utils 等2项。导出:createSimplifyFunction、parseDiscordError、prepareErrorData、prepareOptions、prepareEmbeds、checkAccessToGuild、createSendAndWaitMessageBody。关键函数/方法:parseDiscordError、errorString、prepareErrorData、prepareOptions、prepareEmbeds 等6项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Discord/v2/helpers/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Discord/v2/helpers/utils.py
