"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/ERPNext/ERPNext.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/ERPNext 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./DocumentDescription、./GenericFunctions、./utils。导出:ERPNext。关键函数/方法:execute、getDocTypes、getDocFilters、getDocFields。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。注释目标:eslint-disable n8n-nodes-base/node-filename-against-convention。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/ERPNext/ERPNext.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/ERPNext/ERPNext_node.py
