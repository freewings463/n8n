"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Cortex/Cortex.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Cortex 的节点。导入/依赖:外部:change-case、lodash/upperFirst；内部:n8n-workflow；本地:./AnalyzerDescriptions、./AnalyzerInterface、./GenericFunctions、./JobDescription 等1项。导出:Cortex。关键函数/方法:execute、delete、loadActiveAnalyzers、loadActiveResponders、loadObservableOptions、selectedAnalyzerId、loadDataTypeOptions、selectedResponderId、responderId、values 等3项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Cortex/Cortex.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Cortex/Cortex_node.py
