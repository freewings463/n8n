"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/SurveyMonkey/SurveyMonkeyTrigger.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/SurveyMonkey 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./GenericFunctions、./Interfaces。导出:SurveyMonkeyTrigger。关键函数/方法:create、delete、getCollectors、getSurveys、checkExists、idsExist、webhook、keys、choice、value 等2项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/SurveyMonkey/SurveyMonkeyTrigger.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/SurveyMonkey/SurveyMonkeyTrigger_node.py
