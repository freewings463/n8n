"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/ActionNetwork/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/ActionNetwork 的节点。导入/依赖:外部:lodash/flow、lodash/omit；内部:无；本地:无。导出:extractId、makeOsdiLink、isPrimary、adjustPersonPayload、adjustPetitionPayload、adjustEventPayload、resourceLoaders、simplifyResponse。关键函数/方法:actionNetworkApiRequest、toItemsKey、handleListing、extractId、makeOsdiLink、isPrimary、adjustLanguagesSpoken、adjustPhoneNumbers 等11项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/ActionNetwork/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/ActionNetwork/GenericFunctions.py
