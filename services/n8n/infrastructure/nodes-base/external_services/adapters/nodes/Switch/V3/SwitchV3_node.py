"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Switch/V3/SwitchV3.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Switch/V3 的节点。导入/依赖:外部:lodash/set、@utils/utilities；内部:n8n-workflow；本地:../utils/constants、../utils/descriptions、../V2/utils。导出:SwitchV3。关键函数/方法:execute、set、configuredOutputs、rules、renameFallbackOutput、getFallbackOutputOptions、checkIndexRange。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Switch/V3/SwitchV3.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Switch/V3/SwitchV3_node.py
