"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Bitwarden/Bitwarden.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Bitwarden 的节点。导入/依赖:外部:lodash/isEmpty、lodash/partialRight；内部:n8n-workflow；本地:./descriptions/CollectionDescription、./descriptions/EventDescription、./descriptions/GroupDescription、./descriptions/MemberDescription。导出:Bitwarden。关键函数/方法:execute、getGroups、getCollections。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Bitwarden/Bitwarden.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Bitwarden/Bitwarden_node.py
