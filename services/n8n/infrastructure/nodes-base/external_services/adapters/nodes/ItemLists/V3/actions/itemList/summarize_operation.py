"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/ItemLists/V3/actions/itemList/summarize.operation.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/ItemLists/V3 的节点。导入/依赖:外部:lodash/get、@utils/utilities；内部:n8n-workflow；本地:../common.descriptions。导出:properties、description。关键函数/方法:execute、parseReturnData、parseFieldName、fieldValueGetter、checkIfFieldExists、aggregate、aggregateData、splitData、aggregationToArray、fieldsToSplitBy。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/ItemLists/V3/actions/itemList/summarize.operation.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/ItemLists/V3/actions/itemList/summarize_operation.py
