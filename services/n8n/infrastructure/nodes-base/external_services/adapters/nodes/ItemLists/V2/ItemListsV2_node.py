"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/ItemLists/V2/ItemListsV2.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/ItemLists/V2 的节点。导入/依赖:外部:lodash/get、lodash/isEmpty、lodash/isEqual、lodash/lt、lodash/pick、lodash/set 等2项；内部:n8n-workflow；本地:./summarize.operation、../helpers/utils。导出:ItemListsV2。关键函数/方法:execute、fieldsToSplitOut、destinationFields、unset、fieldsToInclude。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/ItemLists/V2/ItemListsV2.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/ItemLists/V2/ItemListsV2_node.py
