"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/DataTable/actions/row/update.operation.ts
  target_context: n8n
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/DataTable/actions/row/update.operation.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/DataTable/actions/row/update_operation.py
