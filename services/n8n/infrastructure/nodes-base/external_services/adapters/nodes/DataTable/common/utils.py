"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/DataTable/common/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/DataTable/common 的节点。导入/依赖:外部:luxon；内部:n8n-workflow；本地:./constants 等1项。导出:isFieldEntry、isMatchType、buildGetManyFilter、isFieldArray、dataObjectToApiInput、getDryRunParameter。关键函数/方法:isDateLike、resolveDataTableId、getDataTableProxyExecute、getDataTableProxyLoadOptions、getDataTableAggregateProxy、isFieldEntry、isMatchType、buildGetManyFilter 等3项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/DataTable/common/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/DataTable/common/utils.py
