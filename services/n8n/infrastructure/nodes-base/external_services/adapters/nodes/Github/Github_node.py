"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Github/Github.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Github 的节点。导入/依赖:外部:change-case；内部:无；本地:./SearchFunctions、../utils/utilities、../Webhook/description。导出:Github。关键函数/方法:waitingTooltip。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Github/Github.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Github/Github_node.py
