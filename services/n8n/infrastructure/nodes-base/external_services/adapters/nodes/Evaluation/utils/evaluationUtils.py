"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Evaluation/utils/evaluationUtils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Evaluation/utils 的工具。导入/依赖:外部:node:assert；内部:无；本地:./evaluationTriggerUtils、./metricHandlers、../helpers/utils。导出:toDataTableValue、setInputs、getOutputConnectionTypes、getInputConnectionTypes。关键函数/方法:withEvaluationData、isOutputsArray、toDataTableValue、toDataTableColumnType、setOutputs、assert、isInputsArray、setInputs、setMetrics、checkIfEvaluating 等3项。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Evaluation/utils/evaluationUtils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Evaluation/utils/evaluationUtils.py
