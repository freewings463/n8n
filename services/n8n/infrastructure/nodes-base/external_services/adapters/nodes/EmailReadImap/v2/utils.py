"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/EmailReadImap/v2/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/EmailReadImap/v2 的节点。导入/依赖:外部:lodash/find、mailparser；内部:无；本地:无。导出:无。关键函数/方法:parseRawEmail、getNewEmails。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/EmailReadImap/v2/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/EmailReadImap/v2/utils.py
