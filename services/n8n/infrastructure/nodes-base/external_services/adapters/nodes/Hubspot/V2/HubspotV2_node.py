"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Hubspot/V2/HubspotV2.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Hubspot/V2 的节点。导入/依赖:外部:change-case、lodash/set；内部:n8n-workflow；本地:./CompanyDescription 等9项。导出:HubspotV2。关键函数/方法:hubspotApiTest、getContactLeadStatuses、getContactLealBasics、getContactLifeCycleStages、getContactOriginalSources、getContactPrefferedLanguages、getContactStatuses、getContactProperties、getContactPropertiesWithType 等25项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Hubspot/V2/HubspotV2.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Hubspot/V2/HubspotV2_node.py
