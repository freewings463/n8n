"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Transform/Sort/Sort.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Transform/Sort 的节点。导入/依赖:外部:lodash/get、lodash/isEqual、lodash/lt、@utils/utilities；内部:无；本地:./utils。导出:Sort。关键函数/方法:execute、shuffleArray。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Transform/Sort/Sort.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Transform/Sort/Sort_node.py
