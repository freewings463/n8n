"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Transform/RemoveDuplicates/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Transform/RemoveDuplicates 的节点。导入/依赖:外部:lodash/get、lodash/isEqual、lodash/lt、lodash/pick、@utils/utilities；内部:n8n-workflow；本地:../utils/utils。导出:validateInputData、removeDuplicateInputItems。关键函数/方法:validateInputData、removeDuplicateInputItems。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Transform/RemoveDuplicates/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Transform/RemoveDuplicates/utils.py
