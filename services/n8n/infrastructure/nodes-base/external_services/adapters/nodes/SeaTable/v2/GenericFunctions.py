"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/SeaTable/v2/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/SeaTable/v2 的节点。导入/依赖:外部:form-data；内部:n8n-workflow；本地:./Schema 等1项。导出:resolveBaseUri、simplify_new、nameOfPredicate、split、enrichColumns、splitStringColumnsToArrays、rowExport、dtableSchemaIsColumn 等2项。关键函数/方法:userBaseUri、resolveBaseUri、getBaseAccessToken、endpointCtxExpr、seaTableApiRequest、getBaseCollaborators、getTableColumns、simplify_new 等16项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/SeaTable/v2/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/SeaTable/v2/GenericFunctions.py
