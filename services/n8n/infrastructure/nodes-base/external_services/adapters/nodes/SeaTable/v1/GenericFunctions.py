"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/SeaTable/v1/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/SeaTable/v1 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./Schema 等1项。导出:resolveBaseUri、simplify、getColumns、getDownloadableColumns、nameOfPredicate、split、columnNamesToArray、columnNamesGlob 等9项。关键函数/方法:userBaseUri、resolveBaseUri、getBaseAccessToken、endpointCtxExpr、seaTableApiRequest、setableApiRequestAllItems、getTableColumns、getTableViews、simplify 等21项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/SeaTable/v1/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/SeaTable/v1/GenericFunctions.py
