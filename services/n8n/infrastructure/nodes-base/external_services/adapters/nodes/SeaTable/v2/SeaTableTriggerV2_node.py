"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/SeaTable/v2/SeaTableTriggerV2.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/SeaTable/v2 的节点。导入/依赖:外部:moment-timezone；内部:无；本地:./GenericFunctions、./methods。导出:SeaTableTriggerV2。关键函数/方法:poll、viewName、assetColumn、endDate、signature。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/SeaTable/v2/SeaTableTriggerV2.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/SeaTable/v2/SeaTableTriggerV2_node.py
