"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/SeaTable/v2/types.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/SeaTable/v2 的类型。导入/依赖:外部:无；内部:n8n-workflow；本地:无。导出:TSeaTableServerVersion、TSeaTableServerEdition、TColumnType、TInheritColumnKey、TColumnValue、TColumnKey、TDtableMetadataTables、TDtableMetadataColumns 等12项。关键函数/方法:无。用于定义该模块相关类型/结构约束，供多模块共享。注释目标:---------------------------------- / SeaTable。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/SeaTable/v2/types.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/SeaTable/v2/types.py
