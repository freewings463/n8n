"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Stripe/helpers.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Stripe 的工具。导入/依赖:外部:lodash/flow、lodash/isEmpty、lodash/omit；内部:无；本地:无。导出:adjustMetadata、adjustChargeFields、adjustCustomerFields。关键函数/方法:stripeApiRequest、adjustAddress、adjustMetadata、adjustShipping、loadResource、handleListing。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Stripe/helpers.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Stripe/helpers.py
