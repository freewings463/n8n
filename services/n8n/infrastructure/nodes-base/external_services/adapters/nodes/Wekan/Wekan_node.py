"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Wekan/Wekan.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Wekan 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./BoardDescription、./CardCommentDescription、./CardDescription、./ChecklistDescription 等4项。导出:Wekan。关键函数/方法:execute、getUsers、getBoards、getLists、getSwimlanes、getCards、getChecklists、getChecklistItems、getComments、wrapData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Wekan/Wekan.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Wekan/Wekan_node.py
