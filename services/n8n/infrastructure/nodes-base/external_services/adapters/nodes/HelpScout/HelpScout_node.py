"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/HelpScout/HelpScout.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/HelpScout 的节点。导入/依赖:外部:@utils/ISOCountryCodes；内部:n8n-workflow；本地:./ConversationDescription、./ConversationInterface、./CustomerDescription、./CustomerInterface 等4项。导出:HelpScout。关键函数/方法:execute、getCountriesCodes、getTags、getMailboxes、threads、chats、address、emails、phones、socialProfiles 等1项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/HelpScout/HelpScout.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/HelpScout/HelpScout_node.py
