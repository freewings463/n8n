"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/WooCommerce/WooCommerce.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/WooCommerce 的节点。导入/依赖:外部:无；内部:无；本地:./descriptions、./OrderDescription、./ProductDescription、./ProductInterface。导出:WooCommerce。关键函数/方法:execute、getCategories、getTags、setFields、images、dimension、metadata、billing、toSnakeCase、shipping 等5项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/WooCommerce/WooCommerce.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/WooCommerce/WooCommerce_node.py
