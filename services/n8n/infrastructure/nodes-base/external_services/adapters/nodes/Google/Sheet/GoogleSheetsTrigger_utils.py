"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Sheet/GoogleSheetsTrigger.utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Sheet 的节点。导入/依赖:外部:lodash/isEqual、lodash/zip、xlsx；内部:n8n-workflow；本地:../helpers/GoogleSheets.types、./v2/transport。导出:BINARY_MIME_TYPE、sheetBinaryToArrayOfArrays、arrayOfArraysToJson、compareRevisions。关键函数/方法:getRevisionFile、sheetBinaryToArrayOfArrays、arrayOfArraysToJson、getSpecificColumns、extractVersionData、compareRevisions。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Sheet/GoogleSheetsTrigger.utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Sheet/GoogleSheetsTrigger_utils.py
