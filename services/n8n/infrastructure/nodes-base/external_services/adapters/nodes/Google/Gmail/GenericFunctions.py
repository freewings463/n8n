"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Gmail/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Gmail 的节点。导入/依赖:外部:lodash/isEmpty、luxon 等2项；内部:n8n-workflow；本地:../sendAndWait/interfaces 等2项。导出:IAttachments、extractEmail、prepareTimestamp、prepareQuery、prepareEmailsInput、prepareEmailBody、unescapeSnippets。关键函数/方法:delete、googleApiRequest、parseRawEmail、encodeEmail、googleApiRequestAllItems、extractEmail、prepareTimestamp 等8项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Gmail/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Gmail/GenericFunctions.py
