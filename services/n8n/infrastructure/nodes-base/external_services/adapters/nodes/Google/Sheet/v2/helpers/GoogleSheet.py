"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Sheet/v2/helpers/GoogleSheet.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Sheet 的节点。导入/依赖:外部:lodash/get、xlsx；内部:n8n-workflow；本地:./GoogleSheets.utils、../transport。导出:GoogleSheet。关键函数/方法:encodeRange、clearData、getData、spreadsheetGetSheets、spreadsheetGetSheet、response、getDataRange、spreadsheetBatchUpdate、batchUpdate、appendEmptyRowsOrColumns 等15项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Sheet/v2/helpers/GoogleSheet.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Sheet/v2/helpers/GoogleSheet.py
