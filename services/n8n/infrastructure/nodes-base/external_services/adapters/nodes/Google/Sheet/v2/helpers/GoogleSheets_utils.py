"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Sheet/v2/helpers/GoogleSheets.utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Sheet 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./GoogleSheet 等1项。导出:untilSheetSelected、getSpreadsheetId、getSheetId、getColumnName、getColumnNumber、hexToRgb、addRowNumber、trimToFirstEmptyRow 等9项。关键函数/方法:getSpreadsheetId、getSheetId、getColumnName、getColumnNumber、hexToRgb、addRowNumber、trimToFirstEmptyRow、removeEmptyRows、trimLeadingEmptyRows 等11项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Sheet/v2/helpers/GoogleSheets.utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Sheet/v2/helpers/GoogleSheets_utils.py
