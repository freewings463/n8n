"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Analytics/v1/GoogleAnalyticsV1.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Analytics 的节点。导入/依赖:外部:moment-timezone、@utils/descriptions；内部:无；本地:./GenericFunctions、./Interfaces、./ReportDescription、./UserActivityDescription。导出:GoogleAnalyticsV1。关键函数/方法:execute、getDimensions、getViews、dateValues、metrics、dimensions、dimensionFilters。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Analytics/v1/GoogleAnalyticsV1.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Analytics/v1/GoogleAnalyticsV1_node.py
