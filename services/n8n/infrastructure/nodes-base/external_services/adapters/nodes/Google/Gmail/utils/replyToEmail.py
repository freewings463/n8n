"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Gmail/utils/replyToEmail.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Gmail 的工具。导入/依赖:外部:lodash/uniq、@utils/sendAndWait/interfaces；内部:n8n-workflow；本地:../types。导出:无。关键函数/方法:replyToEmail、prepareEmailString、headerName。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Gmail/utils/replyToEmail.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Gmail/utils/replyToEmail.py
