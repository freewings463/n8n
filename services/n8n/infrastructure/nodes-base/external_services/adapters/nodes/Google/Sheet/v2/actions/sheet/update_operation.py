"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Sheet/v2/actions/sheet/update.operation.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Sheet 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./commonDescription、../helpers/GoogleSheet、../helpers/GoogleSheets.utils。导出:description。关键函数/方法:execute、cellFormatDefault、valueRenderMode、locationDefineOptions、errorOnUnexpectedColumn、addNewColumn、handlingExtraDataOption。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Sheet/v2/actions/sheet/update.operation.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Sheet/v2/actions/sheet/update_operation.py
