"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/YouTube/YouTube.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/YouTube 的节点。导入/依赖:外部:@utils/ISOCountryCodes；内部:n8n-workflow；本地:./ChannelDescription、./GenericFunctions、./PlaylistDescription、./PlaylistItemDescription 等3项。导出:YouTube。关键函数/方法:execute、getLanguages、getCountriesCodes、getVideoCategories、getPlaylists、channelSettingsValues、imageSettingsValues、validateAndSetDate。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/YouTube/YouTube.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/YouTube/YouTube_node.py
