"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Calendar/GoogleCalendar.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Calendar 的节点。导入/依赖:外部:moment-timezone、uuid；内部:n8n-workflow；本地:./CalendarDescription、./EventDescription、./EventInterface、../utils/utilities。导出:GoogleCalendar。关键函数/方法:execute、getConferenceSolutions、getColors、reminders、conferenceData、dateObjectToISO、instance。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Calendar/GoogleCalendar.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Calendar/GoogleCalendar_node.py
