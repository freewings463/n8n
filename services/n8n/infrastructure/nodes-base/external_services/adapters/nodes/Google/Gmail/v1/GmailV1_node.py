"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Gmail/v1/GmailV1.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Gmail 的节点。导入/依赖:外部:lodash/isEmpty、@utils/descriptions；内部:无；本地:./DraftDescription、./LabelDescription、./loadOptions、./MessageDescription 等2项。导出:GmailV1。关键函数/方法:execute。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Gmail/v1/GmailV1.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Gmail/v1/GmailV1_node.py
