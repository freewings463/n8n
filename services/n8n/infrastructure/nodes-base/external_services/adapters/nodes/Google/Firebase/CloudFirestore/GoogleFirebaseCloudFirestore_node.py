"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Firebase/CloudFirestore/GoogleFirebaseCloudFirestore.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Firebase 的Store。导入/依赖:外部:无；内部:n8n-workflow；本地:./CollectionDescription、./DocumentDescription、../utils/utilities。导出:GoogleFirebaseCloudFirestore。关键函数/方法:execute、getProjects、getAllResponse、fullDocumentToJson、jsonParse。用于管理该模块前端状态（state/actions/getters）供UI消费。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Firebase/CloudFirestore/GoogleFirebaseCloudFirestore.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Firebase/CloudFirestore/GoogleFirebaseCloudFirestore_node.py
