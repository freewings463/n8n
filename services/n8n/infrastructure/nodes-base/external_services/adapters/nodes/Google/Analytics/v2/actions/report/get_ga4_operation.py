"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Google/Analytics/v2/actions/report/get.ga4.operation.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Google/Analytics 的节点。导入/依赖:外部:无；内部:无；本地:../../transport。导出:description。关键函数/方法:execute、metrics、dimensions、metricOrderBy、dimmensionOrderBy。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Google/Analytics/v2/actions/report/get.ga4.operation.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Google/Analytics/v2/actions/report/get_ga4_operation.py
