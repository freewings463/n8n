"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Twitter/V2/TwitterV2.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Twitter/V2 的节点。导入/依赖:外部:iso-639-1、luxon；内部:无；本地:./DirectMessageDescription、./ListDescription、./TweetDescription、./UserDescription。导出:TwitterV2。关键函数/方法:execute、getLanguages、user。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Twitter/V2/TwitterV2.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Twitter/V2/TwitterV2_node.py
