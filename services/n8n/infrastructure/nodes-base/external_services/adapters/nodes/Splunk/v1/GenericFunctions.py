"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Splunk/v1/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Splunk/v1 的节点。导入/依赖:外部:xml2js；内部:n8n-workflow；本地:无。导出:formatSearch、extractErrorDescription、toUnixEpoch、formatFeed、formatResults、setCount、populate、getId。关键函数/方法:compactEntryContent、formatEntryContent、formatEntry、formatSearch、parseXml、parseString、extractErrorDescription、toUnixEpoch、splunkApiRequest、rawError 等7项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Splunk/v1/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Splunk/v1/GenericFunctions.py
