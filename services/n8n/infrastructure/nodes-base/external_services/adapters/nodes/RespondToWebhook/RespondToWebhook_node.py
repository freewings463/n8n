"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/RespondToWebhook/RespondToWebhook.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/RespondToWebhook 的节点。导入/依赖:外部:jsonwebtoken、lodash/set；内部:无；本地:./utils/binary、./utils/outputs、../utils/utilities。导出:RespondToWebhook。关键函数/方法:execute、onMessage。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/RespondToWebhook/RespondToWebhook.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/RespondToWebhook/RespondToWebhook_node.py
