"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Mattermost/v1/actions/router.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Mattermost/v1 的路由。导入/依赖:外部:无；内部:n8n-workflow；本地:./channel、./Interfaces、./message、./reaction 等1项。导出:无。关键函数/方法:router。用于组织该模块路由，绑定控制器与中间件，定义API边界。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Mattermost/v1/actions/router.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Mattermost/v1/actions/router.py
