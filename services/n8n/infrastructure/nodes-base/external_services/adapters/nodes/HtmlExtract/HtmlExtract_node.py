"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/HtmlExtract/HtmlExtract.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/HtmlExtract 的节点。导入/依赖:外部:cheerio、lodash/get；内部:n8n-workflow；本地:无。导出:HtmlExtract。关键函数/方法:execute、getValue。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/HtmlExtract/HtmlExtract.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/HtmlExtract/HtmlExtract_node.py
