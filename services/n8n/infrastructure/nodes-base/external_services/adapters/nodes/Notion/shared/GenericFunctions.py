"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Notion/shared/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Notion/shared 的节点。导入/依赖:外部:change-case、lodash/set 等2项；内部:n8n-workflow；本地:./constants 等1项。导出:SortData、getBlockTypesOptions、formatTitle、formatText、formatBlocks、mapProperties、mapSorting、mapFilters 等6项。关键函数/方法:uuidValidateWithoutDashes、notionApiRequest、notionApiRequestAllItems、notionApiRequestGetBlockChildrens、getBlockTypesOptions 等23项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Notion/shared/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Notion/shared/GenericFunctions.py
