"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Notion/NotionTrigger.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Notion 的节点。导入/依赖:外部:moment-timezone；内部:无；本地:./shared/GenericFunctions、./shared/methods。导出:NotionTrigger。关键函数/方法:poll、possibleDuplicates、moment。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Notion/NotionTrigger.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Notion/NotionTrigger_node.py
