"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Set/v2/helpers/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Set/v2 的节点。导入/依赖:外部:lodash/get、lodash/set、lodash/unset；内部:无；本地:./interfaces、../utils/utilities。导出:composeReturnItem、parseJsonParameter、validateEntry、resolveRawData、prepareReturnItem。关键函数/方法:set、configureFieldHelper、unset、composeReturnItem、includeFields、excludeFields、parseJsonParameter、validateEntry、resolveRawData、prepareReturnItem。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Set/v2/helpers/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Set/v2/helpers/utils.py
