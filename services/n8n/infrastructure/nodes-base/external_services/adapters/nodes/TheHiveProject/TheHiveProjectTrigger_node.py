"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/TheHiveProject/TheHiveProjectTrigger.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/TheHiveProject 的节点。导入/依赖:外部:lodash/get；内部:无；本地:无。导出:TheHiveProjectTrigger。关键函数/方法:create、delete、checkExists、webhook、action、objectType。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/TheHiveProject/TheHiveProjectTrigger.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/TheHiveProject/TheHiveProjectTrigger_node.py
