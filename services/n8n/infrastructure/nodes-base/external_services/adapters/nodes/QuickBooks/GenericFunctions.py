"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/QuickBooks/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/QuickBooks 的节点。导入/依赖:外部:change-case、lodash/omit 等1项；内部:n8n-workflow；本地:./descriptions/Shared.interface 等1项。导出:processLines、populateFields、toOptions、splitPascalCase、toDisplayName、adjustTransactionDates、simplifyTransactionReport。关键函数/方法:delete、quickBooksApiRequest、getCount、quickBooksApiRequestAllItems、handleListing、getSyncToken 等11项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/QuickBooks/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/QuickBooks/GenericFunctions.py
