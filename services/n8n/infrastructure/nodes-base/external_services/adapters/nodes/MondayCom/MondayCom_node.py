"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/MondayCom/MondayCom.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/MondayCom 的节点。导入/依赖:外部:change-case；内部:n8n-workflow；本地:./BoardColumnDescription、./BoardDescription、./BoardGroupDescription、./BoardItemDescription。导出:MondayCom。关键函数/方法:execute、getBoards、boards、getColumns、getGroups、archive_board、create_board、create_column、create_group、delete_group 等11项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/MondayCom/MondayCom.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/MondayCom/MondayCom_node.py
