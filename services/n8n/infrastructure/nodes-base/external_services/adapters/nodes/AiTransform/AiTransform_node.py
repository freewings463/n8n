"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/AiTransform/AiTransform.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/AiTransform 的节点。导入/依赖:外部:lodash/set；内部:无；本地:../Code/JavaScriptSandbox、../Code/Sandbox、../Code/utils。导出:AiTransform。关键函数/方法:execute、set、getSandbox、standardizeOutput。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/AiTransform/AiTransform.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/AiTransform/AiTransform_node.py
