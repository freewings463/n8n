"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Todoist/v2/Service.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Todoist/v2 的服务。导入/依赖:外部:无；内部:n8n-workflow；本地:../GenericFunctions。导出:TodoistService、TaskOperationType、ProjectOperationType、SectionOperationType、CommentOperationType、LabelOperationType、ReminderOperationType、isTaskOperationType 等9项。关键函数/方法:executeTask、executeProject、executeSection、executeComment、executeLabel、executeReminder、isTaskOperationType 等5项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Todoist/v2/Service.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Todoist/v2/Service.py
