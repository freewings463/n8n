"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Freshservice/Freshservice.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Freshservice 的服务。导入/依赖:外部:moment-timezone；内部:n8n-workflow；本地:./types。导出:Freshservice。关键函数/方法:execute、getAgents、getAgentGroups、getAgentRoles、getAssetTypes、getAssetTypeFields、getDepartments、getLocations、getRequesters。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Freshservice/Freshservice.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Freshservice/Freshservice_node.py
