"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Merge/v2/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Merge/v2 的节点。导入/依赖:外部:lodash/assign、lodash/assignWith 等4项；内部:@n8n/errors；本地:./interfaces。导出:addSuffixToEntriesKeys、findMatches、selectMergeMethod、mergeMatched、checkMatchFieldsInput、checkInput、addSourceField。关键函数/方法:addSuffixToEntriesKeys、findAllMatches、findFirstMatch、findMatches、multipleMatches、selectMergeMethod、customizer、mergeMatched 等4项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Merge/v2/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Merge/v2/utils.py
