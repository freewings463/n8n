"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Merge/v3/helpers/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Merge/v3 的节点。导入/依赖:外部:lodash/assign、lodash/assignWith 等4项；内部:n8n-workflow；本地:./interfaces。导出:addSuffixToEntriesKeys、findMatches、selectMergeMethod、mergeMatched、checkMatchFieldsInput、checkInput、addSourceField、configuredInputs 等3项。关键函数/方法:addSuffixToEntriesKeys、findAllMatches、findFirstMatch、findMatches、multipleMatches、selectMergeMethod 等10项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Merge/v3/helpers/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Merge/v3/helpers/utils.py
