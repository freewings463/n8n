"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Microsoft/Teams/MicrosoftTeamsTrigger.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Microsoft/Teams 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:../helpers/types、../helpers/utils-trigger、./v2/methods、./v2/transport。导出:MicrosoftTeamsTrigger。关键函数/方法:create、delete、checkExists、subscriptions、webhook。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Microsoft/Teams/MicrosoftTeamsTrigger.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Microsoft/Teams/MicrosoftTeamsTrigger_node.py
