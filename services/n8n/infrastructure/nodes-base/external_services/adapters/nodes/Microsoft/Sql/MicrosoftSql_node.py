"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Microsoft/Sql/MicrosoftSql.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Microsoft/Sql 的节点。导入/依赖:外部:mssql、@utils/utilities；内部:无；本地:./interfaces。导出:MicrosoftSql。关键函数/方法:execute、microsoftSqlConnectionTest。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Microsoft/Sql/MicrosoftSql.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Microsoft/Sql/MicrosoftSql_node.py
