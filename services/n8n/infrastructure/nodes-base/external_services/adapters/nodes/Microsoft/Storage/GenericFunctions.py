"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Microsoft/Storage/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Microsoft/Storage 的节点。导入/依赖:外部:change-case、xml2js 等2项；内部:n8n-workflow；本地:./compare-header。导出:XMsVersion、HeaderConstants、getCanonicalizedHeadersString、getCanonicalizedResourceString、parseHeaders。关键函数/方法:azureStorageApiRequest、response、handleErrorPostReceive、getCanonicalizedHeadersString、getCanonicalizedResourceString、parseHeaders 等6项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Microsoft/Storage/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Microsoft/Storage/GenericFunctions.py
