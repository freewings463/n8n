"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Microsoft/Sql/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Microsoft/Sql 的节点。导入/依赖:外部:mssql、@utils/utilities；内部:n8n-workflow；本地:./interfaces。导出:copyInputItem、createTableStruct、formatColumns、configurePool、escapeIdentifier、escapeTableName、mssqlChunk。关键函数/方法:copyInputItem、createTableStruct、executeQueryQueue、buildQueryQueue、formatColumns、configurePool、escapeIdentifier、escapeTableName、mssqlChunk 等4项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Microsoft/Sql/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Microsoft/Sql/GenericFunctions.py
