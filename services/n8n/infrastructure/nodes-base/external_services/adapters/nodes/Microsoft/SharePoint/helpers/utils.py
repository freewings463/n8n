"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Microsoft/SharePoint/helpers/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Microsoft/SharePoint 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./interfaces、../transport。导出:escapeFilterValue。关键函数/方法:delete、escapeFilterValue、simplifyItemPostReceive、simplifyListPostReceive、downloadFilePostReceive、uploadFilePreSend、itemGetAllFieldsPreSend、itemColumnsPreSend、handleErrorPostReceive、error。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Microsoft/SharePoint/helpers/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Microsoft/SharePoint/helpers/utils.py
