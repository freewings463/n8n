"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/SendGrid/SendGrid.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/SendGrid 的节点。导入/依赖:外部:moment-timezone；内部:无；本地:./ContactDescription、./GenericFunctions、./ListDescription、./MailDescription。导出:SendGrid。关键函数/方法:execute、getCustomFields、getListIds、getTemplateIds、addressValues、alternateEmails、listIdValues、customFields。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/SendGrid/SendGrid.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/SendGrid/SendGrid_node.py
