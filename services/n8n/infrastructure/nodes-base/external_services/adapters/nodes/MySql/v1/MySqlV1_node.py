"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/MySql/v1/MySqlV1.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/MySql/v1 的节点。导入/依赖:外部:mysql2/promise、@utils/descriptions、@utils/utilities；内部:n8n-workflow；本地:./GenericFunctions。导出:MySqlV1。关键函数/方法:execute、mysqlConnectionTest、async。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/MySql/v1/MySqlV1.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/MySql/v1/MySqlV1_node.py
