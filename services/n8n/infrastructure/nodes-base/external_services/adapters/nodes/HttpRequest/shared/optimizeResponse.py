"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/HttpRequest/shared/optimizeResponse.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/HttpRequest/shared 的节点。导入/依赖:外部:@mozilla/readability、cheerio、html-to-text、jsdom、lodash/get、lodash/set 等1项；内部:无；本地:无。导出:configureResponseOptimizer、optimizeResponseProperties。关键函数/方法:set、htmlOptimizer、textOptimizer、jsonOptimizer、unset、configureResponseOptimizer。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/HttpRequest/shared/optimizeResponse.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/HttpRequest/shared/optimizeResponse.py
