"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/HttpRequest/V3/HttpRequestV3.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/HttpRequest/V3 的节点。导入/依赖:外部:lodash/set、@utils/utilities；内部:无；本地:./Description、../GenericFunctions、./utils/binaryData、./utils/parse 等2项。导出:HttpRequestV3。关键函数/方法:execute、set、checkDomainRestrictions、parametersToKeyValue、updadeQueryParameter、setAgentOptions、async、errorData、removeCircularRefs。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/HttpRequest/V3/HttpRequestV3.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/HttpRequest/V3/HttpRequestV3_node.py
