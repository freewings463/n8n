"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Netscaler/ADC/NetscalerAdc.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Netscaler/ADC 的节点。导入/依赖:外部:无；内部:无；本地:./CertificateDescription、./FileDescription、./GenericFunctions。导出:NetscalerAdc。关键函数/方法:execute。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。注释目标:eslint-disable n8n-nodes-base/node-filename-against-convention。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Netscaler/ADC/NetscalerAdc.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Netscaler/ADC/NetscalerAdc_node.py
