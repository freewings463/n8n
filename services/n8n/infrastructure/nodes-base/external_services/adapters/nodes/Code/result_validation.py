"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Code/result-validation.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Code 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./reserved-key-found-error、./utils、./ValidationError。导出:TextKeys、REQUIRED_N8N_ITEM_KEYS、getTextKey、validateItem、validateTopLevelKeys、validateRunCodeEachItem、validateRunCodeAllItems。关键函数/方法:getTextKey、validateItem、validateTopLevelKeys、validateRunCodeEachItem、validateRunCodeAllItems。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Code/result-validation.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Code/result_validation.py
