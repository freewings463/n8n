"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Code/JsTaskRunnerSandbox.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Code 的节点。导入/依赖:外部:无；内部:无；本地:./JsCodeValidator、./result-validation、./throw-execution-error。导出:JsTaskRunnerSandbox。关键函数/方法:runCodeAllItems、throwExecutionError、runCodeForTool、runCodeForEachItem、validateNoDisallowedMethodsInRunForEach、chunkInputItems。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Code/JsTaskRunnerSandbox.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Code/JsTaskRunnerSandbox.py
