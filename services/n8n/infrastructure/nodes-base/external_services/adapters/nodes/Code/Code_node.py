"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Code/Code.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Code 的节点。导入/依赖:外部:lodash/set；内部:@n8n/config、@n8n/di；本地:./descriptions/JavascriptCodeDescription、./descriptions/PythonCodeDescription、./JavaScriptSandbox、./JsTaskRunnerSandbox 等4项。导出:Code。关键函数/方法:execute、set、getSandbox、standardizeOutput、addPostExecutionWarning。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。注释目标:eslint-disable n8n-nodes-base/node-execute-block-wrong-error-thrown。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Code/Code.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Code/Code_node.py
