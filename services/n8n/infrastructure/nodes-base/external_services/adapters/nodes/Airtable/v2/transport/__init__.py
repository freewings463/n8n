"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Airtable/v2/transport/index.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Airtable/v2 的入口。导入/依赖:外部:无；内部:@n8n/errors；本地:../helpers/interfaces、../helpers/utils。导出:无。关键函数/方法:apiRequest、apiRequestAllItems、downloadRecordAttachments、batchUpdate。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Airtable/v2/transport/index.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Airtable/v2/transport/__init__.py
