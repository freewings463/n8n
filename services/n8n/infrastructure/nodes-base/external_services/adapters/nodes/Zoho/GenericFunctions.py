"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Zoho/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Zoho 的节点。导入/依赖:外部:lodash/flow、lodash/sortBy；内部:n8n-workflow；本地:无。导出:throwOnErrorStatus、throwOnEmptyUpdate、throwOnMissingProducts、adjustProductDetails、adjustProductDetailsOnUpdate、adjustAccountPayload、adjustContactPayload、adjustDealPayload 等12项。关键函数/方法:throwOnErrorStatus、zohoApiRequest、zohoApiRequestAllItems、handleListing 等17项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Zoho/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Zoho/GenericFunctions.py
