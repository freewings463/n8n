"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/RabbitMQ/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/RabbitMQ 的节点。导入/依赖:外部:amqplib、@utils/utilities；内部:n8n-workflow；本地:./types。导出:MessageTracker、parsePublishArguments、parseMessage。关键函数/方法:rabbitmqConnect、rabbitmqCreateChannel、resolve、reject、rabbitmqConnectQueue、rabbitmqConnectExchange、received、answered、unansweredMessages、closeChannel 等3项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/RabbitMQ/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/RabbitMQ/GenericFunctions.py
