"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/RabbitMQ/RabbitMQTrigger.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/RabbitMQ 的节点。导入/依赖:外部:amqplib；内部:n8n-workflow；本地:./DefaultOptions、./GenericFunctions、./types。导出:RabbitMQTrigger。关键函数/方法:trigger、closeFunction、manualTriggerFunction、processMessage。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。注释目标:eslint-disable n8n-nodes-base/node-filename-against-convention。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/RabbitMQ/RabbitMQTrigger.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/RabbitMQ/RabbitMQTrigger_node.py
