"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Salesmate/Salesmate.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Salesmate 的节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./ActivityDescription、./ActivityInterface、./CompanyDescription、./CompanyInterface 等2项。导出:Salesmate。关键函数/方法:execute、getUsers、getContacts、getCompanies。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Salesmate/Salesmate.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Salesmate/Salesmate_node.py
