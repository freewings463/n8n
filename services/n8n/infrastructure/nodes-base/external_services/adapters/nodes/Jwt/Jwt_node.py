"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Jwt/Jwt.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/nodes/Jwt 的JWT节点。导入/依赖:外部:jsonwebtoken；内部:n8n-workflow；本地:../utils/utilities、../helpers/utils。导出:Jwt。关键函数/方法:execute、prettifyOperation、getToken。用于实现 n8n JWT节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Jwt/Jwt.node.ts -> services/n8n/infrastructure/nodes-base/external_services/adapters/nodes/Jwt/Jwt_node.py
