"""
MIGRATION-META:
  source_path: packages/nodes-base/credentials/common/aws/system-credentials-utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/credentials/common/aws 的凭证。导入/依赖:外部:fs/promises；内部:@n8n/config、@n8n/di、n8n-workflow；本地:无。导出:envGetter、credentialsResolver。关键函数/方法:envGetter、getSystemCredentials、getEnvironmentCredentials、getInstanceMetadataCredentials、roleName、getContainerMetadataCredentials、getPodIdentityCredentials。用于声明 n8n 该模块鉴权字段/校验规则，供节点引用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/credentials/common/aws/system-credentials-utils.ts -> services/n8n/infrastructure/nodes-base/external_services/clients/credentials/common/aws/system_credentials_utils.py
