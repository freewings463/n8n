"""
MIGRATION-META:
  source_path: packages/nodes-base/credentials/common/aws/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/credentials/common/aws 的凭证。导入/依赖:外部:xml2js、aws4；内部:无；本地:./system-credentials-utils。导出:getAwsDomain、parseAwsUrl、awsCredentialsTest、awsGetSignInOptionsAndUpdateRequest、signOptions。关键函数/方法:getAwsDomain、parseAwsUrl、awsGetSignInOptionsAndUpdateRequest、assumeRole、sign、parseString、reject、resolve、assumeRoleResult、signOptions。用于声明 n8n 该模块鉴权字段/校验规则，供节点引用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/credentials/common/aws/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/clients/credentials/common/aws/utils.py
