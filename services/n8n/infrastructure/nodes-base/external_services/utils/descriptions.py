"""
MIGRATION-META:
  source_path: packages/nodes-base/utils/descriptions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/utils 的工具。导入/依赖:外部:无；内部:n8n-workflow；本地:无。导出:oldVersionNotice、returnAllOrLimit、looseTypeValidationProperty、appendAttributionOption、encodeDecodeOptions。关键函数/方法:无。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/utils/descriptions.ts -> services/n8n/infrastructure/nodes-base/external_services/utils/descriptions.py
