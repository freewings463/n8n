"""
MIGRATION-META:
  source_path: packages/nodes-base/utils/workflowInputsResourceMapping/GenericFunctions.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/utils/workflowInputsResourceMapping 的工作流工具。导入/依赖:外部:generate-schema、json-schema、lodash/pickBy；内部:n8n-workflow；本地:无。导出:getFieldEntries、getWorkflowInputValues、getCurrentWorkflowInputData。关键函数/方法:parseJsonSchema、parseJsonExample、getFieldEntries、getWorkflowInputValues、getCurrentWorkflowInputData、loadWorkflowInputMappings。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/utils/workflowInputsResourceMapping/GenericFunctions.ts -> services/n8n/infrastructure/nodes-base/external_services/utils/workflowInputsResourceMapping/GenericFunctions.py
