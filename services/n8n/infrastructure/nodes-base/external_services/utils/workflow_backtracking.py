"""
MIGRATION-META:
  source_path: packages/nodes-base/utils/workflow-backtracking.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/utils 的工作流工具。导入/依赖:外部:无；内部:无；本地:无。导出:previousTaskData、findPairedItemThroughWorkflowData。关键函数/方法:previousTaskData、findPairedItemThroughWorkflowData。用于提供工作流通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/utils/workflow-backtracking.ts -> services/n8n/infrastructure/nodes-base/external_services/utils/workflow_backtracking.py
