"""
MIGRATION-META:
  source_path: packages/nodes-base/utils/sendAndWait/utils.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/utils/sendAndWait 的工具。导入/依赖:外部:isbot；内部:n8n-core；本地:./descriptions 等4项。导出:SendAndWaitConfig、getSendAndWaitProperties、getSendAndWaitConfig、createButton、createEmail、SEND_AND_WAIT_WAITING_TOOLTIP。关键函数/方法:getSendAndWaitProperties、getFormResponseCustomizations、sendAndWaitWebhook、getSendAndWaitConfig、createButton、createEmail、to、sendAndWaitWaitingTooltip。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/utils/sendAndWait/utils.ts -> services/n8n/infrastructure/nodes-base/external_services/utils/sendAndWait/utils.py
