"""
MIGRATION-META:
  source_path: packages/nodes-base/utils/sendAndWait/email-templates.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/utils/sendAndWait 的工具。导入/依赖:外部:无；内部:无；本地:无。导出:BUTTON_STYLE_SECONDARY、BUTTON_STYLE_PRIMARY、ACTION_RECORDED_PAGE、createEmailBodyWithN8nAttribution、createEmailBodyWithoutN8nAttribution。关键函数/方法:createEmailBodyWithN8nAttribution、createEmailBodyWithoutN8nAttribution。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/utils/sendAndWait/email-templates.ts -> services/n8n/infrastructure/nodes-base/external_services/utils/sendAndWait/email_templates.py
