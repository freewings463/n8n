"""
MIGRATION-META:
  source_path: packages/nodes-base/utils/binary.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/nodes-base/utils 的工具。导入/依赖:外部:iconv-lite、lodash/get、pdfjs-dist/…/api、xlsx、@utils/utilities、@thednp/dommatrix；内部:n8n-workflow；本地:无。导出:JsonToSpreadsheetBinaryFormat、JsonToSpreadsheetBinaryOptions、JsonToBinaryOptions、prepareBinariesDataList。关键函数/方法:convertJsonToSpreadsheetBinary、sheetName、createBinaryFromJson、parseText、extractDataFromPDF、prepareBinariesDataList。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/utils/binary.ts -> services/n8n/infrastructure/nodes-base/external_services/utils/binary.py
