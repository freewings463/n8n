"""
MIGRATION-META:
  source_path: packages/workflow/src/errors/node-api.error.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/workflow/src/errors 的工作流错误。导入/依赖:外部:axios、xml2js；内部:@n8n/errors；本地:./abstract/node.error、../utils。导出:NodeOperationErrorOptions、NodeApiError。关键函数/方法:removeCircularRefs、setDescriptionFromXml、parseString、setDefaultStatusCodeMessage。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-unsafe-member-access。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/errors/node-api.error.ts -> services/n8n/infrastructure/workflow/external_services/clients/errors/node_api_error.py
