"""
MIGRATION-META:
  source_path: packages/@n8n/task-runner/src/js-task-runner/js-task-runner.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/task-runner/src/js-task-runner 的模块。导入/依赖:外部:lodash/isObject、lodash/set 等3项；内部:n8n-core、@/config/main-config 等3项；本地:./built-ins-parser/built-ins-parser 等7项。导出:RpcCallObject、JSExecSettings、JsTaskData、JsTaskRunner。关键函数/方法:get、set、parseModuleAllowList、preventPrototypePollution、require、executeTask、validateTaskSettings、getNativeVariables、runForAllItems 等14项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/task-runner/src/js-task-runner/js-task-runner.ts -> services/n8n/infrastructure/n8n-task-runner/container/js-task-runner/js_task_runner.py
