"""
MIGRATION-META:
  source_path: packages/@n8n/task-runner/src/runner-types.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/task-runner/src 的类型。导入/依赖:外部:无；内部:无；本地:无。导出:InputDataChunkDefinition、InputDataRequestParams、TaskDataRequestParams、DataRequestResponse、TaskResultData、TaskData、PartialAdditionalData、EXPOSED_RPC_METHODS 等3项。关键函数/方法:无。用于定义该模块相关类型/结构约束，供多模块共享。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/task-runner/src/runner-types.ts -> services/n8n/infrastructure/n8n-task-runner/container/runner_types.py
