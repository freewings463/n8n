"""
MIGRATION-META:
  source_path: packages/@n8n/task-runner/src/task-state.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/task-runner/src 的模块。导入/依赖:外部:node:assert；内部:无；本地:无。导出:TaskStatus、TaskStateOpts、TaskState。关键函数/方法:cleanup、clearTimeout、toJSON、caseOf。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/task-runner/src/task-state.ts -> services/n8n/infrastructure/n8n-task-runner/container/task_state.py
