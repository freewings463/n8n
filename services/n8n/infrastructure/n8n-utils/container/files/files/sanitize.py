"""
MIGRATION-META:
  source_path: packages/@n8n/utils/src/files/sanitize.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/utils/src/files 的工具。导入/依赖:外部:无；内部:无；本地:无。导出:sanitizeFilename。关键函数/方法:sanitizeFilename。用于提供该模块通用工具能力（纯函数/封装器）供复用。注释目标:Constants definition。
  entities: []
  external_dependencies: []
  mapping_confidence: High
  todo_refactor_ddd:
    - Filesystem/path helpers -> infrastructure/container/files
    - Rewrite implementation for Infrastructure layer
  moved_in_batch: 2026-01-18-system-analysis-ddd-mapping
"""
# TODO-REFACTOR-DDD: packages/@n8n/utils/src/files/sanitize.ts -> services/n8n/infrastructure/n8n-utils/container/files/files/sanitize.py
