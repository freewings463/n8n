"""
MIGRATION-META:
  source_path: packages/@n8n/decorators/src/module/module.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/decorators/src/module 的模块。导入/依赖:外部:无；内部:@n8n/constants、@n8n/di；本地:./module-metadata。导出:BaseEntity、TimestampedIdEntity、TimestampedEntity、EntityClass、ModuleSettings、ModuleContext、ModuleInterface、ModuleClass 等3项。关键函数/方法:save、hasId、remove、softRemove、recover、reload。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/decorators/src/module/module.ts -> services/n8n/infrastructure/n8n-decorators/container/src/module/module.py
