"""
MIGRATION-META:
  source_path: packages/@n8n/decorators/src/context-establishment/context-establishment-hook.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/decorators/src/context-establishment 的模块。导入/依赖:外部:无；内部:@n8n/di；本地:无。导出:ContextEstablishmentOptions、ContextEstablishmentResult、HookDescription、IContextEstablishmentHook、ContextEstablishmentHookClass。关键函数/方法:execute、isApplicableToTriggerNode。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/decorators/src/context-establishment/context-establishment-hook.ts -> services/n8n/infrastructure/n8n-decorators/container/src/context-establishment/context_establishment_hook.py
