"""
MIGRATION-META:
  source_path: packages/@n8n/config/src/configs/executions.config.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/config/src/configs 的执行配置。导入/依赖:外部:zod；内部:无；本地:../decorators。导出:ExecutionMode、ExecutionsConfig。关键函数/方法:无。用于集中定义执行配置项与默认值，供其他模块读取。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/config/src/configs/executions.config.ts -> services/n8n/infrastructure/n8n-config/configuration/configs/executions_config.py
