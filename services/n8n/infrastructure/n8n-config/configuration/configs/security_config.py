"""
MIGRATION-META:
  source_path: packages/@n8n/config/src/configs/security.config.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/config/src/configs 的配置。导入/依赖:外部:无；内部:无；本地:../decorators。导出:SecurityConfig。关键函数/方法:无。用于集中定义该模块配置项与默认值，供其他模块读取。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/config/src/configs/security.config.ts -> services/n8n/infrastructure/n8n-config/configuration/configs/security_config.py
