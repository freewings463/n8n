"""
MIGRATION-META:
  source_path: packages/@n8n/di/src/di.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/di/src 的模块。导入/依赖:外部:reflect-metadata；内部:无；本地:无。导出:Constructable、Service、Container。关键函数/方法:paramTypes、reset。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/di/src/di.ts -> services/n8n/infrastructure/n8n-di/container/src/di.py
