"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/eslint.config.mjs
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain 的配置。导入/依赖:外部:eslint/config、eslint-plugin-n8n-nodes-base；内部:@n8n/eslint-config/node、@n8n/eslint-plugin-community-nodes；本地:无。导出:无。关键函数/方法:无。用于集中定义该模块配置项与默认值，供其他模块读取。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/eslint.config.mjs -> services/n8n/infrastructure/n8n-nodes-langchain/configuration/tooling/eslint_config.py
