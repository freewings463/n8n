"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/llms/LmChatGoogleVertex/LmChatGoogleVertex.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/llms/LmChatGoogleVertex 的节点。导入/依赖:外部:@google-cloud/resource-manager、@langchain/google-common 等2项；内部:n8n-nodes-base/…/utilities；本地:./error-handling、../gemini-common/additional-options 等2项。导出:LmChatGoogleVertex。关键函数/方法:getConnectionHintNoticeField、getAdditionalOptions、gcpProjectsList、email、supplyData、validateNodeParameters。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/llms/LmChatGoogleVertex/LmChatGoogleVertex.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/llms/LmChatGoogleVertex/LmChatGoogleVertex_node.py
