"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/llms/LMOpenAi/LmOpenAi.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/llms/LMOpenAi 的节点。导入/依赖:外部:@langchain/openai、@utils/httpProxyAgent；内部:n8n-workflow、@n8n/di、@n8n/config；本地:../n8nLlmFailedAttemptHandler、../N8nLlmTracing。导出:LmOpenAi。关键函数/方法:openAiModelSearch、supplyData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/llms/LMOpenAi/LmOpenAi.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/llms/LMOpenAi/LmOpenAi_node.py
