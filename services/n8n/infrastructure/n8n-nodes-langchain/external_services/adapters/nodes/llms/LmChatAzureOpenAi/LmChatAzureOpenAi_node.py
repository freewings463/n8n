"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/llms/LmChatAzureOpenAi/LmChatAzureOpenAi.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/llms/LmChatAzureOpenAi 的节点。导入/依赖:外部:@langchain/openai、@utils/httpProxyAgent；内部:无；本地:./credentials/api-key、./credentials/oauth2、./properties、./types 等2项。导出:LmChatAzureOpenAi。关键函数/方法:supplyData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/llms/LmChatAzureOpenAi/LmChatAzureOpenAi.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/llms/LmChatAzureOpenAi/LmChatAzureOpenAi_node.py
