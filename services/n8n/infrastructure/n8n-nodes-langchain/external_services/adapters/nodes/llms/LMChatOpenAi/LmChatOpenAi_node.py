"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/llms/LMChatOpenAi/LmChatOpenAi.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/llms/LMChatOpenAi 的节点。导入/依赖:外部:@langchain/openai、lodash/pick、@utils/httpProxyAgent、@utils/sharedFields；内部:@n8n/di、@n8n/config；本地:../helpers/error-handling、../n8nLlmFailedAttemptHandler、../N8nLlmTracing、./common 等2项。导出:LmChatOpenAi。关键函数/方法:getConnectionHintNoticeField、supplyData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/llms/LMChatOpenAi/LmChatOpenAi.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/llms/LMChatOpenAi/LmChatOpenAi_node.py
