"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/llms/LmChatAwsBedrock/LmChatAwsBedrock.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/llms/LmChatAwsBedrock 的节点。导入/依赖:外部:@aws-sdk/client-bedrock-runtime、@langchain/aws、@smithy/node-http-handler、@utils/httpProxyAgent、@utils/sharedFields；内部:无；本地:../n8nLlmFailedAttemptHandler、../N8nLlmTracing。导出:LmChatAwsBedrock。关键函数/方法:getConnectionHintNoticeField、supplyData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/llms/LmChatAwsBedrock/LmChatAwsBedrock.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/llms/LmChatAwsBedrock/LmChatAwsBedrock_node.py
