"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/ModelSelector/ModelSelector.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/ModelSelector 的节点。导入/依赖:外部:@langchain/core/…/base、@langchain/core/…/manager 等1项；内部:无；本地:./helpers、../llms/N8nLlmTracing、../llms/N8nNonEstimatingTracing。导出:ModelSelector。关键函数/方法:getCallbacksArray、getModels、supplyData、models。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。注释目标:eslint-disable n8n-nodes-base/node-param-description-wrong-for-dynamic-options。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/ModelSelector/ModelSelector.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/ModelSelector/ModelSelector_node.py
