"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/tools/ToolWorkflow/ToolWorkflow.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/tools/ToolWorkflow 的工作流节点。导入/依赖:外部:无；内部:n8n-workflow；本地:./v1/ToolWorkflowV1.node、./v2/ToolWorkflowV2.node。导出:ToolWorkflow。关键函数/方法:无。用于实现 n8n 工作流节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/tools/ToolWorkflow/ToolWorkflow.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/tools/ToolWorkflow/ToolWorkflow_node.py
