"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/tools/ToolWorkflow/v1/versionDescription.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/tools/ToolWorkflow 的工作流节点。导入/依赖:外部:无；内部:n8n-workflow；本地:../utils/sharedFields。导出:versionDescription。关键函数/方法:getConnectionHintNoticeField。用于实现 n8n 工作流节点的描述与执行逻辑，供工作流运行。注释目标:eslint-disable n8n-nodes-base/node-filename-against-convention。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/tools/ToolWorkflow/v1/versionDescription.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/tools/ToolWorkflow/v1/versionDescription.py
