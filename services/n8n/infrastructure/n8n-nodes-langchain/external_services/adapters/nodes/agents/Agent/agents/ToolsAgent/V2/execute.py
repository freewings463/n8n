"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/agents/Agent/agents/ToolsAgent/V2/execute.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/agents/Agent 的节点。导入/依赖:外部:@langchain/core/…/event_stream、@langchain/core/…/stream、@langchain/core/…/chat_models、@langchain/core/messages、@langchain/core/prompts 等7项；内部:n8n-workflow；本地:../prompt。导出:无。关键函数/方法:createAgentExecutor、getAgentStepsParser、processEventStream、checkIsResponsesApi、toolsAgentExecute、assert。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/agents/Agent/agents/ToolsAgent/V2/execute.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/agents/Agent/agents/ToolsAgent/V2/execute.py
