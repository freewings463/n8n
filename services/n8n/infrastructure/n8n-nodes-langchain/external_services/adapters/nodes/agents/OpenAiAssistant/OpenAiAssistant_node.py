"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/agents/OpenAiAssistant/OpenAiAssistant.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/agents/OpenAiAssistant 的节点。导入/依赖:外部:@langchain/classic/agents、@langchain/classic/…/schema、@langchain/classic/…/openai_assistant、openai、@utils/helpers、@utils/tracing；内部:n8n-workflow、@n8n/di、@n8n/config；本地:./utils。导出:OpenAiAssistant。关键函数/方法:execute。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/agents/OpenAiAssistant/OpenAiAssistant.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/agents/OpenAiAssistant/OpenAiAssistant_node.py
