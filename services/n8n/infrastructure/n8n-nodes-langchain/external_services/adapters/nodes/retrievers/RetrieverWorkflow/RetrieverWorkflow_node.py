"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/retrievers/RetrieverWorkflow/RetrieverWorkflow.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/retrievers/RetrieverWorkflow 的工作流节点。导入/依赖:外部:@langchain/core/…/manager、@langchain/core/documents、@langchain/core/retrievers、@utils/logWrapper；内部:n8n-nodes-base/…/interfaces、n8n-nodes-base/…/manual.mode、n8n-workflow；本地:无。导出:RetrieverWorkflow。关键函数/方法:objectToString、supplyData。用于实现 n8n 工作流节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/retrievers/RetrieverWorkflow/RetrieverWorkflow.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/retrievers/RetrieverWorkflow/RetrieverWorkflow_node.py
