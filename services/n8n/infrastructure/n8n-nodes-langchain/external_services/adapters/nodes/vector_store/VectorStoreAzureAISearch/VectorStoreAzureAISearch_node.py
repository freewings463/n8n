"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreAzureAISearch/VectorStoreAzureAISearch.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreAzureAISearch 的节点。导入/依赖:外部:@azure/search-documents、@langchain/core/embeddings；内部:无；本地:../createVectorStoreNode/createVectorStoreNode。导出:AZURE_AI_SEARCH_CREDENTIALS、INDEX_NAME、QUERY_TYPE、FILTER 等3项。关键函数/方法:isExecutionContext、getParameter、getValidatedCredentials、clearAzureSearchIndex 等6项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreAzureAISearch/VectorStoreAzureAISearch.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStoreAzureAISearch/VectorStoreAzureAISearch_node.py
