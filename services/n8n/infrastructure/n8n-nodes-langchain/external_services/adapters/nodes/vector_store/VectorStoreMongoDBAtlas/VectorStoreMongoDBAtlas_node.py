"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreMongoDBAtlas/VectorStoreMongoDBAtlas.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreMongoDBAtlas 的节点。导入/依赖:外部:@langchain/core/embeddings、@langchain/mongodb 等2项；内部:n8n-nodes-base/…/GenericFunctions；本地:../createVectorStoreNode/createVectorStoreNode。导出:MONGODB_CREDENTIALS、MONGODB_COLLECTION_NAME、VECTOR_INDEX_NAME、EMBEDDING_NAME 等11项。关键函数/方法:getMongoClient、getDatabase、getCollections、getParameter 等3项。用于实现 n8n 该模块节点的描述与执行逻…
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreMongoDBAtlas/VectorStoreMongoDBAtlas.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStoreMongoDBAtlas/VectorStoreMongoDBAtlas_node.py
