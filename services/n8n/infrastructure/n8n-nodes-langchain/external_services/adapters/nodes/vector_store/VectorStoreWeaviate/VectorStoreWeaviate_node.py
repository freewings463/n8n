"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreWeaviate/VectorStoreWeaviate.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreWeaviate 的节点。导入/依赖:外部:@langchain/core/documents、@langchain/core/embeddings 等2项；内部:无；本地:./Weaviate.utils、../createVectorStoreNode/createVectorStoreNode 等2项。导出:VectorStoreWeaviate。关键函数/方法:fromExistingCollection、similaritySearchVectorWithScore、getVectorStoreClient、validFilter、populateVectorStore。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreWeaviate/VectorStoreWeaviate.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStoreWeaviate/VectorStoreWeaviate_node.py
