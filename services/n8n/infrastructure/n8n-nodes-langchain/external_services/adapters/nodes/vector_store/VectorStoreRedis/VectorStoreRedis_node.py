"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreRedis/VectorStoreRedis.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreRedis 的节点。导入/依赖:外部:@langchain/core/embeddings、@langchain/redis 等2项；内部:无；本地:../createVectorStoreNode/createVectorStoreNode。导出:redisConfig、getParameter、getParameterAsNumber、VectorStoreRedis。关键函数/方法:getRedisClient、isStringArray、listIndexes、getParameter、getParameterAsNumber、similaritySearchVectorWithScore 等2项。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreRedis/VectorStoreRedis.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStoreRedis/VectorStoreRedis_node.py
