"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreZep/VectorStoreZep.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreZep 的节点。导入/依赖:外部:@langchain/community/…/zep、@langchain/community/…/zep_cloud、@utils/sharedFields；内部:n8n-workflow；本地:../createVectorStoreNode/createVectorStoreNode。导出:VectorStoreZep。关键函数/方法:getVectorStoreClient、populateVectorStore、errorCode、responseData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreZep/VectorStoreZep.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStoreZep/VectorStoreZep_node.py
