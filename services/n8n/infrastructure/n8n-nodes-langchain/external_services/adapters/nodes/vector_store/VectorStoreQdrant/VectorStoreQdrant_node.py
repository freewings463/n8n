"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreQdrant/VectorStoreQdrant.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreQdrant 的节点。导入/依赖:外部:@langchain/core/…/manager、@langchain/core/embeddings 等2项；内部:n8n-workflow；本地:./Qdrant.utils、../createVectorStoreNode/createVectorStoreNode 等2项。导出:VectorStoreQdrant。关键函数/方法:fromExistingCollection、similaritySearch、getVectorStoreClient、assertParamIsString、populateVectorStore。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreQdrant/VectorStoreQdrant.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStoreQdrant/VectorStoreQdrant_node.py
