"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreZepInsert/VectorStoreZepInsert.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreZepInsert 的节点。导入/依赖:外部:@langchain/community/…/zep、@langchain/core/documents、@langchain/core/embeddings、@utils/N8nJsonLoader；内部:无；本地:../shared/processDocuments。导出:VectorStoreZepInsert。关键函数/方法:execute、documentInput、embeddings。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreZepInsert/VectorStoreZepInsert.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStoreZepInsert/VectorStoreZepInsert_node.py
