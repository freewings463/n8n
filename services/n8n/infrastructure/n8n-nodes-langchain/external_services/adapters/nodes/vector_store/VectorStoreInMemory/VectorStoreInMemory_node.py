"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreInMemory/VectorStoreInMemory.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreInMemory 的节点。导入/依赖:外部:@langchain/core/embeddings、@langchain/classic/…/memory；内部:无；本地:../createVectorStoreNode/createVectorStoreNode、../MemoryManager/MemoryVectorStoreManager。导出:VectorStoreInMemory。关键函数/方法:getMemoryKey、vectorStoresSearch、createVectorStore、getVectorStoreClient、populateVectorStore。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStoreInMemory/VectorStoreInMemory.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStoreInMemory/VectorStoreInMemory_node.py
