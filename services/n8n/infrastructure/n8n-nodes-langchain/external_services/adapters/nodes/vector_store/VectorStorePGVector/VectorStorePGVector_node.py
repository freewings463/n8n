"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStorePGVector/VectorStorePGVector.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/vector_store/VectorStorePGVector 的节点。导入/依赖:外部:@langchain/core/embeddings、pg 等1项；内部:n8n-nodes-base/…/index、n8n-nodes-base/…/interfaces 等1项；本地:../createVectorStoreNode/createVectorStoreNode。导出:VectorStorePGVector。关键函数/方法:initialize、similaritySearchVectorWithScore、getVectorStoreClient、populateVectorStore、releaseVectorStoreClient。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/vector_store/VectorStorePGVector/VectorStorePGVector.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/vector_store/VectorStorePGVector/VectorStorePGVector_node.py
