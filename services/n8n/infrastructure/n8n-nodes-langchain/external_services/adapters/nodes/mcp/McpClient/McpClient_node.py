"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/mcp/McpClient/McpClient.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/mcp/McpClient 的节点。导入/依赖:外部:@modelcontextprotocol/sdk/types.js、zod、zod/…/core；内部:n8n-workflow；本地:./listSearch、./resourceMapping、../shared/descriptions、../shared/types。导出:McpClient。关键函数/方法:execute、transportSelect、result。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/mcp/McpClient/McpClient.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/mcp/McpClient/McpClient_node.py
