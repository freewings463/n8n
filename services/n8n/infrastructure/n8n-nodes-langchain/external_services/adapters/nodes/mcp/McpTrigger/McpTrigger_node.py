"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/mcp/McpTrigger/McpTrigger.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/mcp/McpTrigger 的节点。导入/依赖:外部:@utils/helpers；内部:n8n-nodes-base/…/error、n8n-nodes-base/…/utils、n8n-workflow；本地:./FlushingTransport、./McpServer。导出:McpTrigger。关键函数/方法:webhook。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/mcp/McpTrigger/McpTrigger.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/mcp/McpTrigger/McpTrigger_node.py
