"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/chains/ChainSummarization/V2/ChainSummarizationV2.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/chains/ChainSummarization 的节点。导入/依赖:外部:@utils/sharedFields；内部:n8n-workflow；本地:./processItem、../prompt。导出:ChainSummarizationV2。关键函数/方法:execute、getInputs、getTemplateNoticeField、getBatchingOptionFields。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/chains/ChainSummarization/V2/ChainSummarizationV2.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/chains/ChainSummarization/V2/ChainSummarizationV2_node.py
