"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/chains/ChainRetrievalQA/processItem.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/chains/ChainRetrievalQA 的节点。导入/依赖:外部:@langchain/core/…/base、@langchain/core/retrievers、@langchain/classic/…/combine_documents、@langchain/classic/…/retrieval、@utils/helpers、@utils/tracing；内部:n8n-workflow；本地:./constants。导出:processItem。关键函数/方法:processItem、model、retriever。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/chains/ChainRetrievalQA/processItem.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/chains/ChainRetrievalQA/processItem.py
