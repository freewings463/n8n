"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/chains/ChainSummarization/V1/ChainSummarizationV1.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/chains/ChainSummarization 的节点。导入/依赖:外部:@langchain/core/documents、@langchain/core/…/base、@langchain/core/prompts、@langchain/classic/chains、@utils/N8nBinaryLoader、@utils/N8nJsonLoader 等1项；内部:无；本地:../prompt。导出:ChainSummarizationV1。关键函数/方法:execute、getTemplateNoticeField、model、documentInput。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/chains/ChainSummarization/V1/ChainSummarizationV1.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/chains/ChainSummarization/V1/ChainSummarizationV1_node.py
