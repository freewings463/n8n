"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/chains/InformationExtractor/InformationExtractor.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/chains/InformationExtractor 的节点。导入/依赖:外部:@langchain/core/…/base、json-schema、@langchain/classic/output_parsers、zod、@utils/schemaParsing、@utils/sharedFields；内部:n8n-workflow；本地:./constants、./helpers、./processItem、./types。导出:InformationExtractor。关键函数/方法:execute、buildJsonSchemaExampleNotice、getBatchingOptionFields、llm。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/chains/InformationExtractor/InformationExtractor.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/chains/InformationExtractor/InformationExtractor_node.py
