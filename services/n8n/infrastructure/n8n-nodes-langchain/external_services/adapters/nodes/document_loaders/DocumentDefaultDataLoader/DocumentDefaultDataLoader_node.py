"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/document_loaders/DocumentDefaultDataLoader/DocumentDefaultDataLoader.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/document_loaders/DocumentDefaultDataLoader 的节点。导入/依赖:外部:@langchain/textsplitters、@utils/logWrapper、@utils/N8nBinaryLoader、@utils/N8nJsonLoader、@utils/sharedFields；内部:无；本地:无。导出:DocumentDefaultDataLoader。关键函数/方法:getInputs、supplyData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/document_loaders/DocumentDefaultDataLoader/DocumentDefaultDataLoader.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/document_loaders/DocumentDefaultDataLoader/DocumentDefaultDataLoader_node.py
