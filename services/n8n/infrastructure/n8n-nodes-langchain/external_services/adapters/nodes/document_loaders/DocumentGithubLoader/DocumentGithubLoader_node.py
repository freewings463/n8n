"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/document_loaders/DocumentGithubLoader/DocumentGithubLoader.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/document_loaders/DocumentGithubLoader 的节点。导入/依赖:外部:@langchain/community/…/github、@langchain/textsplitters、@utils/logWrapper、@utils/sharedFields；内部:无；本地:无。导出:DocumentGithubLoader。关键函数/方法:getInputs、getConnectionHintNoticeField、supplyData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/document_loaders/DocumentGithubLoader/DocumentGithubLoader.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/document_loaders/DocumentGithubLoader/DocumentGithubLoader_node.py
