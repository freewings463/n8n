"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/memory/MemoryManager/MemoryManager.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/memory/MemoryManager 的节点。导入/依赖:外部:@langchain/community/…/chat_memory、@langchain/core/messages；内部:n8n-workflow；本地:无。导出:simplifyMessages、MemoryManager。关键函数/方法:execute、simplifyMessages、prepareOutputSetup、memory。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/memory/MemoryManager/MemoryManager.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/memory/MemoryManager/MemoryManager_node.py
