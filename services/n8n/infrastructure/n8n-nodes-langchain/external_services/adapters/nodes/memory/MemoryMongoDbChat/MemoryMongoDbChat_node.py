"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/memory/MemoryMongoDbChat/MemoryMongoDbChat.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/memory/MemoryMongoDbChat 的节点。导入/依赖:外部:@langchain/mongodb、@langchain/classic/memory、mongodb、@utils/helpers、@utils/logWrapper、@utils/sharedFields；内部:n8n-workflow；本地:无。导出:MemoryMongoDbChat。关键函数/方法:getConnectionHintNoticeField、expressionSessionKeyProperty、supplyData、closeFunction。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/memory/MemoryMongoDbChat/MemoryMongoDbChat.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/memory/MemoryMongoDbChat/MemoryMongoDbChat_node.py
