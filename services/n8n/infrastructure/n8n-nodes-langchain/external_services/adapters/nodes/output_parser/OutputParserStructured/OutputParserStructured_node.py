"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/output_parser/OutputParserStructured/OutputParserStructured.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/output_parser/OutputParserStructured 的节点。导入/依赖:外部:@langchain/core/…/base、@langchain/core/prompts、json-schema、zod、@utils/schemaParsing、@utils/sharedFields；内部:无；本地:./prompt。导出:OutputParserStructured。关键函数/方法:getConnectionHintNoticeField、buildJsonSchemaExampleNotice、supplyData、model。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/output_parser/OutputParserStructured/OutputParserStructured.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/output_parser/OutputParserStructured/OutputParserStructured_node.py
