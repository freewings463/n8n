"""
MIGRATION-META:
  source_path: packages/@n8n/nodes-langchain/nodes/embeddings/EmbeddingsGoogleVertex/EmbeddingsGoogleVertex.node.ts
  target_context: n8n
  target_layer: Infrastructure
  responsibility: 位于 packages/@n8n/nodes-langchain/nodes/embeddings/EmbeddingsGoogleVertex 的节点。导入/依赖:外部:@google-cloud/resource-manager、@langchain/google-vertexai、@utils/logWrapper、@utils/sharedFields；内部:n8n-nodes-base/…/utilities、n8n-workflow；本地:无。导出:EmbeddingsGoogleVertex。关键函数/方法:gcpProjectsList、email、getConnectionHintNoticeField、supplyData。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/nodes-langchain/nodes/embeddings/EmbeddingsGoogleVertex/EmbeddingsGoogleVertex.node.ts -> services/n8n/infrastructure/n8n-nodes-langchain/external_services/adapters/nodes/embeddings/EmbeddingsGoogleVertex/EmbeddingsGoogleVertex_node.py
