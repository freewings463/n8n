"""
MIGRATION-META:
  source_path: packages/cli/src/commands/db/revert.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/commands/db 的模块。导入/依赖:外部:无；内部:@n8n/backend-common、@n8n/db、@n8n/decorators、@n8n/di、@n8n/typeorm；本地:无。导出:DbRevertMigrationCommand。关键函数/方法:run、main、finally。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/commands/db/revert.ts -> services/n8n/presentation/cli/cli/commands/db/revert.py
