"""
MIGRATION-META:
  source_path: packages/cli/src/commands/webhook.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/commands 的Webhook模块。导入/依赖:外部:无；内部:@n8n/decorators、@n8n/di、@/active-executions、@/deprecation/deprecation.service、@/eventbus/…/message-event-bus、@/events/…/log-streaming.event-relay 等5项；本地:./base-command。导出:Webhook。关键函数/方法:init、run、stopProcess、initOrchestration。用于承载Webhook实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/commands/webhook.ts -> services/n8n/presentation/cli/cli/commands/webhook.py
