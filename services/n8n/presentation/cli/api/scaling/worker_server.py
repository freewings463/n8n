"""
MIGRATION-META:
  source_path: packages/cli/src/scaling/worker-server.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/scaling 的模块。导入/依赖:外部:express、node:assert；内部:@n8n/backend-common、@n8n/config、@n8n/db、@n8n/di、n8n-core、@/credentials-overwrites 等8项；本地:无。导出:WorkerServerEndpointsConfig、WorkerServer。关键函数/方法:init、assert、mountEndpoints、readiness、handleOverwrites。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/scaling/worker-server.ts -> services/n8n/presentation/cli/api/scaling/worker_server.py
