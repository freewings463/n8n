"""
MIGRATION-META:
  source_path: packages/cli/src/push/origin-validator.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/push 的校验。导入/依赖:外部:express；内部:无；本地:无。导出:OriginValidationResult、validateOriginHeaders。关键函数/方法:validateOriginHeaders、normalizeHost、stripIPv6Brackets、getFirstHeaderValue、validateProtocol、parseForwardedHeader、parseOrigin。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/push/origin-validator.ts -> services/n8n/presentation/cli/api/push/origin_validator.py
