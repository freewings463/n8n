"""
MIGRATION-META:
  source_path: packages/cli/src/push/websocket.push.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/push 的模块。导入/依赖:外部:ws；内部:@n8n/api-types、@n8n/db、@n8n/di、n8n-workflow；本地:./abstract.push。导出:WebSocketPush。关键函数/方法:heartbeat、add、onMessage、close、sendToOneConnection、ping、isClientHeartbeat。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/push/websocket.push.ts -> services/n8n/presentation/cli/api/ws/push/websocket_push.py
