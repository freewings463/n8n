"""
MIGRATION-META:
  source_path: packages/cli/src/chat/chat-service.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/chat 的服务。导入/依赖:外部:ws、zod；内部:@n8n/backend-common、@n8n/di、@n8n/decorators、n8n-workflow、n8n-core、@n8n/db；本地:./chat-execution-manager、./utils。导出:ChatService。关键函数/方法:closeConnection、setTimeout、async、startSession、clearInterval、processWaitingExecution、processSuccessExecution、waitForChatResponseOrContinue、pollAndProcessChatResponses、incomingMessageHandler 等7项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/chat/chat-service.ts -> services/n8n/presentation/cli/api/ws/chat/chat_service.py
