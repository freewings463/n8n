"""
MIGRATION-META:
  source_path: packages/cli/src/task-runners/task-broker/task-broker-ws-server.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/task-runners/task-broker 的模块。导入/依赖:外部:ws；内部:@n8n/backend-common、@n8n/config、@n8n/constants、@n8n/di、@n8n/task-runner、n8n-workflow 等3项；本地:./task-broker.service。导出:TaskBrokerWsServer。关键函数/方法:start、stop、heartbeat、startHeartbeatChecks、clearInterval、setDisconnectAnalyzer、getDisconnectAnalyzer、sendMessage、add、onMessage 等4项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/task-runners/task-broker/task-broker-ws-server.ts -> services/n8n/presentation/cli/api/ws/task-runners/task-broker/task_broker_ws_server.py
