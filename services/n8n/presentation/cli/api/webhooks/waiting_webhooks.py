"""
MIGRATION-META:
  source_path: packages/cli/src/webhooks/waiting-webhooks.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/webhooks 的Webhook模块。导入/依赖:外部:express；内部:@n8n/backend-common、@n8n/db、@n8n/di 等7项；本地:./webhook-request-sanitizer、./webhook.service。导出:WaitingWebhooks。关键函数/方法:logReceivedWebhook、disableNode、isSendAndWaitRequest、createWorkflow、getExecution、validateSignatureInRequest、executeWebhook、sanitizeWebhookRequest、applyCors、getWebhookExecutionData 等1项。用于承载Webhook实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/webhooks/waiting-webhooks.ts -> services/n8n/presentation/cli/api/webhooks/waiting_webhooks.py
