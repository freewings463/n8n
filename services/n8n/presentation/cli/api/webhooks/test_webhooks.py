"""
MIGRATION-META:
  source_path: packages/cli/src/webhooks/test-webhooks.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/webhooks 的Webhook模块。导入/依赖:外部:express；内部:@/constants、@n8n/decorators、@n8n/di、n8n-core 等13项；本地:./constants、./webhook-request-sanitizer、./webhook.service。导出:TestWebhooks。关键函数/方法:executeWebhook、sanitizeWebhookRequest、handleClearTestWebhooks、clearTimeout、getWebhooksFromPath、getWebhookMethods、findAccessControlOptions、needsWebhook、async、cancelWebhook 等4项。用于承载Webhook实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/webhooks/test-webhooks.ts -> services/n8n/presentation/cli/api/webhooks/test_webhooks.py
