"""
MIGRATION-META:
  source_path: packages/cli/src/webhooks/live-webhooks.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/webhooks 的Webhook模块。导入/依赖:外部:express；内部:@n8n/backend-common、@n8n/db、@n8n/di、n8n-workflow、@/errors/…/not-found.error、@/errors/…/webhook-not-found.error 等5项；本地:./constants、./webhook-request-sanitizer。导出:LiveWebhooks。关键函数/方法:getWebhookMethods、findAccessControlOptions、isChatWebhookNode、executeWebhook、sanitizeWebhookRequest、async、resolve、findWebhook。用于承载Webhook实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/webhooks/live-webhooks.ts -> services/n8n/presentation/cli/api/webhooks/live_webhooks.py
