"""
MIGRATION-META:
  source_path: packages/cli/src/modules/chat-hub/stream-capturer.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/modules/chat-hub 的模块。导入/依赖:外部:express、uuid；内部:@n8n/api-types、n8n-workflow；本地:./chat-hub-message.entity。导出:ChunkTransformer、interceptResponseWrites、AggregatedMessage、createStructuredChunkAggregator。关键函数/方法:toText、write、originalWrite、originalCb、end、originalEnd、keyOf、createStructuredChunkAggregator、startNew、ensureMessage 等2项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/chat-hub/stream-capturer.ts -> services/n8n/presentation/cli/api/modules/chat-hub/stream_capturer.py
