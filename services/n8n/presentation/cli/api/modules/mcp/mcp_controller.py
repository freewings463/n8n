"""
MIGRATION-META:
  source_path: packages/cli/src/modules/mcp/mcp.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/modules/mcp 的控制器。导入/依赖:外部:@modelcontextprotocol/sdk/…/streamableHttp.js、express；内部:@n8n/backend-common、@n8n/db、@n8n/decorators 等3项；本地:./mcp-server-middleware.service、./mcp.service、./mcp.settings.service、./mcp.typeguards 等2项。导出:FlushableResponse、McpController。关键函数/方法:build、getAuthMiddleware、setCorsHeaders、discoverAuthSchemeHead、trackConnectionEvent。用于处理该模块接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/mcp/mcp.controller.ts -> services/n8n/presentation/cli/api/modules/mcp/mcp_controller.py
