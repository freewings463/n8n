"""
MIGRATION-META:
  source_path: packages/cli/src/modules/mcp/mcp-oauth-service.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/modules/mcp 的OAuth服务。导入/依赖:外部:@modelcontextprotocol/sdk/…/clients、@modelcontextprotocol/sdk/…/types 等1项；内部:@n8n/backend-common、@n8n/di；本地:../entities/oauth-client.entity 等5项。导出:SUPPORTED_SCOPES、McpOAuthService。关键函数/方法:authorize、challengeForAuthorizationCode、exchangeAuthorizationCode、exchangeRefreshToken、verifyAccessToken、revokeToken、getAllClients 等1项。用于封装OAuth业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/mcp/mcp-oauth-service.ts -> services/n8n/presentation/cli/api/modules/mcp/mcp_oauth_service.py
