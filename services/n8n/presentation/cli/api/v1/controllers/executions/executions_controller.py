"""
MIGRATION-META:
  source_path: packages/cli/src/executions/executions.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/executions 的执行控制器。导入/依赖:外部:无；内部:@n8n/db、@n8n/decorators、@n8n/permissions、@/errors/…/bad-request.error、@/errors/…/not-found.error、@/license 等2项；本地:./execution.service、./execution.service.ee、./execution.types、./parse-range-query.middleware 等1项。导出:ExecutionsController。关键函数/方法:stop、delete、update、getAccessibleWorkflowIds、getMany、getOne、stopMany、retry。用于处理执行接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/executions/executions.controller.ts -> services/n8n/presentation/cli/api/v1/controllers/executions/executions_controller.py
