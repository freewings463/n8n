"""
MIGRATION-META:
  source_path: packages/cli/src/webhooks/webhook-last-node-response-extractor.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/webhooks 的Webhook模块。导入/依赖:外部:lodash/get；内部:@n8n/di、n8n-core、n8n-workflow、@/webhooks/webhook-execution-context；本地:无。导出:无。关键函数/方法:extractWebhookLastNodeResponse、extractFirstEntryJsonFromTaskData、extractFirstEntryBinaryFromTaskData、extractAllEntriesJsonFromTaskData。用于承载Webhook实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/webhooks/webhook-last-node-response-extractor.ts -> services/n8n/presentation/cli/api/v1/controllers/webhooks/webhook_last_node_response_extractor.py
