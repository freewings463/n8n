"""
MIGRATION-META:
  source_path: packages/cli/src/modules/community-packages/community-packages.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/modules/community-packages 的控制器。导入/依赖:外部:semver；内部:@n8n/decorators、@/errors/…/bad-request.error 等4项；本地:./community-node-types.service、./community-packages.service、./community-packages.types 等1项。导出:isNpmError、CommunityPackagesController。关键函数/方法:isClientError、isNpmError、installPackage、getInstalledPackages、uninstallPackage、updatePackage。用于处理该模块接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/community-packages/community-packages.controller.ts -> services/n8n/presentation/cli/api/v1/controllers/modules/community-packages/community_packages_controller.py
