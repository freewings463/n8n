"""
MIGRATION-META:
  source_path: packages/cli/src/modules/insights/insights.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/modules/insights 的Insights控制器。导入/依赖:外部:luxon、zod；内部:@n8n/api-types、@n8n/db、@n8n/decorators、n8n-workflow 等3项；本地:./insights.service。导出:InsightsController。关键函数/方法:getInsightsSummary、getInsightsByWorkflow、getInsightsByTime、getTimeSavedInsightsByTime、validateQueryDates、inThePast、prepareDateFilters、getSanitizedDateFilters、checkDatesFiltersAgainstLicense。用于处理Insights接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/insights/insights.controller.ts -> services/n8n/presentation/cli/api/v1/controllers/modules/insights/insights_controller.py
