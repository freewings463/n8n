"""
MIGRATION-META:
  source_path: packages/cli/src/public-api/v1/handlers/workflows/workflows.service.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/public-api/v1/handlers 的工作流服务。导入/依赖:外部:无；内部:@n8n/config、@n8n/db、@n8n/di、@n8n/permissions、@/license、@/workflows/workflow-sharing.service；本地:无。导出:parseTagNames。关键函数/方法:insertIf、getSharedWorkflowIds、getSharedWorkflow、getWorkflowById、createWorkflow、deleteWorkflow、parseTagNames、getWorkflowTags、updateTags。用于封装工作流业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/public-api/v1/handlers/workflows/workflows.service.ts -> services/n8n/presentation/cli/api/v1/handlers/workflows/workflows_service.py
