"""
MIGRATION-META:
  source_path: packages/cli/src/controllers/invitation.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/controllers 的控制器。导入/依赖:外部:express；内部:@n8n/api-types、@n8n/backend-common、@n8n/db、@n8n/decorators、@/auth/auth.service、@/constants 等11项；本地:无。导出:InvitationController。关键函数/方法:inviteUser、processInvitationAcceptance、acceptInvitationWithToken、acceptInvitation。用于处理该模块接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/controllers/invitation.controller.ts -> services/n8n/presentation/cli/api/controllers/invitation_controller.py
