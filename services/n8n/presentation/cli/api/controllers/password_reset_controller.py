"""
MIGRATION-META:
  source_path: packages/cli/src/controllers/password-reset.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/controllers 的控制器。导入/依赖:外部:express；内部:@n8n/backend-common、@n8n/db、@n8n/decorators、@n8n/permissions、@/auth/auth.service、@/constants 等13项；本地:无。导出:PasswordResetController。关键函数/方法:forgotPassword、resolvePasswordToken、changePassword。用于处理该模块接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/controllers/password-reset.controller.ts -> services/n8n/presentation/cli/api/controllers/password_reset_controller.py
