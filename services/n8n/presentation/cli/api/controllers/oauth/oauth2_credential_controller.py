"""
MIGRATION-META:
  source_path: packages/cli/src/controllers/oauth/oauth2-credential.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/controllers/oauth 的OAuth控制器。导入/依赖:外部:express、lodash/omit、lodash/set、lodash/split；内部:@n8n/client-oauth2、@n8n/decorators、n8n-workflow、@/requests、@/oauth/oauth.service、@n8n/backend-common 等1项；本地:无。导出:OAuth2CredentialController。关键函数/方法:set、getAuthUri、handleCallback、convertCredentialToOptions。用于处理OAuth接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/controllers/oauth/oauth2-credential.controller.ts -> services/n8n/presentation/cli/api/controllers/oauth/oauth2_credential_controller.py
