"""
MIGRATION-META:
  source_path: packages/cli/src/sso.ee/saml/saml.service.ee.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/sso.ee/saml 的SSO服务。导入/依赖:外部:axios、express 等2项；内部:@n8n/api-types、@n8n/backend-common 等11项；本地:./constants 等6项。导出:SamlService。关键函数/方法:init、loadSamlify、getIdentityProviderInstance、getServiceProviderInstance、getLoginRequestUrl、getRedirectLoginRequestUrl、getPostLoginRequestUrl、handleSamlLogin、applySsoProvisioning、broadcastReloadSAMLConfigurationCommand 等10项。用于封装SSO业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/sso.ee/saml/saml.service.ee.ts -> services/n8n/presentation/cli/api/sso.ee/saml/saml_service_ee.py
