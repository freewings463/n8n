"""
MIGRATION-META:
  source_path: packages/cli/src/public-api/v1/handlers/credentials/credentials.handler.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/public-api/v1/handlers 的凭证。导入/依赖:外部:express、zod；内部:@n8n/backend-common、@n8n/db、@n8n/di、@n8n/permissions、@/credential-types、@/credentials/credentials.service.ee 等1项；本地:../../types、../middlewares/global.middleware。导出:无。关键函数/方法:apiKeyHasScope、async、projectScope。用于声明 n8n 该模块鉴权字段/校验规则，供节点引用。注释目标:eslint-disable @typescript-eslint/no-unsafe-argument。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/public-api/v1/handlers/credentials/credentials.handler.ts -> services/n8n/presentation/cli/api/public-api/v1/handlers/credentials/credentials_handler.py
