"""
MIGRATION-META:
  source_path: packages/cli/src/public-api/v1/handlers/workflows/workflows.handler.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/public-api/v1/handlers 的工作流模块。导入/依赖:外部:express、uuid、zod；内部:@n8n/config、@n8n/db、@n8n/di、@n8n/typeorm、@/errors/…/not-found.error、@/events/event.service 等6项；本地:./workflows.service、../../types、../services/pagination.service。导出:无。关键函数/方法:apiKeyHasScope、async、addNodeIds、projectScope、parseTagNames。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/public-api/v1/handlers/workflows/workflows.handler.ts -> services/n8n/presentation/cli/api/public-api/v1/handlers/workflows/workflows_handler.py
