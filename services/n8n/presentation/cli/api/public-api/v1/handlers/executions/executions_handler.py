"""
MIGRATION-META:
  source_path: packages/cli/src/public-api/v1/handlers/executions/executions.handler.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/public-api/v1/handlers 的执行模块。导入/依赖:外部:express；内部:@n8n/db、@n8n/di、n8n-workflow、@/active-executions、@/concurrency/concurrency-control.service、@/errors/aborted-execution-retry.error 等4项；本地:../../types、../middlewares/global.middleware、../services/pagination.service、../workflows/workflows.service。导出:无。关键函数/方法:apiKeyHasScope、async。用于承载执行实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/public-api/v1/handlers/executions/executions.handler.ts -> services/n8n/presentation/cli/api/public-api/v1/handlers/executions/executions_handler.py
