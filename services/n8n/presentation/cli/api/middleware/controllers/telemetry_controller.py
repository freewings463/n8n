"""
MIGRATION-META:
  source_path: packages/cli/src/controllers/telemetry.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/controllers 的遥测控制器。导入/依赖:外部:express、http-proxy-middleware；内部:@n8n/config、@n8n/db、@n8n/decorators；本地:无。导出:TelemetryController。关键函数/方法:fixRequestBody、track、identify、page、sourceConfig。用于处理遥测接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/controllers/telemetry.controller.ts -> services/n8n/presentation/cli/api/middleware/controllers/telemetry_controller.py
