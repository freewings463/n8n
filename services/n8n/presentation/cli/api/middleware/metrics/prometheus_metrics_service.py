"""
MIGRATION-META:
  source_path: packages/cli/src/metrics/prometheus-metrics.service.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/metrics 的服务。导入/依赖:外部:express、express-prom-bundle、luxon 等2项；内部:@n8n/config、@n8n/constants、@n8n/db、@n8n/decorators、@n8n/di、n8n-core 等6项；本地:./types。导出:PrometheusMetricsService。关键函数/方法:init、enableMetric、disableMetric、disableAllMetrics、enableLabels、disableAllLabels、initN8nVersionMetric、initInstanceRoleMetric、updateOnLeaderTakeover、updateOnLeaderStepdown 等15项。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/metrics/prometheus-metrics.service.ts -> services/n8n/presentation/cli/api/middleware/metrics/prometheus_metrics_service.py
