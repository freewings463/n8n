"""
MIGRATION-META:
  source_path: packages/cli/src/credentials-overwrites.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:express；内部:@n8n/backend-common、@n8n/config、@n8n/db、@n8n/decorators、@n8n/di、n8n-core 等4项；本地:./services/frontend.service。导出:CredentialsOverwrites。关键函数/方法:init、get、reloadOverwriteCredentials、loadOverwriteDataFromDB、broadcastReloadOverwriteCredentialsCommand、saveOverwriteDataToDB、getOverwriteEndpointMiddleware、next、setPlainData、setData 等4项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/credentials-overwrites.ts -> services/n8n/presentation/cli/api/middleware/credentials_overwrites.py
