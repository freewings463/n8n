"""
MIGRATION-META:
  source_path: packages/cli/src/modules/mcp/mcp-server-middleware.service.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/modules/mcp 的服务。导入/依赖:外部:express；内部:@n8n/db、@n8n/di、n8n-workflow、@/errors/…/auth.error、@/services/jwt.service、@/telemetry；本地:./mcp-api-key.service、./mcp-oauth-token.service、./mcp.constants、./mcp.types 等1项。导出:McpServerMiddlewareService。关键函数/方法:getUserForToken、getAuthMiddleware、next、extractBearerToken、responseWithUnauthorized、trackUnauthorizedEvent。用于封装该模块业务流程，对上提供稳定调用面。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/mcp/mcp-server-middleware.service.ts -> services/n8n/presentation/cli/api/middleware/modules/mcp/mcp_server_middleware_service.py
