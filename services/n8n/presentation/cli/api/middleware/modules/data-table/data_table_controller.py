"""
MIGRATION-META:
  source_path: packages/cli/src/modules/data-table/data-table.controller.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src/modules/data-table 的控制器。导入/依赖:外部:express；内部:@n8n/db、n8n-workflow 等6项；本地:./data-table.service、./errors/data-table-column-name-conflict.error 等4项。导出:DataTableController。关键函数/方法:handleDataTableColumnOperationError、validateProjectExists、next、createDataTable、listProjectDataTables、updateDataTable、deleteDataTable、getColumns、addColumn、deleteColumn 等8项。用于处理该模块接口请求，调度服务/仓储并返回响应。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/modules/data-table/data-table.controller.ts -> services/n8n/presentation/cli/api/middleware/modules/data-table/data_table_controller.py
