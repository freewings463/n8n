"""
MIGRATION-META:
  source_path: packages/cli/src/abstract-server.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/cli/src 的模块。导入/依赖:外部:compression、express、fs/promises、isbot、@sentry/node；内部:@n8n/backend-common、@n8n/config、@n8n/db、@n8n/decorators、@n8n/di、@/config 等11项；本地:无。导出:无。关键函数/方法:init、start、configure、setupErrorHandlers、setupExpressErrorHandler、setupCommonMiddlewares、setupDevMiddlewares、setupPushServer、setupHealthCheck、createWebhookHandlerFor 等2项。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/cli/src/abstract-server.ts -> services/n8n/presentation/cli/api/middleware/abstract_server.py
