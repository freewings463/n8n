"""
MIGRATION-META:
  source_path: packages/@n8n/node-cli/src/commands/dev/index.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/node-cli/src/commands/dev 的入口。导入/依赖:外部:@oclif/core、picocolors；内部:无；本地:../utils/filesystem、../utils/package-manager、../utils/prompts、../utils/validation 等1项。导出:Dev。关键函数/方法:run、packageManager、setTimeout、runCommands。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/node-cli/src/commands/dev/index.ts -> services/n8n/presentation/n8n-node-cli/cli/commands/dev/__init__.py
