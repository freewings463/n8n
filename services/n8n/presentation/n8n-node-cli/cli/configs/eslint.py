"""
MIGRATION-META:
  source_path: packages/@n8n/node-cli/src/configs/eslint.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/node-cli/src/configs 的模块。导入/依赖:外部:@eslint/js、eslint/config、eslint-import-resolver-typescript、eslint-plugin-import-x、eslint-plugin-n8n-nodes-base、typescript-eslint；内部:@n8n/eslint-plugin-community-nodes；本地:无。导出:config、configWithoutCloudSupport。关键函数/方法:createConfig、globalIgnores。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/node-cli/src/configs/eslint.ts -> services/n8n/presentation/n8n-node-cli/cli/configs/eslint.py
