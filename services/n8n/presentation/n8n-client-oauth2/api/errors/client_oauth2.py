"""
MIGRATION-META:
  source_path: packages/@n8n/client-oauth2/src/client-oauth2.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/client-oauth2/src 的OAuth模块。导入/依赖:外部:axios、querystring；内部:无；本地:./client-oauth2-token、./code-flow、./credentials-flow、./types 等1项。导出:ClientOAuth2RequestObject、ClientOAuth2Options、ResponseError、ClientOAuth2。关键函数/方法:createToken、accessTokenRequest、contentType。用于承载OAuth实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-explicit-any。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/client-oauth2/src/client-oauth2.ts -> services/n8n/presentation/n8n-client-oauth2/api/errors/client_oauth2.py
