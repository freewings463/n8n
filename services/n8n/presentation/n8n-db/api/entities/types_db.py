"""
MIGRATION-META:
  source_path: packages/@n8n/db/src/entities/types-db.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/db/src/entities 的模块。导入/依赖:外部:express、zod；内部:@n8n/permissions、@n8n/typeorm；本地:./credentials-entity、./folder、./project、./shared-credentials 等5项。导出:UsageCount、ITagBase、ICredentialsBase、IExecutionBase、IPersonalizationSurveyAnswers、ITagDb、ITagWithCountDb、IWorkflowDb 等45项。关键函数/方法:isAuthProviderType。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/db/src/entities/types-db.ts -> services/n8n/presentation/n8n-db/api/entities/types_db.py
