"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Pipedrive/PipedriveTrigger.node.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/nodes-base/nodes/Pipedrive 的节点。导入/依赖:外部:basic-auth、express；内部:无；本地:./GenericFunctions。导出:PipedriveTrigger。关键函数/方法:create、delete、authorizationError、checkExists、webhook。用于实现 n8n 该模块节点的描述与执行逻辑，供工作流运行。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Pipedrive/PipedriveTrigger.node.ts -> services/n8n/presentation/nodes-base/api/nodes/Pipedrive/PipedriveTrigger_node.py
