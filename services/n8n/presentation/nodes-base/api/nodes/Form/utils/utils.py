"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Form/utils/utils.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/nodes-base/nodes/Form/utils 的工具。导入/依赖:外部:express、fs/promises 等4项；内部:n8n-core；本地:../utils/utilities 等3项。导出:sanitizeHtml、prepareFormFields、sanitizeCustomCss、validateSafeRedirectUrl、createDescriptionMetadata、prepareFormData、validateResponseModeConfiguration 等4项。关键函数/方法:sanitizeHtml、prepareFormFields、sanitizeCustomCss、validateSafeRedirectUrl 等13项。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Form/utils/utils.ts -> services/n8n/presentation/nodes-base/api/nodes/Form/utils/utils.py
