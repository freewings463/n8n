"""
MIGRATION-META:
  source_path: packages/nodes-base/nodes/Form/utils/formCompletionUtils.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/nodes-base/nodes/Form/utils 的工具。导入/依赖:外部:express；内部:无；本地:./utils。导出:binaryResponse、renderFormCompletion。关键函数/方法:getBinaryDataFromNode、binaryResponse、renderFormCompletion、responseText。用于提供该模块通用工具能力（纯函数/封装器）供复用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/nodes-base/nodes/Form/utils/formCompletionUtils.ts -> services/n8n/presentation/nodes-base/api/nodes/Form/utils/formCompletionUtils.py
