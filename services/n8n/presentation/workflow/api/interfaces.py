"""
MIGRATION-META:
  source_path: packages/workflow/src/interfaces.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/workflow/src 的工作流模块。导入/依赖:外部:@langchain/core/…/manager、axios 等5项；内部:@n8n/config；本地:./deferred-promise 等11项。导出:IAdditionalCredentialOptions、IAllExecuteFunctions、BinaryFileType、IBinaryData、IOAuth2Options、IConnection、ExecutionError、IGetCredentials 等71项。关键函数/方法:get、recognizes、getByName、getSupportedNodes 等32项。用于承载工作流实现细节，并通过导出对外提供能力。注释目标:eslint-disable @typescript-eslint/no-explicit-any。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/workflow/src/interfaces.ts -> services/n8n/presentation/workflow/api/interfaces.py
