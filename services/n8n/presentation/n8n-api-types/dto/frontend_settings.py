"""
MIGRATION-META:
  source_path: packages/@n8n/api-types/src/frontend-settings.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/api-types/src 的模块。导入/依赖:外部:无；内部:n8n-workflow；本地:./chat-hub、./schemas/insights.schema。导出:IVersionNotificationSettings、ITelemetryClientConfig、ITelemetrySettings、AuthenticationMethod、IUserManagementSettings、IEnterpriseSettings、FrontendSettings、FrontendModuleSettings 等2项。关键函数/方法:无。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/api-types/src/frontend-settings.ts -> services/n8n/presentation/n8n-api-types/dto/frontend_settings.py
