"""
MIGRATION-META:
  source_path: packages/@n8n/api-types/src/schemas/insights.schema.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/api-types/src/schemas 的Insights模块。导入/依赖:外部:zod；内部:无；本地:无。导出:insightsSummaryTypeSchema、InsightsSummaryType、insightsSummaryUnitSchema、InsightsSummaryUnit、insightsSummaryDataSchemas、insightsSummarySchema、InsightsSummary、insightsByWorkflowDataSchemas 等10项。关键函数/方法:无。用于承载Insights实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/api-types/src/schemas/insights.schema.ts -> services/n8n/presentation/n8n-api-types/dto/schemas/insights_schema.py
