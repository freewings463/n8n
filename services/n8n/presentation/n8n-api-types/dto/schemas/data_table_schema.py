"""
MIGRATION-META:
  source_path: packages/@n8n/api-types/src/schemas/data-table.schema.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/api-types/src/schemas 的模块。导入/依赖:外部:zod；内部:无；本地:../dto。导出:insertRowReturnType、dataTableNameSchema、dataTableIdSchema、DATA_TABLE_COLUMN_REGEX、DATA_TABLE_COLUMN_MAX_LENGTH、DATA_TABLE_COLUMN_ERROR_MESSAGE、dataTableColumnNameSchema、dataTableColumnTypeSchema 等10项。关键函数/方法:无。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/api-types/src/schemas/data-table.schema.ts -> services/n8n/presentation/n8n-api-types/dto/schemas/data_table_schema.py
