"""
MIGRATION-META:
  source_path: packages/@n8n/api-types/src/index.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/api-types/src 的入口。导入/依赖:外部:无；内部:无；本地:无。再导出:./dto。导出:createHeartbeatMessage、heartbeatMessageSchema、ViewableMimeTypes、passwordSchema。关键函数/方法:无。用于汇总导出并完成该模块模块初始化、注册或装配。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/api-types/src/index.ts -> services/n8n/presentation/n8n-api-types/dto/__init__.py
