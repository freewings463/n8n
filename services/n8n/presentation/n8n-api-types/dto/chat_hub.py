"""
MIGRATION-META:
  source_path: packages/@n8n/api-types/src/chat-hub.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/api-types/src 的模块。导入/依赖:外部:zod、zod-class；内部:@n8n/permissions；本地:无。导出:chatHubLLMProviderSchema、ChatHubLLMProvider、agentIconOrEmojiSchema、AgentIconOrEmoji、chatHubProviderSchema、ChatHubProvider、PROVIDER_CREDENTIAL_TYPE_MAP、ChatHubAgentTool 等52项。关键函数/方法:isValidTimeZone。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/api-types/src/chat-hub.ts -> services/n8n/presentation/n8n-api-types/dto/chat_hub.py
