"""
MIGRATION-META:
  source_path: packages/@n8n/api-types/src/dto/workflows/base-workflow.dto.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/api-types/src/dto/workflows 的工作流模块。导入/依赖:外部:zod；内部:n8n-workflow；本地:无。导出:WORKFLOW_NAME_MAX_LENGTH、workflowNameSchema、workflowDescriptionSchema、workflowNodesSchema、workflowConnectionsSchema、workflowSettingsSchema、workflowStaticDataSchema、workflowPinDataSchema 等2项。关键函数/方法:无。用于承载工作流实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/api-types/src/dto/workflows/base-workflow.dto.ts -> services/n8n/presentation/n8n-api-types/dto/dto/workflows/base_workflow_dto.py
