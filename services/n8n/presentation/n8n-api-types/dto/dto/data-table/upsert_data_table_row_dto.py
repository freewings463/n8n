"""
MIGRATION-META:
  source_path: packages/@n8n/api-types/src/dto/data-table/upsert-data-table-row.dto.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/api-types/src/dto/data-table 的模块。导入/依赖:外部:zod、zod-class；内部:无；本地:../schemas/data-table-filter.schema。导出:UpsertDataTableRowDto。关键函数/方法:无。用于承载该模块实现细节，并通过导出对外提供能力。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/api-types/src/dto/data-table/upsert-data-table-row.dto.ts -> services/n8n/presentation/n8n-api-types/dto/dto/data-table/upsert_data_table_row_dto.py
