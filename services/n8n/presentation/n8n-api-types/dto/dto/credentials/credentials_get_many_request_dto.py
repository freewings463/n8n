"""
MIGRATION-META:
  source_path: packages/@n8n/api-types/src/dto/credentials/credentials-get-many-request.dto.ts
  target_context: n8n
  target_layer: Interface
  responsibility: 位于 packages/@n8n/api-types/src/dto/credentials 的凭证。导入/依赖:外部:zod-class；内部:无；本地:../schemas/boolean-from-string。导出:CredentialsGetManyRequestQuery。关键函数/方法:无。用于声明 n8n 该模块鉴权字段/校验规则，供节点引用。
  entities: []
...
"""
# TODO-REFACTOR-DDD: packages/@n8n/api-types/src/dto/credentials/credentials-get-many-request.dto.ts -> services/n8n/presentation/n8n-api-types/dto/dto/credentials/credentials_get_many_request_dto.py
